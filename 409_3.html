...
<head>
    ...
    <script>
        $(document).ready(function() {
            if (typeof newrelic === 'object' && typeof newrelic.setPageViewName === 'function') {
                newrelic.setPageViewName('/idolmaster/index.php/idol_story/cjs/409/3/idol_story--index--2--6---prev----1---keyword----/0');
            }
        });
    </script>
    ...
    <script type='text/javascript' src='js/cjs/episode/409_3/talk.js'></script>
    <script type='text/javascript' src='js/cjs/episode/409_3/409_3.js'></script>
    <script>
        var image_server = "";
        var base_url = "";
        // 音声ファイルのmanifestを定義
        window.file_name = "_409_3"; // createjs の本体ファイルを定義
        window.dir_name = "image_sp/cjs/episode/409_3/";
        window.im_cjs.voice_flag = false; // 音声再生フラグを定義
        window.im_cjs.jump_url = 'http://sp.pf.mbga.jp/12008305/?guid=ON&amp;url=http://125.6.169.35/idolmaster/idol_story/index/2/6%3Fprev%3D1%3Fkeyword%3D%26l_frm%3DIdol_story_cjs_1%26rnd%3D805282498'; // createjsの演出が全て終了した場合の飛び先urlの定義
    </script>
    <script>
    ...
    <script>
        (function() {
            var _url = "http://sp.pf.mbga.jp/12008305/?guid=ON&amp;url=http://125.6.169.35/idolmaster/game_error/report_js_error%3Fl_frm%3DIdol_story_cjs_1%26rnd%3D335335666";
