(function (cjs, an) {
    ...
    (lib._462_2 = function(mode,startPosition,loop) {
        ...
        this.frame_599 = function() {
            exportRoot._g.m2 = "せん……｡ｱｲﾄﾞﾙの世界に､";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 2);
        }
        this.frame_629 = function() {
            exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
            exportRoot._g.m3 = "は戸惑い……";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 1);
        }
        this.frame_665 = function() {
            exportRoot._g.m3 = "は戸惑い……貴方は､";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 3);
        }
        ...
        this.frame_764 = function() {
            exportRoot._g.m1 = "今……私に合わせて､";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 2);
        }
        this.frame_794 = function() {
            exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
            exportRoot._g.m2 = "れているように……｡";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 1);
        }
        this.frame_848 = function() {
            exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
            exportRoot._g.m3 = "す中で､";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 3);
        }
        ...
        this.frame_883 = function() {
            exportRoot._g.m3 = "す中で､変化は数あれど……";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 4);
        }
        this.frame_928 = function() {
            exportRoot._g.m3 = this.m.t[exportRoot._g.idx][3];
            exportRoot._g.m4 = "方の優しさは､";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch2", 11);
        }
        ...
        this.frame_1266 = function() {
            exportRoot._g.m2 = "貴方に魔法をかけられ､";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch3", 4);
        }
        this.frame_1308 = function() {
            exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
            exportRoot._g.m3 = "した皆の物語……";
            exportRoot._u.setText();
