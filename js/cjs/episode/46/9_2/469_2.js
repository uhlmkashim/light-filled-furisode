(function (cjs, an) {
    ...
    (lib.bg = function() {
        this.initialize(img._469_2_bg);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);
    
    
    (lib.ch_base = function() {
        this.initialize(img._469_2_ch_base);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);
    
    
    (lib.ch_face2 = function() {
        this.initialize(img._469_2_ch_face2);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,292,268);
    
    
    (lib.ch_face3 = function() {
        this.initialize(img._469_2_ch_face3);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,292,268);
    
    
    (lib.ch_face4 = function() {
        this.initialize(img._469_2_ch_face4);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,292,268);
    
    
    (lib.ch_face5 = function() {
        this.initialize(img._469_2_ch_face5);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,292,268);
    
    
    (lib.ch_face6 = function() {
        this.initialize(img._469_2_ch_face6);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,292,268);
    
    
    (lib.ch_face7 = function() {
        this.initialize(img._469_2_ch_face7);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,292,268);
    
    
    (lib.ch_face8 = function() {
        this.initialize(img._469_2_ch_face8);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,292,268);
    
    
    (lib.finish = function() {
        this.initialize(img._469_2_finish);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,480,620);
    
    
    (lib.finish_blur = function() {
        this.initialize(img._469_2_finish_blur);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,480,620);
    
    
    (lib.shadow = function() {
        this.initialize(img._469_2_shadow);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,1200,1400);
    
    
    (lib.tie_fp = function() {
        this.initialize(img._469_2_tie_fp);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,32);
    
    
    (lib.tie_sp = function() {
        this.initialize(img._469_2_tie_sp);
    }).prototype = p = new cjs.Bitmap();
    ...
    (lib.g_shadow = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{});
    
        // レイヤー_1
        this.instance = new lib.shadow();
        this.instance.parent = this;
        this.instance.setTransform(-300,-350,0.5,0.5);
    
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-300,-350,600,700);
    ...
    }).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,146,134), null);
    ...
    (lib.tie = function(mode,startPosition,loop) {
        ...
        // txt
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#333333").s().p("");
        this.shape.setTransform(35.45,0.4);
    
        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#333333").s().p("");
        this.shape_1.setTransform(20,0.4);
        ...
        this.shape_2.setTransform(4.125,0.975);
    
        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#333333").s().p("AgjAwQAKgHAIgKQAIgLAGgNQAEgLADgOIAEgbIghABIAAgRIAyAAQgCATgDAQQgDAPgEAMIAIAOIAIAQIAHAQIgLAOQgFgNgEgLIgJgTQgHARgJALQgIAKgJAGg");
        this.shape_3.setTransform(-8.05,0.875);
    
        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#333333").s().p("AAAApIgJgWIgJgTIgIgOIANgGIAHALIAGANQAFgGADgJIAGgSIADgRIgyABIAAgRIAFAAIAMAAIAQAAIAPAAIANAAIAGAAQgBATgEAPQgEAQgGAMQgFAMgHAJIAHARIAFAPIgOAKIgFgWg");
        this.shape_4.setTransform(-15.925,1.175);
    
        this.shape_5 = new cjs.Shape();
        this.shape_5.graphics.f("#333333").s().p("AgjAwQALgHAHgKQAIgLAGgNQADgLAEgOIAEgbIghABIAAgRIAxAAQgBATgDAQQgDAPgEAMIAIAOIAIAQIAHAQIgMAOQgEgNgFgLIgIgTQgHARgJALQgIAKgJAGg");
        this.shape_5.setTransform(-24.05,0.875);
    
        this.shape_6 = new cjs.Shape();
        this.shape_6.graphics.f("#333333").s().p("AgZA4QAQgFAIgKQAHgJADgNQADgNAAgMIAAgLIAAgMIAAgQIAAgOIAAgKIAPAAIAAAFIAAAMIAAARIAAARIAAAOQAAAQgEAMQgDANgGAJQgGAJgIAGQgGAGgIADgAgaAPIAAhUIAPAAIAABUg");
        this.shape_6.setTransform(-31.925,0.625);
    
        this.shape_7 = new cjs.Shape();
        this.shape_7.graphics.f("#333333").s().p("AgdA6QAMgFAJgKQAIgJAFgNQAGgNADgNQAEgOABgPIgTAAQgFAOgGAMQgGAMgHAJIgKgMQAFgFAFgJQAFgJADgLIAGgUIADgSIAOAEIgEARIAJAAIAKAAIAIAAIAFAAIgCAbIgGAbQgDAOgGANQgGANgJALQgJAKgNAHg");
        this.shape_7.setTransform(-40.125,0.375);
    ...
    (lib.character1_face = function(mode,startPosition,loop) {
        ...
        mask._off = true;
        mask.graphics.p("ArPKUIAA0nIWfAAIAAUng");
        mask.setTransform(73,67);
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},12).wait(1));
    
        // body
        this.b = new lib.character1_base();
        this.b.name = "b";
        this.b.parent = this;
        this.b.setTransform(-120,226);
    ...
    p.nominalBounds = new cjs.Rectangle(1,1,144,132);
    ...
    (lib.character1_face_container = function(mode,startPosition,loop) {
        ...
        var mask = new cjs.Shape();
        mask._off = true;
        var mask_graphics_15 = new cjs.Graphics().p("AqUG+IgNjnIDeiaIFhivIFWjZICGhmIBwgSQBYAagBACIBiCLIgUB5IiTBLIh+BYIg6AZIgmAKIhnACIhvAxIhWBxIgwAxIiiBsIh9BcIhgAEg");
        ...
        this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:71.85,y:72.25}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:73,regY:67,x:73,y:67,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:73,regY:67,x:73,y:67,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
        ...
        this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:73,regY:67,x:73,y:67,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
        ...
        this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:73,regY:67,x:73,y:67,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-240,-170,600,700);
    ...
    (lib.character1_body = function(mode,startPosition,loop) {
        ...
        this.b.name = "b";
        this.b.parent = this;
        this.b.setTransform(-121.4,-94.8);
    
        this.timeline.addTween(cjs.Tween.get(this.b).wait(2));
    
        // レイヤー_2
        this.instance = new lib.g_shadow("synched",0);
        this.instance.parent = this;
        this.instance.setTransform(358.55,209.15,1,1,0,0,0,300,350);
    
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(2));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-241.4,-490.8,600,700);
    ...
    (lib.character1_container = function(mode,startPosition,loop) {
        ...
        this.instance.parent = this;
        this.instance.setTransform(134.9,-337.1,1.1645,1.1645,0,0,180);
        this.instance._off = true;
    
        this.instance_1 = new lib.heart();
        this.instance_1.parent = this;
        this.instance_1.setTransform(143.35,-286.5,0.4532,0.4532,0,0,180);
        this.instance_1.alpha = 0;
        this.instance_1.compositeOperation = "lighter";
        this.instance_1._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:160.5,y:-346.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:172.15,y:-350.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:134.9,y:-337.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:160.5,y:-346.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:172.15,y:-350.4,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:134.9,y:-337.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:160.5,y:-346.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:172.15,y:-350.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:134.9,y:-337.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:160.5,y:-346.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:172.15,y:-350.4,alpha:0.2188},0).to({_off:true},1).wait(110));
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:145.1,y:-300.65,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:148.35,y:-306.5,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:145.8,y:-304.35,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:145.25,y:-301.1,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:146.35,y:-296.5,alpha:0},0).to({_off:true},1).wait(66));
    
        // effect_look_to_right
        this.instance_2 = new lib.spread_flower_pink("synched",0,false);
        this.instance_2.parent = this;
        this.instance_2.setTransform(76.75,-244.35,1.4807,1.4807,0,0,180);
    
        this.instance_3 = new lib.good_effect("synched",0,false);
        this.instance_3.parent = this;
        this.instance_3.setTransform(76.8,-244.4,1.481,1.481);
    
        this.instance_4 = new lib.notice();
        this.instance_4.parent = this;
        this.instance_4.setTransform(150.45,-332.65,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
        this.instance_4._off = true;
    
        this.instance_5 = new lib.laugh("synched",0);
        this.instance_5.parent = this;
        this.instance_5.setTransform(166.45,-329.1,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
        this.instance_5._off = true;
    
        this.instance_6 = new lib.chord("synched",0,false);
        this.instance_6.parent = this;
        this.instance_6.setTransform(163.1,-274.1,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);
    
        this.instance_7 = new lib.question();
        this.instance_7.parent = this;
        this.instance_7.setTransform(138.65,-329.6,1.053,1.053,29.448);
        this.instance_7.alpha = 0;
        this.instance_7._off = true;
    
        this.instance_8 = new lib.mc_exclamation("synched",0,false);
        this.instance_8.parent = this;
        this.instance_8.setTransform(142.4,-345,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);
    
        this.instance_9 = new lib.drop1a("synched",0);
        this.instance_9.parent = this;
        this.instance_9.setTransform(138.1,-327.5,1,1,0,0,0,-0.5,0.2);
        this.instance_9._off = true;
    
        this.instance_10 = new lib.drop2_v2("synched",0);
        this.instance_10.parent = this;
        this.instance_10.setTransform(136.7,-327.35,0.9876,0.9876,0,-14.9998,165.0002);
        this.instance_10._off = true;
    
        this.instance_11 = new lib.shock("synched",0);
        this.instance_11.parent = this;
        this.instance_11.setTransform(143.15,-330.35,1.3878,1.3878,0,121.2396,-58.7604);
    
        this.instance_12 = new lib.sigh("synched",0);
        this.instance_12.parent = this;
        this.instance_12.setTransform(116.7,-177.05,1,1,0,0,180);
        this.instance_12.alpha = 0.6016;
        this.instance_12._off = true;
    
        this.instance_13 = new lib.heart("synched",0);
        this.instance_13.parent = this;
        this.instance_13.setTransform(143.35,-286.5,0.4532,0.4532,0,0,180);
        this.instance_13._off = true;
    
        this.instance_14 = new lib.angry("synched",0);
        this.instance_14.parent = this;
        this.instance_14.setTransform(149.9,-307.75,0.5276,0.5276);
        this.instance_14._off = true;
    
        this.instance_15 = new lib.mc_punpun();
        this.instance_15.parent = this;
        this.instance_15.setTransform(18.85,-356.9,1.1377,1.1377);
    
        this.instance_16 = new lib.concent_wrapper("synched",0,false);
        this.instance_16.parent = this;
        this.instance_16.setTransform(76.55,-244.95,1,1,0,0,0,-0.5,-0.1);
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-332.7},0).wait(3).to({regX:-28.8,x:150.05,y:-332.55,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:150.45,y:-332.7,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-332.65,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-332.7},0).wait(3).to({regX:-28.8,x:150.05,y:-332.55,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:150.45,y:-332.7,alpha:0},0).to({_off:true},1).wait(283));
        this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({regY:20.4,skewX:-35.827,skewY:144.1725,x:166.35,y:-329.15},0).wait(1).to({regX:-31.4,regY:22.1,x:169.15,y:-328.2,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.4,x:166.35,y:-329.15,alpha:0,startPosition:19},0).to({_off:true},1).wait(262));
        this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:146.3,y:-342.55,alpha:0.5556},0).wait(1).to({x:151.1,y:-350.4,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:153.05,y:-353.2,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:152.4,y:-352.45},0).wait(1).to({x:151.35,y:-350.6},0).wait(1).to({x:149.6,y:-347.5},0).wait(1).to({regX:0,regY:0,x:147.45,y:-343.3},0).to({x:148.2,y:-344.65},2).wait(8).to({regX:-0.2,regY:0.2,x:147.55,y:-343.95,alpha:0.9298},0).wait(1).to({x:146.45,y:-342,alpha:0.692},0).wait(1).to({x:144.85,y:-339.15,alpha:0.339},0).wait(1).to({x:143.65,y:-337.05,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-336.5,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:138.65,y:-329.6},0).wait(1).to({regX:-0.2,regY:0.2,x:146.3,y:-342.55,alpha:0.5556},0).wait(1).to({x:151.1,y:-350.4,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:153.05,y:-353.2,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:152.4,y:-352.45},0).wait(1).to({x:151.35,y:-350.6},0).wait(1).to({x:149.6,y:-347.5},0).wait(1).to({regX:0,regY:0,x:147.45,y:-343.3},0).to({x:148.2,y:-344.65},2).wait(3).to({regX:-0.2,regY:0.2,x:147.55,y:-343.95,alpha:0.9298},0).wait(1).to({x:146.45,y:-342,alpha:0.692},0).wait(1).to({x:144.85,y:-339.15,alpha:0.339},0).wait(1).to({x:143.65,y:-337.05,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-336.5,alpha:0},0).to({_off:true},1).wait(195));
        this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:139.1,y:-323.8},0).wait(1).to({y:-319.95},0).wait(1).to({y:-316.7},0).wait(1).to({y:-314.05},0).wait(1).to({y:-311.95},0).wait(1).to({y:-310.45},0).wait(1).to({y:-309.55},0).wait(1).to({regX:-0.5,regY:0.2,x:138.1,y:-308.5},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:139.1,y:-309.3,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:138.1,y:-308.5,alpha:0},0).to({_off:true},1).wait(153));
        this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:168.125,y:-322.7375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:178.6,y:-321.2,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:136.7,y:-327.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:168.125,y:-327.125,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:178.6,y:-327.05,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:136.7,y:-327.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:168.125,y:-322.7375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:178.6,y:-321.2,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:136.7,y:-327.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:168.125,y:-327.125,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:178.6,y:-327.05,alpha:0.2188},0).to({_off:true},1).wait(110));
        this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:117.7,y:-176.05,alpha:1},0).wait(1).to({regX:0.9,x:117.8,y:-175.1,alpha:0.8965},0).wait(1).to({x:119.15,y:-173.9,alpha:0.7636},0).wait(1).to({x:120.75,y:-172.45,alpha:0.6048},0).wait(1).to({x:122.55,y:-170.85,alpha:0.4229},0).wait(1).to({x:124.55,y:-169,alpha:0.2205},0).wait(1).to({regX:0,x:127.7,y:-167.05,alpha:0},0).to({_off:true},1).wait(83));
        this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:145.1,y:-300.65},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:148.35,y:-306.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:145.8,y:-304.35},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:145.25,y:-301.1},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:146.35,y:-296.5},0).to({scaleX:1,scaleY:1,x:147.35,y:-300.5},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:144.75,y:-299.5,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:146.35,y:-300.25,alpha:0.1016},0).to({_off:true},1).wait(59));
        this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-311.5},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-312.75},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(40));
        ...
        this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:58.6,regY:-140.8,x:58.6,y:-149.2},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-150},0).wait(1).to({y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-146.3},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-146.55},0).wait(1).to({y:-139.6},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-137.55},0).wait(1).to({y:-139.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-145.75},0).wait(1).to({y:-139.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-145.75},0).wait(1).to({y:-139.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-139.9},0).wait(1).to({y:-140.55},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-149.8},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-153.75},0).wait(1).to({y:-150.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-138.8},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-141.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-149.8},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-153.75},0).wait(1).to({y:-150.15},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-138.8},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-141.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:58.6,regY:-140.8,x:58.6,y:-140.2},0).wait(1).to({y:-137.8},0).wait(1).to({y:-135.45},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-135.45},0).wait(1).to({y:-137.8},0).wait(1).to({y:-140.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:58.6,regY:-140.8,x:58.6,y:-140.65},0).wait(1).to({y:-140.1},0).wait(1).to({y:-139},0).wait(1).to({y:-137.65},0).wait(1).to({y:-136.55},0).wait(1).to({y:-136},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-136},0).wait(1).to({y:-136.55},0).wait(1).to({y:-137.65},0).wait(1).to({y:-139},0).wait(1).to({y:-140.1},0).wait(1).to({y:-140.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-136.05},0).wait(1).to({y:-139.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-138.6},0).wait(1).to({y:-140.45},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:58.6,regY:-140.8,rotation:0.0244,x:58.65,y:-140.75},0).wait(1).to({rotation:0.1092,x:58.95,y:-140.35},0).wait(1).to({rotation:0.275,x:59.6,y:-139.6},0).wait(1).to({rotation:0.538,x:60.6,y:-138.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:61.9,y:-137},0).wait(1).to({rotation:1.1673,x:63,y:-135.7},0).wait(1).to({rotation:1.367,x:63.75,y:-134.8},0).wait(1).to({rotation:1.4695,x:64.1,y:-134.35},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:58.6,regY:-140.8,rotation:1.479,x:64.1,y:-134.4},0).wait(1).to({rotation:1.4111,x:63.85,y:-134.65},0).wait(1).to({rotation:1.2801,x:63.4,y:-135.25},0).wait(1).to({rotation:1.0711,x:62.6,y:-136.15},0).wait(1).to({rotation:0.7884,x:61.55,y:-137.4},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:60.4,y:-138.7},0).wait(1).to({rotation:0.2415,x:59.45,y:-139.75},0).wait(1).to({rotation:0.0832,x:58.85,y:-140.45},0).wait(1).to({rotation:0.0011,x:58.6,y:-140.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:58.6,regY:-140.8,rotation:0.0244,x:58.65,y:-140.75},0).wait(1).to({rotation:0.1092,x:58.95,y:-140.35},0).wait(1).to({rotation:0.275,x:59.6,y:-139.6},0).wait(1).to({rotation:0.538,x:60.6,y:-138.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:61.9,y:-137},0).wait(1).to({rotation:1.1673,x:63,y:-135.7},0).wait(1).to({rotation:1.367,x:63.75,y:-134.8},0).wait(1).to({rotation:1.4695,x:64.1,y:-134.35},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:58.6,regY:-140.8,rotation:1.4793,x:64.1,y:-134.4},0).wait(1).to({rotation:1.4124,x:63.85,y:-134.65},0).wait(1).to({rotation:1.2834,x:63.4,y:-135.25},0).wait(1).to({rotation:1.0775,x:62.6,y:-136.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:61.55,y:-137.4},0).wait(1).to({rotation:0.5016,x:60.45,y:-138.7},0).wait(1).to({rotation:0.2603,x:59.5,y:-139.75},0).wait(1).to({rotation:0.1043,x:58.9,y:-140.45},0).wait(1).to({rotation:0.0235,x:58.65,y:-140.8},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:58.6,regY:-140.8,x:58.6,y:-146.35},0).wait(1).to({y:-148.25},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-148.15},0).wait(1).to({y:-146.05},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:58.6,regY:-140.8,x:58.6,y:-149.2},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-150},0).wait(1).to({y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:58.6,regY:-140.8,x:58.6,y:-140.65},0).wait(1).to({y:-140.1},0).wait(1).to({y:-139},0).wait(1).to({y:-137.65},0).wait(1).to({y:-136.55},0).wait(1).to({y:-136},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-136},0).wait(1).to({y:-136.55},0).wait(1).to({y:-137.65},0).wait(1).to({y:-139},0).wait(1).to({y:-140.1},0).wait(1).to({y:-140.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(7).to({regX:58.6,regY:-140.8,rotation:0.1421,x:59.1,y:-140.2},0).wait(1).to({rotation:0.6998,x:61.2,y:-137.8},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:63.6,y:-135},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:58.6,regY:-140.8,rotation:1.4399,x:63.95,y:-134.55},0).wait(1).to({rotation:1.2196,x:63.15,y:-135.5},0).wait(1).to({rotation:0.7884,x:61.55,y:-137.4},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:59.7,y:-139.45},0).wait(1).to({rotation:0.0482,x:58.7,y:-140.6},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:58.6,regY:-140.8,rotation:0.0865,x:58.9,y:-140.45},0).wait(1).to({rotation:0.4213,x:60.2,y:-138.95},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:62.35,y:-136.45},0).wait(1).to({rotation:1.3945,x:63.85,y:-134.65},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:58.6,regY:-140.8,rotation:1.4399,x:63.95,y:-134.55},0).wait(1).to({rotation:1.2196,x:63.15,y:-135.5},0).wait(1).to({rotation:0.7884,x:61.55,y:-137.4},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:59.7,y:-139.45},0).wait(1).to({rotation:0.0482,x:58.7,y:-140.6},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-149.2},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-150},0).wait(1).to({y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:58.6,regY:-140.8,x:55.85,y:-133.05},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:58.6,regY:-140.8,x:58.6,y:-128.55},0).wait(1).to({y:-131.5},0).wait(1).to({y:-136.45},0).wait(1).to({y:-139.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-139.8},0).wait(1).to({y:-133.85},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:58.6,regY:-140.8,x:58.6,y:-133},0).wait(1).to({y:-137.3},0).wait(1).to({y:-141.6},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-141.3},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:58.6,regY:-140.8,x:58.6,y:-147.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-147.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-149.2},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-150},0).wait(1).to({y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:58.6,regY:-140.8,x:55.85,y:-133.05},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:58.6,regY:-140.8,x:58.6,y:-130.05},0).wait(1).to({y:-137.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-141.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-140.95},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-140.3},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:58.6,regY:-140.8,x:58.6,y:-140.2},0).wait(1).to({y:-137.8},0).wait(1).to({y:-135.45},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-135.4},0).wait(1).to({y:-135.7},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:58.6,regY:-140.8,x:58.6,y:-136.2},0).wait(1).to({y:-137.7},0).wait(1).to({y:-139.95},0).wait(1).to({y:-141.4},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-141.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-148.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-150},0).wait(1).to({y:-147.25},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:58.6,regY:-140.8,x:58.6,y:-148.3},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:58.6,regY:-140.8,x:58.6,y:-148.8},0).wait(1).to({y:-142.8},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:58.6,regY:-140.8,x:58.6,y:-136.15},0).wait(1).to({y:-137.35},0).wait(1).to({y:-139.3},0).wait(1).to({y:-140.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-145.75},0).wait(1).to({y:-139.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-145.75},0).wait(1).to({y:-139.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:58.6,regY:-140.8,x:58.6,y:-139.9},0).wait(1).to({y:-140.55},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:58.6,regY:-140.8,x:61.6,y:-137.4},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:58.6,regY:-140.8,x:57.75,y:-131.35},0).wait(1).to({x:58.4,y:-130.95},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:58.6,regY:-140.8,x:58.6,y:-131.5},0).wait(1).to({y:-133.95},0).wait(1).to({y:-137.65},0).wait(1).to({y:-140.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-456.9,-680.4,941.0999999999999,905.0999999999999);
    ...
    // stage content:
    (lib._469_2 = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:186,scene2:187,end2:401,scene3:402,end3:602,scene4:603,end4:824,scene5:825,end5:1051,scene6:1052,end6:1228,scene7:1229,end7:1452});
        ...
        this.frame_746 = function() {
            exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
            exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
            exportRoot._g.m3 = "その隣のお人形さんは"; //3 行目
            exportRoot._g.m4 = ""; //4 行目
            exportRoot._u.setText();
        ...
        this.frame_1348 = function() {
            ...
            exportRoot._g.m3 = "わたくしとﾌﾟﾛﾃﾞｭｰｻｰちゃまで､";
            exportRoot._g.m4 = "";
        ...
        this.frame_1387 = function() {
            // finish指定時は exportRoot._g.m の後ろの数字をsetTextの2つ目の引数に指定する
            exportRoot._g.m3 = "わたくしとﾌﾟﾛﾃﾞｭｰｻｰちゃまで､";
            exportRoot._g.m4 = "天使に願いを｡";
            exportRoot._u.setText("finish", 3);
        }
        this.frame_1427 = function() {
            // finish指定時は exportRoot._g.m の後ろの数字をsetTextの2つ目の引数に指定する
            exportRoot._g.m3 = "わたくしとﾌﾟﾛﾃﾞｭｰｻｰちゃまで､";
            exportRoot._g.m4 = "天使に願いを｡心を合わせて｡";
            exportRoot._u.setText("finish", 3);
        }
        ...
        // actions tween:
        this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(11).call(this.frame_26).wait(8).call(this.frame_34).wait(22).call(this.frame_56).wait(26).call(this.frame_82).wait(46).call(this.frame_128).wait(23).call(this.frame_151).wait(35).call(this.frame_186).wait(1).call(this.frame_187).wait(32).call(this.frame_219).wait(39).call(this.frame_258).wait(56).call(this.frame_314).wait(37).call(this.frame_351).wait(50).call(this.frame_401).wait(1).call(this.frame_402).wait(12).call(this.frame_414).wait(13).call(this.frame_427).wait(16).call(this.frame_443).wait(11).call(this.frame_454).wait(37).call(this.frame_491).wait(35).call(this.frame_526).wait(36).call(this.frame_562).wait(40).call(this.frame_602).wait(1).call(this.frame_603).wait(24).call(this.frame_627).wait(14).call(this.frame_641).wait(51).call(this.frame_692).wait(29).call(this.frame_721).wait(25).call(this.frame_746).wait(39).call(this.frame_785).wait(39).call(this.frame_824).wait(1).call(this.frame_825).wait(34).call(this.frame_859).wait(67).call(this.frame_926).wait(50).call(this.frame_976).wait(45).call(this.frame_1021).wait(14).call(this.frame_1035).wait(16).call(this.frame_1051).wait(1).call(this.frame_1052).wait(15).call(this.frame_1067).wait(34).call(this.frame_1101).wait(48).call(this.frame_1149).wait(27).call(this.frame_1176).wait(41).call(this.frame_1217).wait(11).call(this.frame_1228).wait(1).call(this.frame_1229).wait(34).call(this.frame_1263).wait(35).call(this.frame_1298).wait(50).call(this.frame_1348).wait(39).call(this.frame_1387).wait(40).call(this.frame_1427).wait(25).call(this.frame_1452).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(1457));
        ...
        this.timeline.addTween(cjs.Tween.get(this.sender).wait(1452).to({_off:false},0).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.loader).wait(1457));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1438));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1442));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1451));
        ...
        this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1298).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(119));
        ...
        this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1338).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(106));
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1338).wait(119));
        ...
        this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1338).to({_off:false},0).wait(119));
        ...
        this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(1338).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(101));
        ...
        this.timeline.addTween(cjs.Tween.get(this.fns).wait(1338).to({_off:false},0).wait(119));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1326).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(119));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(1206).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(220));
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1442));
        ...
        this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1052).to({_off:false},0).to({alpha:1},15).to({_off:true},162).wait(228));
        ...
        this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(1052).to({_off:false},0).to({alpha:0.4492},15).to({_off:true},162).wait(228));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).to({_off:true},1323).wait(119));
    
        // ch コピー
        this.ch1 = new lib.character1_container();
        this.ch1.name = "ch1";
        this.ch1.parent = this;
        this.ch1.setTransform(83.35,264.6,0.6449,0.6449,0,0,0,0.1,0.2);
        this.ch1._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({_off:false},0).wait(41).to({regY:0.1,scaleX:0.8311,scaleY:0.8311,x:73.75,y:324.55},69,cjs.Ease.quadInOut).wait(277).to({regY:0.2,scaleX:0.6852,scaleY:0.6852,x:81.55,y:280.5},52,cjs.Ease.cubicInOut).wait(37).to({x:47.05},27,cjs.Ease.quadInOut).wait(307).to({regY:0.1,scaleX:0.8311,scaleY:0.8311,x:73.75,y:324.55},83,cjs.Ease.cubicInOut).wait(144).to({scaleX:0.9111,scaleY:0.9111,x:71.05,y:349.35},91,cjs.Ease.cubicInOut).wait(86).to({regY:0.2,scaleX:0.6449,scaleY:0.6449,x:83.35,y:264.6},0).to({_off:true},109).wait(119));
    
        // bg コピー
        this.bg1 = new lib.bg_zoom_half();
        this.bg1.name = "bg1";
        this.bg1.parent = this;
        this.bg1.setTransform(-274.35,-53,0.874,0.874,0,0,0,-0.3,-0.1);
    
        this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.4,scaleX:0.6449,scaleY:0.6449,x:-72.35,y:-51.9},0).wait(41).to({regX:-0.1,regY:0,scaleX:0.8311,scaleY:0.8311,x:-126.95,y:-83.35},69,cjs.Ease.quadInOut).wait(277).to({regX:-0.2,scaleX:0.6852,scaleY:0.6852,x:-83.85,y:-55.8},52,cjs.Ease.cubicInOut).wait(37).to({x:-118.35},27,cjs.Ease.quadInOut).wait(307).to({regX:-0.1,scaleX:0.8311,scaleY:0.8311,x:-126.95,y:-83.35},83,cjs.Ease.cubicInOut).wait(144).to({regY:-0.1,scaleX:0.911,scaleY:0.911,x:-148.9,y:-97.8},91,cjs.Ease.cubicInOut).wait(86).to({regX:-0.4,scaleX:0.6449,scaleY:0.6449,x:-72.35,y:-51.9},0).to({_off:true},109).wait(119));
        ...
        this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1326).wait(131));
        ...
        this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1338).wait(114).to({_off:false},0).wait(5));
    ...
    lib.properties = {
        ...
        opacity: 1.00,
        manifest: [
            {src:"images/bg.jpg", id:"_469_2_bg"},
            {src:"images/ch_base.png", id:"_469_2_ch_base"},
            {src:"images/ch_face2.png", id:"_469_2_ch_face2"},
            {src:"images/ch_face3.png", id:"_469_2_ch_face3"},
            {src:"images/ch_face4.png", id:"_469_2_ch_face4"},
            {src:"images/ch_face5.png", id:"_469_2_ch_face5"},
            {src:"images/ch_face6.png", id:"_469_2_ch_face6"},
            {src:"images/ch_face7.png", id:"_469_2_ch_face7"},
            {src:"images/ch_face8.png", id:"_469_2_ch_face8"},
            {src:"images/finish.jpg", id:"_469_2_finish"},
            {src:"images/finish_blur.jpg", id:"_469_2_finish_blur"},
            {src:"images/shadow.png", id:"_469_2_shadow"},
            {src:"images/tie_fp.png", id:"_469_2_tie_fp"},
            {src:"images/tie_sp.png", id:"_469_2_tie_sp"},
            {src:"sounds/_1wav.mp3", id:"_469_2__1wav"},
            {src:"sounds/_2wav.mp3", id:"_469_2__2wav"},
            {src:"sounds/_3wav.mp3", id:"_469_2__3wav"},
            {src:"sounds/_4wav.mp3", id:"_469_2__4wav"},
            {src:"sounds/_5wav.mp3", id:"_469_2__5wav"},
            {src:"sounds/_6wav.mp3", id:"_469_2__6wav"},
            {src:"sounds/_7wav.mp3", id:"_469_2__7wav"}
        ],
        preloads: []
    };
