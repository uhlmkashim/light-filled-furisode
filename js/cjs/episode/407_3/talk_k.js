...
window.im_cjs.t[1][1] = "…………묘하네요. 지도가 나타내는";
window.im_cjs.t[1][2] = "곳은, 확실히, 이 근처입니다만";
window.im_cjs.t[1][3] = "… 어째서일까요. 그림자도 형태도";
window.im_cjs.t[1][4] = "…… 기척조차, 없습니다.";

window.im_cjs.t[2][1] = "골목 뒤쪽에 조용히 자리잡은 고서점";
window.im_cjs.t[2][2] = "이 있다고 가르쳐 주셨는데,";
...
window.im_cjs.t[7][3] = "프로듀서 씨,";
window.im_cjs.t[7][4] = "좀 더 느긋이……";
window.im_cjs.t[7][5] = "추억을 만들까요.";
