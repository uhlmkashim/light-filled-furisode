(function (cjs, an) {
    ...
    (lib.textfield = function(mode,startPosition,loop) {
        ...
        // レイヤー_1
        this.line4 = new cjs.Text("", "13px 'NanumSquare'");
        ...
        this.line3 = new cjs.Text("", "13px 'NanumSquare'");
        ...
        this.line2 = new cjs.Text("", "13px 'NanumSquare'");
        ...
        this.line1 = new cjs.Text("", "13px 'NanumSquare'");
