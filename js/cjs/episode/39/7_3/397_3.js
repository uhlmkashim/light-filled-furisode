...
(lib.bg = function() {
	this.initialize(img._397_3_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1164,1400);


(lib.bg_blur = function() {
	this.initialize(img._397_3_bg_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1164,1400);


(lib.ch_base = function() {
	this.initialize(img._397_3_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1164,1400);


(lib.ch_base_no_hand = function() {
	this.initialize(img._397_3_ch_base_no_hand);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,356,240);


(lib.ch_face2 = function() {
	this.initialize(img._397_3_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,224);


(lib.ch_face3 = function() {
	this.initialize(img._397_3_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,224);


(lib.ch_face4 = function() {
	this.initialize(img._397_3_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,224);


(lib.ch_face5 = function() {
	this.initialize(img._397_3_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,224);


(lib.ch_face6 = function() {
	this.initialize(img._397_3_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,224);


(lib.ch_face7 = function() {
	this.initialize(img._397_3_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,256,224);


(lib.finish = function() {
	this.initialize(img._397_3_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._397_3_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.glitter = function() {
	this.initialize(img._397_3_glitter);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,40,40);


(lib.tie_fp = function() {
	this.initialize(img._397_3_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._397_3_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.room_light_part = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#E05417","rgba(224,140,28,0)"],[0,1],0,0,0,0,0,162.7).s().p("Ax0R1QnYnZAAqcQAAqcHYnYQHYnYKcAAQKcAAHZHYQHYHYAAKcQAAKcnYHZQnZHYqcAAQqcAAnYnYg");
	this.shape.setTransform(161.325,161.325);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.room_light_part, new cjs.Rectangle(0,0,322.7,322.7), null);
...
(lib.light_slush = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.light_slush, new cjs.Rectangle(-148.1,-2.9,296.29999999999995,5.9), null);
...
(lib.glitter_common_parts1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.glitter_common_parts1_1, new cjs.Rectangle(-8,-8,16,16), null);
...
(lib.clickpoint = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
}).prototype = getMCSymbolPrototype(lib.clickpoint, new cjs.Rectangle(0,0,58.7,58.7), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,128,112), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,582,700), null);


(lib.ch_base_no_hand_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.ch_base_no_hand();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.ch_base_no_hand_1, new cjs.Rectangle(0,0,178,120), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,582,700);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(56.1,0.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AAyBMIAAgJIhzAAIAAgPIBzAAIAAgVIhtAAIAAgPIBtAAIAAgTIhyAAIAAgPIA4AAIAAg5IARAAIAAA5IA5AAIAABegAAYgeIADgCIAGgHIAHgMQAEgHACgJIARAHQgGANgFAJIgKANIgEAEgAgogaIgHgOIgOgRIAOgKIANASIAIANIADAGIgNAJIgEgFg");
	this.shape_1.setTransform(40,0.425);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AhAAvQAbgEAUgJQASgHANgNQAOgMAJgQQAJgRAEgVIARAKIgIAXQgFANgHAMQgJAMgNAMQgNAKgSAKQgTAJgcAFgAgigeIgRgLIgPgIIANgOIAKAGIAMAHIANAJIAMAJIgOAPQgFgGgJgHg");
	this.shape_2.setTransform(24.4,0.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("AAHBHIAAhLQgOAJgQAIIgeAMIgPgPQAngLAegUQAegUAUgdIASAJQgLAOgLAKQgLALgLAJIAAAOIAAARIAAAVIAAAUIAAAQg");
	this.shape_3.setTransform(7.6,0.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("Ag4A7QAYgEASgJQASgJANgMIgTgQIgVgMIALgMIAMAIIAOAIIAOALQAJgMAGgLQAEgNADgMIg4AAQgJANgMANQgMALgPALIgPgMQAMgGAKgJQAKgIAIgKQAIgKAFgKQAGgKADgJIARAEIgDAJIgFAIIAOAAIAQAAIAQAAIAOAAIAIAAQgCAOgEAPQgFAPgHAOQgJAPgNANQgNANgRAKQgSAKgaAFg");
	this.shape_4.setTransform(-8.5,0.475);
	...
	this.shape_5.setTransform(-23.6,0.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("Ag8hCIATAAIAAAJIAAASIgBAWIAAAWIAAAXIgBAQQAVgDARgLQAQgKAOgPQAOgNAKgSIAMARQgGALgMAMQgKAMgPALQgOALgTAIQgUAHgZAEg");
	this.shape_6.setTransform(-39.05,0.65);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#333333").s().p("AhNBBQAMgQAJgSQAJgUAFgUQAGgUACgUIATACQgDAXgGAVQgGAUgIATQgIAUgKAQgAArAbIgPgmQgIgTgJgQIARgGIAOAcIANAeIALAdQAFAOACAMIgTAHQgEgVgHgUgAArgtIgKgMIAKgGIAJAMIAJANIgKAGIgIgNgAA8g3IgJgLIAJgFIAJALIAJANIgJAGIgJgOg");
	this.shape_7.setTransform(-55.85,-0.2);
...
(lib.room_light = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_2
	this.instance = new lib.room_light_part();
	this.instance.parent = this;
	this.instance.setTransform(-164.95,-384.3,1.7741,1.7741,0,0,0,161.2,161.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.9021,scaleY:1.9021,x:-164.9,y:-384.25,alpha:0.5},39).to({scaleX:1.7741,scaleY:1.7741,x:-164.95,y:-384.3,alpha:1},44).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-471.5,-690.8,613.7,613.6999999999999);
...
(lib.glitter_common_parts1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// timeline functions:
	this.frame_0 = function() {
		/* _xscale = _yscale = random(15)+10
		p._visible=false;*/
	...
	// marker
	this.p = new lib.clickpoint();
	this.p.name = "p";
	this.p.parent = this;
	this.p.setTransform(0.05,0.05,1,1,0,0,0,29.4,29.4);

	this.timeline.addTween(cjs.Tween.get(this.p).to({_off:true},1).wait(16));

	// light2
	this.instance = new lib.light_slush();
	this.instance.parent = this;
	this.instance.setTransform(-0.05,0,0.1255,1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(1).to({scaleX:0.372},0).to({scaleX:0.5,alpha:0.1289},4).to({_off:true},1).wait(10));

	// light1
	this.instance_1 = new lib.glitter_common_parts1_1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,0,0.6427,0.6427,-44.822);
	this.instance_1.alpha = 0.4297;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({scaleX:3.7607,scaleY:3.7607,rotation:-11.2055,alpha:0.8574},0).wait(1).to({scaleX:4.8,scaleY:4.8,rotation:0,alpha:1},0).wait(1).to({scaleX:4.722,scaleY:4.722,rotation:1.9399,alpha:0.971},0).wait(1).to({scaleX:4.5026,scaleY:4.5026,rotation:7.4005,alpha:0.8893},0).wait(1).to({scaleX:4.1415,scaleY:4.1415,rotation:16.3817,alpha:0.7549},0).wait(1).to({scaleX:3.6391,scaleY:3.6391,rotation:28.8836,alpha:0.5678},0).wait(1).to({scaleX:2.9951,scaleY:2.9951,rotation:44.9061,alpha:0.3281},0).to({_off:true},1).wait(9));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-74.1,-41,148.2,82.1);
...
(lib.effect_c_gitter = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{gitter_stop:0,gitter_play:2,gitter_stop_2:25});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(1).call(this.frame_1).wait(1).call(this.frame_2).wait(22).call(this.frame_24).wait(1).call(this.frame_25).wait(5).call(this.frame_30).wait(1));

	// glitter
	this.instance = new lib.glitter_common_parts1();
	this.instance.parent = this;
	this.instance.setTransform(-110.45,-41.7,0.2,0.2,0,0,0,-0.3,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).wait(22).to({alpha:0},5).wait(1));

	// glitter
	this.instance_1 = new lib.glitter_common_parts1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-61.65,-45.8,0.15,0.15,0,0,0,-0.4,-0.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).wait(19).to({alpha:0},5).wait(1));

	// glitter
	this.instance_2 = new lib.glitter_common_parts1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-40.55,-0.5,0.13,0.13,0,0,0,-0.8,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(9).to({_off:false},0).wait(16).to({alpha:0},5).wait(1));

	// glitter
	this.instance_3 = new lib.glitter_common_parts1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-123.5,-29,0.07,0.07,0,0,0,-0.7,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(11).to({_off:false},0).wait(14).to({alpha:0},5).wait(1));

	// glitter
	this.instance_4 = new lib.glitter_common_parts1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-125.3,12.6,0.0982,0.0982,0,0,0,-1,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(14).to({_off:false},0).wait(11).to({alpha:0},5).wait(1));

	// glitter
	this.instance_5 = new lib.glitter_common_parts1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-107.75,-6.25,0.1048,0.1048,0,0,0,-1,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(15).to({_off:false},0).wait(10).to({alpha:0},5).wait(1));

	// glitter
	this.instance_6 = new lib.glitter_common_parts1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(-82.1,-60.85,0.1048,0.1048,0,0,0,-1,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(17).to({_off:false},0).wait(8).to({alpha:0},5).wait(1));

	// glitter
	this.instance_7 = new lib.glitter_common_parts1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-63.85,11.95,0.077,0.077,0,0,0,-1.3,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(19).to({_off:false},0).wait(6).to({alpha:0},5).wait(1));

	// glitter
	this.instance_8 = new lib.glitter_common_parts1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-35.8,-36,0.0766,0.0766,0,0,0,-1.9,0);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(20).to({_off:false},0).wait(5).to({alpha:0},5).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-128,-63.9,128,79.4);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_10 = new cjs.Graphics().p("Ag8BTIhBguIgQhzQA1gNAAABIBoAPIBgAwIAeA+IgUAtIhZALg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(10).to({graphics:mask_graphics_10,x:43.375,y:101.6214}).wait(2).to({graphics:null,x:0,y:0}).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(10).to({_off:false},0).to({_off:true},2).wait(8));

	// mask_face (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_7 = new cjs.Graphics().p("AiOAdIgbgzIAjhQIBFgHICsBDIA/BFIhGBTIiTAAIAAAAQgCAAhdhRg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(7).to({graphics:mask_1_graphics_7,x:45.225,y:99.207}).wait(3).to({graphics:null,x:0,y:0}).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},3).wait(10));

	// mask_face (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	mask_2.graphics.p("ApwIrIAAxLITrAAIAARLg");
	mask_2.setTransform(63.5,55.501);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-124,144);
...
p.nominalBounds = new cjs.Rectangle(1,1,126,110);
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(59.95,234.55,0.0766,0.0766);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(22.9,226.55,0.1958,0.1958);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(202.35,195,0.1412,0.1412);
	this.instance_2._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(195.7,36.5,0.0849,0.0849);
	this.instance_4._off = true;
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(149.65,254.85,0.1618,0.1618);
	this.instance_5._off = true;
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(233.6,58,0.1362,0.1362);
	this.instance_6._off = true;
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(219,213.95,0.1702,0.1702);
	this.instance_8._off = true;
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(146.9,41.5,0.2555,0.2555);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(35,44,0.1138,0.1138);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.face_blink_ary = [1, 1, 1, 0, 1, 0, 1, 1, 0, 1, 1, 1, 1, 1, 0]; 
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AHcFyIhBgjIgXAHIgTgEIgQgRIgiAAIhZgMIhig+IgQg8Ihfg5IiBhiIh3AUIiDgUIg5gYIhIg4IggAIIgSgMIACgcIhPgQIAZkEQgBgBAJgHIAJgGIBDAiIC2AjIC4BMIBZCBICIAxIE1AlIBlBFIB3BsIAAAUIgnBTIhaBlg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:64.525,y:51.025}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:64,regY:56,x:64,y:56,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:64,regY:56,x:64,y:56,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:63.5,regY:55.5,x:63.5,y:55.5,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:63.5,regY:55.5,x:63.5,y:55.5,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-244,-252,582,700);


(lib.character1_body = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{def:0,nf:1,nh:2});
	...
	this.f.name = "f";
	this.f.parent = this;
	this.f.setTransform(-39,-262);

	this.timeline.addTween(cjs.Tween.get(this.f).to({_off:true},1).wait(1).to({_off:false},0).wait(1));

	// no_hand
	this.instance = new lib.ch_base_no_hand_1();
	this.instance.parent = this;
	this.instance.setTransform(-21,-88,1,1,0,0,0,89,60);
	this.instance._off = true;
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-163,-118);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(3));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-283,-514,593.2,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// effect_c_gitter
	this.c_gitter = new lib.effect_c_gitter();
	this.c_gitter.name = "c_gitter";
	this.c_gitter.parent = this;
	this.c_gitter.setTransform(12.7,12.7,1,1,0,0,0,12.7,12.7);

	this.timeline.addTween(cjs.Tween.get(this.c_gitter).wait(540));

	// effect_look_to_right2
	this.instance_1 = new lib.drop1_v2("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(105.3,-232.3,1.1645,1.1645,0,0,180);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(322).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:130.9,y:-241.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:142.55,y:-245.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:105.3,y:-232.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:130.9,y:-241.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:142.55,y:-245.6,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:105.3,y:-232.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:130.9,y:-241.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:142.55,y:-245.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:105.3,y:-232.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:130.9,y:-241.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:142.55,y:-245.6,alpha:0.2188},0).to({_off:true},1).wait(156).to({_off:false,skewX:0,skewY:180,x:105.3,y:-232.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:130.9,y:-241.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:142.55,y:-245.6,alpha:0.2188},0).to({_off:true},1).wait(31).to({_off:false,skewX:0,skewY:180,x:105.3,y:-232.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:130.9,y:-241.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:142.55,y:-245.6,alpha:0.2188},0).to({_off:true},1).wait(6));

	// effect_look_to_right
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(21,-213,1.4807,1.4807,0,0,180);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(21,-213,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(150.85,-307.85,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(152.85,-304.3,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(101.75,-215.9,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(119.05,-264.8,1.053,1.053,29.448);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(122.8,-282.2,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(90.5,-266.7,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(107.1,-222.55,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(125.55,-279.55,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(19.1,-148.25,1,1,0,0,180);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(93.75,-241.7,0.4532,0.4532,0,0,180);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(96.3,-250.95,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(1,-328,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(24.95,-204.15,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2,p:{scaleX:1.4807,scaleY:1.4807,x:21,y:-213}}]},37).to({state:[{t:this.instance_3}]},10).to({state:[]},10).to({state:[{t:this.instance_4}]},76).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},2).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},15).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},20).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},7).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},6).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},16).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},24).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},5).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},11).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},11).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},2).to({state:[{t:this.instance_13}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},6).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},5).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[]},1).to({state:[{t:this.instance_15}]},2).to({state:[]},12).to({state:[{t:this.instance_16}]},17).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_2,p:{scaleX:2.1735,scaleY:2.1735,x:-77,y:-24}}]},1).to({state:[]},10).to({state:[{t:this.instance_4}]},1).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[]},20).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).wait(11));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-307.9},0).wait(3).to({regX:-28.8,x:150.45,y:-307.75,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:150.85,y:-307.9,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-307.85,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-307.9},0).wait(3).to({regX:-28.8,x:150.45,y:-307.75,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:150.85,y:-307.9,alpha:0},0).to({_off:true},1).wait(316).to({_off:false,regY:20.4,scaleX:1.1856,scaleY:1.1856,rotation:51.9062,x:-136.05,y:-71.95,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1863,scaleY:1.1863,rotation:51.9059,y:-71.85},0).wait(3).to({regX:-28.8,regY:20.5,x:-135.95,y:-71.55,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-136.05,y:-71.85,alpha:0},0).to({_off:true},1).wait(53));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({regX:-30.3,regY:20.4,skewX:-35.827,skewY:144.1725,x:152.9,y:-304.45},0).wait(1).to({regX:-31.4,regY:22.1,x:155.55,y:-303.4,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.4,x:152.9,y:-304.45,alpha:0,startPosition:19},0).to({_off:true},1).wait(360));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:126.7,y:-277.75,alpha:0.5556},0).wait(1).to({x:131.5,y:-285.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:133.45,y:-288.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:132.8,y:-287.65},0).wait(1).to({x:131.75,y:-285.8},0).wait(1).to({x:130,y:-282.7},0).wait(1).to({regX:0,regY:0,x:127.85,y:-278.5},0).to({x:128.6,y:-279.85},2).wait(8).to({regX:-0.2,regY:0.2,x:127.95,y:-279.15,alpha:0.9298},0).wait(1).to({x:126.85,y:-277.2,alpha:0.692},0).wait(1).to({x:125.25,y:-274.35,alpha:0.339},0).wait(1).to({x:124.05,y:-272.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-271.7,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:119.05,y:-264.8},0).wait(1).to({regX:-0.2,regY:0.2,x:126.7,y:-277.75,alpha:0.5556},0).wait(1).to({x:131.5,y:-285.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:133.45,y:-288.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:132.8,y:-287.65},0).wait(1).to({x:131.75,y:-285.8},0).wait(1).to({x:130,y:-282.7},0).wait(1).to({regX:0,regY:0,x:127.85,y:-278.5},0).to({x:128.6,y:-279.85},2).wait(3).to({regX:-0.2,regY:0.2,x:127.95,y:-279.15,alpha:0.9298},0).wait(1).to({x:126.85,y:-277.2,alpha:0.692},0).wait(1).to({x:125.25,y:-274.35,alpha:0.339},0).wait(1).to({x:124.05,y:-272.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-271.7,alpha:0},0).to({_off:true},1).wait(293));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:91.5,y:-263},0).wait(1).to({y:-259.15},0).wait(1).to({y:-255.9},0).wait(1).to({y:-253.25},0).wait(1).to({y:-251.15},0).wait(1).to({y:-249.65},0).wait(1).to({y:-248.75},0).wait(1).to({regX:-0.5,regY:0.2,x:90.5,y:-247.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:91.5,y:-248.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:90.5,y:-247.7,alpha:0},0).to({_off:true},1).wait(153).to({_off:false,y:-266.7,alpha:1},0).wait(1).to({regX:0.5,regY:-0.6,x:91.5,y:-263},0).wait(1).to({y:-259.15},0).wait(1).to({y:-255.9},0).wait(1).to({y:-253.25},0).wait(1).to({y:-251.15},0).wait(1).to({y:-249.65},0).wait(1).to({y:-248.75},0).wait(1).to({regX:-0.5,regY:0.2,x:90.5,y:-247.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:91.5,y:-248.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:90.5,y:-247.7,alpha:0},0).to({_off:true},1).wait(77));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-217.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-216.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:107.1,y:-222.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-222.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-222.25,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:107.1,y:-222.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-217.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-216.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:107.1,y:-222.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-222.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-222.25,alpha:0.2188},0).to({_off:true},1).wait(156).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:107.1,y:-222.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-217.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-216.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:107.1,y:-222.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-222.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-222.25,alpha:0.2188},0).to({_off:true},1).wait(27).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:107.1,y:-222.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-217.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-216.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:107.1,y:-222.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:138.525,y:-222.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:149,y:-222.25,alpha:0.2188},0).to({_off:true},1).wait(11));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:20.1,y:-147.25,alpha:1},0).wait(1).to({regX:0.9,x:20.2,y:-146.3,alpha:0.8965},0).wait(1).to({x:21.55,y:-145.1,alpha:0.7636},0).wait(1).to({x:23.15,y:-143.65,alpha:0.6048},0).wait(1).to({x:24.95,y:-142.05,alpha:0.4229},0).wait(1).to({x:26.95,y:-140.2,alpha:0.2205},0).wait(1).to({regX:0,x:30.1,y:-138.25,alpha:0},0).to({_off:true},1).wait(181));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:95.5,y:-255.85},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:98.75,y:-261.7},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:96.2,y:-259.55},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:95.65,y:-256.3},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:96.75,y:-251.7},0).to({scaleX:1,scaleY:1,x:97.75,y:-255.7},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:95.15,y:-254.7,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:96.75,y:-255.45,alpha:0.1016},0).to({_off:true},1).wait(157));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-254.7},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-255.95},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(138));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:8,regY:-164,x:8,y:-172.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:8,regY:-164,x:8,y:-173.2},0).wait(1).to({y:-170.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:8,regY:-164,x:8,y:-169.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:8,regY:-164,x:8,y:-169.75},0).wait(1).to({y:-162.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:8,regY:-164,x:8,y:-160.75},0).wait(1).to({y:-163.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:8,regY:-164,x:8,y:-168.95},0).wait(1).to({y:-163.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:8,regY:-164,x:8,y:-168.95},0).wait(1).to({y:-163.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:8,regY:-164,x:8,y:-163.1},0).wait(1).to({y:-163.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:8,regY:-164,x:8,y:-173},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:8,regY:-164,x:8,y:-176.95},0).wait(1).to({y:-173.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:8,regY:-164,x:8,y:-162},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:8,regY:-164,x:8,y:-164.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:8,regY:-164,x:8,y:-173},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:8,regY:-164,x:8,y:-176.95},0).wait(1).to({y:-173.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:8,regY:-164,x:8,y:-162},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:8,regY:-164,x:8,y:-164.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:8,regY:-164,x:8,y:-163.4},0).wait(1).to({y:-161},0).wait(1).to({y:-158.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:8,regY:-164,x:8,y:-158.65},0).wait(1).to({y:-161},0).wait(1).to({y:-163.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:8,regY:-164,x:8,y:-163.9},0).wait(1).to({y:-163.5},0).wait(1).to({y:-162.75},0).wait(1).to({y:-161.75},0).wait(1).to({y:-161},0).wait(1).to({y:-160.6},0).wait(1).to({regX:0,regY:0,x:0,y:3.55},0).wait(1).to({regX:8,regY:-164,x:8,y:-160.6},0).wait(1).to({y:-161},0).wait(1).to({y:-161.75},0).wait(1).to({y:-162.75},0).wait(1).to({y:-163.5},0).wait(1).to({y:-163.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:8,regY:-164,x:8,y:-159.25},0).wait(1).to({y:-162.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:8,regY:-164,x:8,y:-161.8},0).wait(1).to({y:-163.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:8,regY:-164,rotation:0.0244,x:8.05,y:-163.95},0).wait(1).to({rotation:0.1092,x:8.4,y:-163.65},0).wait(1).to({rotation:0.275,x:9.15,y:-163.05},0).wait(1).to({rotation:0.538,x:10.25,y:-162.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:11.65,y:-161},0).wait(1).to({rotation:1.1673,x:12.9,y:-159.95},0).wait(1).to({rotation:1.367,x:13.7,y:-159.2},0).wait(1).to({rotation:1.4695,x:14.15,y:-158.85},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:8,regY:-164,rotation:1.479,x:14.15,y:-158.9},0).wait(1).to({rotation:1.4111,x:13.85,y:-159.1},0).wait(1).to({rotation:1.2801,x:13.3,y:-159.55},0).wait(1).to({rotation:1.0711,x:12.4,y:-160.3},0).wait(1).to({rotation:0.7884,x:11.25,y:-161.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:10,y:-162.35},0).wait(1).to({rotation:0.2415,x:8.95,y:-163.15},0).wait(1).to({rotation:0.0832,x:8.3,y:-163.75},0).wait(1).to({rotation:0.0011,x:8,y:-164},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:8,regY:-164,rotation:0.0244,x:8.05,y:-163.95},0).wait(1).to({rotation:0.1092,x:8.4,y:-163.65},0).wait(1).to({rotation:0.275,x:9.15,y:-163.05},0).wait(1).to({rotation:0.538,x:10.25,y:-162.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:11.65,y:-161},0).wait(1).to({rotation:1.1673,x:12.9,y:-159.95},0).wait(1).to({rotation:1.367,x:13.7,y:-159.2},0).wait(1).to({rotation:1.4695,x:14.15,y:-158.85},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:8,regY:-164,rotation:1.4793,x:14.15,y:-158.9},0).wait(1).to({rotation:1.4124,x:13.85,y:-159.1},0).wait(1).to({rotation:1.2834,x:13.3,y:-159.55},0).wait(1).to({rotation:1.0775,x:12.45,y:-160.3},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:11.3,y:-161.25},0).wait(1).to({rotation:0.5016,x:10.05,y:-162.35},0).wait(1).to({rotation:0.2603,x:9,y:-163.15},0).wait(1).to({rotation:0.1043,x:8.35,y:-163.75},0).wait(1).to({rotation:0.0235,x:8.05,y:-164},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:8,regY:-164,x:8,y:-169.55},0).wait(1).to({y:-171.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:8,regY:-164,x:8,y:-171.35},0).wait(1).to({y:-169.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:8,regY:-164,x:8,y:-172.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:8,regY:-164,x:8,y:-173.2},0).wait(1).to({y:-170.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:8,regY:-164,rotation:-0.0253,x:7.95,y:-163.9},0).wait(1).to({rotation:-0.1129,x:7.8,y:-163.35},0).wait(1).to({rotation:-0.2845,x:7.55,y:-162.4},0).wait(1).to({rotation:-0.5565,x:7.1,y:-160.9},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:6.6,y:-158.9},0).wait(1).to({rotation:-1.2075,x:6.1,y:-157.1},0).wait(1).to({rotation:-1.4141,x:5.75,y:-155.95},0).wait(1).to({rotation:-1.5201,x:5.6,y:-155.3},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:8,regY:-164,rotation:-1.5305,x:5.55,y:-155.25},0).wait(1).to({rotation:-1.4624,x:5.65,y:-155.65},0).wait(1).to({rotation:-1.3309,x:5.9,y:-156.45},0).wait(1).to({rotation:-1.121,x:6.2,y:-157.65},0).wait(1).to({rotation:-0.8372,x:6.65,y:-159.3},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:7.1,y:-161.05},0).wait(1).to({rotation:-0.2881,x:7.5,y:-162.5},0).wait(1).to({rotation:-0.1291,x:7.75,y:-163.4},0).wait(1).to({rotation:-0.0467,x:7.85,y:-163.9},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:8,regY:-164,rotation:0.1421,x:8.55,y:-163.55},0).wait(1).to({rotation:0.6998,x:10.9,y:-161.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:13.55,y:-159.35},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:8,regY:-164,rotation:1.4399,x:13.95,y:-159},0).wait(1).to({rotation:1.2196,x:13.05,y:-159.8},0).wait(1).to({rotation:0.7884,x:11.25,y:-161.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:9.25,y:-162.9},0).wait(1).to({rotation:0.0482,x:8.15,y:-163.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:8,regY:-164,rotation:0.0865,x:8.35,y:-163.75},0).wait(1).to({rotation:0.4213,x:9.75,y:-162.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:12.15,y:-160.5},0).wait(1).to({rotation:1.3945,x:13.85,y:-159.1},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:8,regY:-164,rotation:1.4399,x:13.95,y:-159},0).wait(1).to({rotation:1.2196,x:13.05,y:-159.8},0).wait(1).to({rotation:0.7884,x:11.25,y:-161.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:9.25,y:-162.9},0).wait(1).to({rotation:0.0482,x:8.15,y:-163.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:8,regY:-164,x:8,y:-172.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:8,regY:-164,x:8,y:-173.2},0).wait(1).to({y:-170.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:8,regY:-164,x:5.25,y:-156.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:8,regY:-164,x:8,y:-151.75},0).wait(1).to({y:-154.7},0).wait(1).to({y:-159.65},0).wait(1).to({y:-163.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:8,regY:-164,x:8,y:-163},0).wait(1).to({y:-157.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:8,regY:-164,x:8,y:-156.2},0).wait(1).to({y:-160.5},0).wait(1).to({y:-164.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:8,regY:-164,x:8,y:-164.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:8,regY:-164,x:8,y:-170.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:8,regY:-164,x:8,y:-170.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:8,regY:-164,x:8,y:-172.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:8,regY:-164,x:8,y:-173.2},0).wait(1).to({y:-170.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:8,regY:-164,x:5.25,y:-156.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:8,regY:-164,x:8,y:-153.25},0).wait(1).to({y:-161},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:8,regY:-164,x:8,y:-165},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:8,regY:-164,x:8,y:-164.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:8,regY:-164,x:8,y:-163.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:8,regY:-164,x:8,y:-163.4},0).wait(1).to({y:-161},0).wait(1).to({y:-158.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:8,regY:-164,x:8,y:-158.6},0).wait(1).to({y:-158.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:8,regY:-164,x:8,y:-159.4},0).wait(1).to({y:-160.9},0).wait(1).to({y:-163.15},0).wait(1).to({y:-164.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:8,regY:-164,x:8,y:-164.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:8,regY:-164,x:8,y:-171.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:8,regY:-164,x:8,y:-173.2},0).wait(1).to({y:-170.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:8,regY:-164,x:8,y:-171.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:8,regY:-164,x:8,y:-172},0).wait(1).to({y:-166},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:8,regY:-164,x:8,y:-159.35},0).wait(1).to({y:-160.55},0).wait(1).to({y:-162.5},0).wait(1).to({y:-163.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:8,regY:-164,x:8,y:-168.95},0).wait(1).to({y:-163.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:8,regY:-164,x:8,y:-168.95},0).wait(1).to({y:-163.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:8,regY:-164,x:8,y:-163.1},0).wait(1).to({y:-163.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:8,regY:-164,x:11,y:-160.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:8,regY:-164,x:7.15,y:-154.55},0).wait(1).to({x:7.8,y:-154.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:8,regY:-164,x:8,y:-154.7},0).wait(1).to({y:-157.15},0).wait(1).to({y:-160.85},0).wait(1).to({y:-163.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(70).to({regX:8,regY:-164,rotation:0.0314,x:8.1,y:-163.9},0).wait(1).to({rotation:0.1421,x:8.55,y:-163.55},0).wait(1).to({rotation:0.3622,x:9.5,y:-162.75},0).wait(1).to({rotation:0.6998,x:10.9,y:-161.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.065,x:12.45,y:-160.25},0).wait(1).to({rotation:1.327,x:13.55,y:-159.35},0).wait(1).to({rotation:1.4612,x:14.1,y:-158.9},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:8,regY:-164,rotation:1.474,x:14.1,y:-158.9},0).wait(1).to({rotation:1.388,x:13.75,y:-159.2},0).wait(1).to({rotation:1.2196,x:13.05,y:-159.8},0).wait(1).to({rotation:0.9527,x:11.95,y:-160.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.6176,x:10.5,y:-161.85},0).wait(1).to({rotation:0.3138,x:9.25,y:-162.9},0).wait(1).to({rotation:0.1111,x:8.4,y:-163.65},0).wait(1).to({rotation:0.007,x:8,y:-164},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(4).to({rotation:0},0).wait(1).to({regX:8,regY:-164,rotation:0.0314,x:8.1,y:-163.9},0).wait(1).to({rotation:0.1421,x:8.55,y:-163.55},0).wait(1).to({rotation:0.3622,x:9.5,y:-162.75},0).wait(1).to({rotation:0.6998,x:10.9,y:-161.6},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.065,x:12.45,y:-160.25},0).wait(1).to({rotation:1.327,x:13.55,y:-159.35},0).wait(1).to({rotation:1.4612,x:14.1,y:-158.9},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:8,regY:-164,rotation:1.474,x:14.1,y:-158.9},0).wait(1).to({rotation:1.388,x:13.75,y:-159.2},0).wait(1).to({rotation:1.2196,x:13.05,y:-159.8},0).wait(1).to({rotation:0.9527,x:11.95,y:-160.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.6176,x:10.5,y:-161.85},0).wait(1).to({rotation:0.3138,x:9.25,y:-162.9},0).wait(1).to({rotation:0.1111,x:8.4,y:-163.65},0).wait(1).to({rotation:0.007,x:8,y:-164},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-493.2,-712.1,925.8,920.6);
...
// stage content:
(lib._397_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:231,scene2:232,end2:424,scene3:425,end3:607,scene4:608,end4:819,scene5:820,end5:1006,scene6:1007,end6:1184,scene7:1185,end7:1436});
	...
	this.frame_15 = function() {
		exportRoot._g.m1 = "役者は揃い……";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
		
		this.ch1.c.gotoAndStop("nh");
		
		exportRoot._u.setFace("ch1", 6);
	}
	this.frame_39 = function() {
		exportRoot._g.m1 = "役者は揃い……今､";
		exportRoot._u.setText();
	...
	this.frame_232 = function() {
		...
		this.ch1.c_gitter.gotoAndPlay("gitter_stop");
		
		exportRoot._u.setFace("ch1", 6);
	}
	this.frame_258 = function() {
		exportRoot._g.m1 = "闇より賜いし､我が至宝! ";
		exportRoot._u.setText();
	...
	this.frame_260 = function() {
		this.ch1.gotoAndPlay("normal_flower");
		this.ch1.c_gitter.gotoAndPlay("gitter_play");
	}
	this.frame_284 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "瞬間から､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch1", 6);
	}
	this.frame_304 = function() {
		exportRoot._g.m2 = "瞬間から､所有権は";
		exportRoot._u.setText();
	...
	this.frame_425 = function() {
		...
		this.ch1.c_gitter.gotoAndPlay("gitter_stop");
		this.ch2.c_gitter.gotoAndPlay("gitter_stop");
	...
	this.frame_625 = function() {
		exportRoot._g.m1 = "混沌､破壊､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 8);
	}
	this.frame_644 = function() {
		exportRoot._g.m1 = "混沌､破壊､そして､";
		exportRoot._u.setText();
	...
	this.frame_820 = function() {
		...
		this.ch2.gotoAndPlay("shy2");
	}
	this.frame_849 = function() {
		exportRoot._g.m1 = "えっと……貴方に､";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_1003 = function() {
		this.ch2.gotoAndPlay("c_check");
		this.ch2.c_gitter.gotoAndPlay("gitter_play");
	}
	...
	this.frame_1007 = function() {
		...
		this.ch2.c_gitter.gotoAndPlay("gitter_stop_2");
		exportRoot._u.setFace("ch2", 11);
	}
	this.frame_1031 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "いるように､";
		exportRoot._u.setText();
		
		exportRoot._u.setFace("ch2", 10);
	}
	this.frame_1064 = function() {
		exportRoot._g.m2 = "いるように､頬が熱い……";
		exportRoot._u.setText();
	...
	this.frame_1377 = function() {
		exportRoot._g.m4 = "親愛なる貴方に､";
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(24).call(this.frame_39).wait(13).call(this.frame_52).wait(27).call(this.frame_79).wait(16).call(this.frame_95).wait(51).call(this.frame_146).wait(16).call(this.frame_162).wait(40).call(this.frame_202).wait(18).call(this.frame_220).wait(11).call(this.frame_231).wait(1).call(this.frame_232).wait(26).call(this.frame_258).wait(2).call(this.frame_260).wait(24).call(this.frame_284).wait(20).call(this.frame_304).wait(11).call(this.frame_315).wait(39).call(this.frame_354).wait(34).call(this.frame_388).wait(36).call(this.frame_424).wait(1).call(this.frame_425).wait(37).call(this.frame_462).wait(29).call(this.frame_491).wait(37).call(this.frame_528).wait(30).call(this.frame_558).wait(10).call(this.frame_568).wait(39).call(this.frame_607).wait(1).call(this.frame_608).wait(17).call(this.frame_625).wait(19).call(this.frame_644).wait(14).call(this.frame_658).wait(35).call(this.frame_693).wait(24).call(this.frame_717).wait(42).call(this.frame_759).wait(29).call(this.frame_788).wait(31).call(this.frame_819).wait(1).call(this.frame_820).wait(29).call(this.frame_849).wait(20).call(this.frame_869).wait(38).call(this.frame_907).wait(16).call(this.frame_923).wait(58).call(this.frame_981).wait(22).call(this.frame_1003).wait(3).call(this.frame_1006).wait(1).call(this.frame_1007).wait(24).call(this.frame_1031).wait(33).call(this.frame_1064).wait(35).call(this.frame_1099).wait(13).call(this.frame_1112).wait(28).call(this.frame_1140).wait(31).call(this.frame_1171).wait(13).call(this.frame_1184).wait(1).call(this.frame_1185).wait(31).call(this.frame_1216).wait(32).call(this.frame_1248).wait(17).call(this.frame_1265).wait(50).call(this.frame_1315).wait(27).call(this.frame_1342).wait(35).call(this.frame_1377).wait(37).call(this.frame_1414).wait(22).call(this.frame_1436).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1441));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1436).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1441));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1422));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1426));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1435));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1337).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1377).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.6},0).wait(1).to({y:378.9},0).wait(1).to({y:375.6},0).wait(1).to({y:370.25},0).wait(1).to({y:362.8},0).wait(1).to({y:354.45},0).wait(1).to({y:347.5},0).wait(1).to({y:342.95},0).wait(1).to({y:340.65},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(51));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1377).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1377).to({_off:false},0).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1377).to({_off:false},0).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1365).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(201).to({_off:false},0).to({alpha:1},10).wait(3).to({alpha:0},12).to({_off:true},1).wait(939).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(248));

	// first_scene
	this.instance_11 = new lib.dark();
	this.instance_11.parent = this;
	this.instance_11.setTransform(240,310,1,1,0,0,0,120,155);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({_off:true},15).wait(1426));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:-3.2},0).wait(1).to({y:-6.85},0).wait(1).to({y:-12.75},0).wait(1).to({y:-20.7},0).wait(1).to({y:-30.4},0).wait(1).to({y:-41.5},0).wait(1).to({y:-53.55},0).wait(1).to({y:-65.9},0).wait(1).to({y:-78.05},0).wait(1).to({y:-89.25},0).wait(1).to({y:-98.95},0).wait(1).to({y:-106.45},0).wait(1).to({y:-111.3},0).wait(1).to({regX:0,x:120,y:-113},0).to({_off:true},203).wait(1209));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).wait(1).to({regX:1,x:121,y:308.45},0).wait(1).to({y:309.8},0).wait(1).to({y:312.05},0).wait(1).to({y:315.05},0).wait(1).to({y:318.75},0).wait(1).to({y:322.95},0).wait(1).to({y:327.5},0).wait(1).to({y:332.15},0).wait(1).to({y:336.75},0).wait(1).to({y:341},0).wait(1).to({y:344.65},0).wait(1).to({y:347.5},0).wait(1).to({y:349.35},0).wait(1).to({regX:0,x:120,y:350},0).to({_off:true},203).wait(1209));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(1099).to({_off:false},0).to({alpha:1},41).to({_off:true},45).wait(256));
	...
	this.lighter_tgt_1.compositeOperation = "lighter";
	this.lighter_tgt_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(1099).to({_off:false},0).to({alpha:0.4492},41).to({_off:true},45).wait(256));

	// ch
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-717,514);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.3,scaleX:0.57,scaleY:0.57,x:134.15,y:236},0).wait(1).to({regX:-41.4,regY:-263.8,x:110.25,y:85.65},0).wait(1).to({x:110.1},0).wait(1).to({x:109.95},0).wait(1).to({x:109.8},0).wait(1).to({x:109.7},0).wait(1).to({x:109.55},0).wait(1).to({x:109.4},0).wait(1).to({x:109.25},0).wait(1).to({x:109.1},0).wait(1).to({x:108.95},0).wait(1).to({x:108.8},0).wait(1).to({x:108.65},0).wait(1).to({x:108.45},0).wait(1).to({x:108.3},0).wait(1).to({x:108.15},0).wait(1).to({x:108},0).wait(1).to({x:107.8},0).wait(1).to({x:107.65},0).wait(1).to({x:107.5},0).wait(1).to({x:107.3},0).wait(1).to({x:107.15},0).wait(1).to({x:106.95},0).wait(1).to({x:106.8},0).wait(1).to({x:106.6},0).wait(1).to({x:106.45},0).wait(1).to({x:106.25},0).wait(1).to({x:106.1},0).wait(1).to({x:105.9},0).wait(1).to({x:105.7},0).wait(1).to({x:105.55},0).wait(1).to({x:105.35},0).wait(1).to({x:105.15},0).wait(1).to({x:104.95},0).wait(1).to({x:104.75},0).wait(1).to({x:104.6},0).wait(1).to({x:104.4},0).wait(1).to({x:104.2},0).wait(1).to({x:104},0).wait(1).to({x:103.8},0).wait(1).to({x:103.6},0).wait(1).to({x:103.4},0).wait(1).to({x:103.2},0).wait(1).to({x:103},0).wait(1).to({x:102.8},0).wait(1).to({x:102.6},0).wait(1).to({x:102.4},0).wait(1).to({x:102.2},0).wait(1).to({x:102},0).wait(1).to({x:101.8},0).wait(1).to({x:101.6},0).wait(1).to({x:101.4},0).wait(1).to({x:101.2},0).wait(1).to({x:101},0).wait(1).to({x:100.8},0).wait(1).to({x:100.55},0).wait(1).to({x:100.35},0).wait(1).to({x:100.15},0).wait(1).to({x:99.95},0).wait(1).to({x:99.75},0).wait(1).to({x:99.55},0).wait(1).to({x:99.35},0).wait(1).to({x:99.15},0).wait(1).to({x:98.95},0).wait(1).to({x:98.75},0).wait(1).to({x:98.5},0).wait(1).to({x:98.3},0).wait(1).to({x:98.1},0).wait(1).to({x:97.9},0).wait(1).to({x:97.7},0).wait(1).to({x:97.5},0).wait(1).to({x:97.3},0).wait(1).to({x:97.1},0).wait(1).to({x:96.9},0).wait(1).to({x:96.7},0).wait(1).to({x:96.5},0).wait(1).to({x:96.35},0).wait(1).to({x:96.15},0).wait(1).to({x:95.95},0).wait(1).to({x:95.75},0).wait(1).to({x:95.55},0).wait(1).to({x:95.35},0).wait(1).to({x:95.15},0).wait(1).to({x:95},0).wait(1).to({x:94.8},0).wait(1).to({x:94.6},0).wait(1).to({x:94.45},0).wait(1).to({x:94.25},0).wait(1).to({x:94.05},0).wait(1).to({x:93.9},0).wait(1).to({x:93.7},0).wait(1).to({x:93.55},0).wait(1).to({x:93.35},0).wait(1).to({x:93.2},0).wait(1).to({x:93},0).wait(1).to({x:92.85},0).wait(1).to({x:92.7},0).wait(1).to({x:92.5},0).wait(1).to({x:92.35},0).wait(1).to({x:92.2},0).wait(1).to({x:92},0).wait(1).to({x:91.85},0).wait(1).to({x:91.7},0).wait(1).to({x:91.55},0).wait(1).to({x:91.4},0).wait(1).to({x:91.25},0).wait(1).to({x:91.1},0).wait(1).to({x:90.95},0).wait(1).to({x:90.8},0).wait(1).to({x:90.65},0).wait(1).to({x:90.5},0).wait(1).to({x:90.4},0).wait(1).to({x:90.25},0).wait(1).to({x:90.1},0).wait(1).to({x:89.95},0).wait(1).to({x:89.85},0).wait(1).to({x:89.7},0).wait(1).to({x:89.6},0).wait(1).to({x:89.45},0).wait(1).to({x:89.35},0).wait(1).to({x:89.2},0).wait(1).to({x:89.1},0).wait(1).to({x:88.95},0).wait(1).to({x:88.85},0).wait(1).to({x:88.75},0).wait(1).to({x:88.65},0).wait(1).to({x:88.5},0).wait(1).to({x:88.4},0).wait(1).to({x:88.3},0).wait(1).to({x:88.2},0).wait(1).to({x:88.1},0).wait(1).to({x:88},0).wait(1).to({x:87.9},0).wait(1).to({x:87.8},0).wait(1).to({x:87.7},0).wait(1).to({x:87.6},0).wait(1).to({x:87.55},0).wait(1).to({x:87.45},0).wait(1).to({x:87.35},0).wait(1).to({x:87.25},0).wait(1).to({x:87.2},0).wait(1).to({x:87.1},0).wait(1).to({x:87.05},0).wait(1).to({x:86.95},0).wait(1).to({x:86.9},0).wait(1).to({x:86.8},0).wait(1).to({x:86.75},0).wait(1).to({x:86.65},0).wait(1).to({x:86.6},0).wait(1).to({x:86.55},0).wait(1).to({x:86.45},0).wait(1).to({x:86.4},0).wait(1).to({x:86.35},0).wait(1).to({x:86.3},0).wait(1).to({x:86.25},0).wait(1).to({x:86.2},0).wait(1).to({x:86.15},0).wait(1).to({x:86.1},0).wait(1).to({x:86.05},0).wait(1).to({x:86},0).wait(1).to({x:85.95},0).wait(1).to({x:85.9},0).wait(1).to({x:85.85},0).wait(1).to({x:85.8},0).wait(2).to({x:85.75},0).wait(1).to({x:85.7},0).wait(2).to({x:85.65},0).wait(1).to({x:85.6},0).wait(2).to({x:85.55},0).wait(2).to({x:85.5},0).wait(3).to({x:85.45},0).wait(3).to({x:85.4},0).wait(8).to({regX:0.3,regY:0,x:109.15,y:236},0).wait(19).to({regX:-41.4,regY:-263.8,x:85.4,y:85.7},0).wait(1).to({y:85.95},0).wait(1).to({y:86.5},0).wait(1).to({y:87.35},0).wait(1).to({scaleX:0.5699,scaleY:0.5699,y:88.65},0).wait(1).to({y:90.4},0).wait(1).to({y:92.1},0).wait(1).to({y:93.4},0).wait(1).to({y:94.2},0).wait(1).to({y:94.6},0).wait(1).to({regX:0.8,regY:0.2,x:109.15,y:245.1},0).wait(1).to({regX:0.6,regY:0.1,scaleX:0.58,scaleY:0.58,x:124.35,y:221.05},0).wait(1).to({regX:-41.4,regY:-263.8,x:100,y:67.9},0).wait(1).to({y:67.75},0).wait(1).to({y:67.4},0).wait(1).to({y:67},0).wait(1).to({y:66.45},0).wait(1).to({y:65.75},0).wait(1).to({y:65},0).wait(1).to({y:64.2},0).wait(1).to({y:63.3},0).wait(1).to({y:62.4},0).wait(1).to({y:61.5},0).wait(1).to({y:60.65},0).wait(1).to({y:59.85},0).wait(1).to({y:59.05},0).wait(1).to({y:58.35},0).wait(1).to({y:57.75},0).wait(1).to({y:57.15},0).wait(1).to({y:56.7},0).wait(1).to({y:56.25},0).wait(1).to({y:55.9},0).wait(1).to({y:55.6},0).wait(1).to({y:55.35},0).wait(1).to({y:55.2},0).wait(1).to({y:55.05},0).wait(1).to({y:55},0).wait(1).to({regX:0.6,regY:0.1,x:124.35,y:208.05},0).wait(167).to({alpha:0},11,cjs.Ease.quadOut).to({_off:true},1).wait(1004));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(15).to({_off:false},0).to({_off:true},410).wait(1016));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-1000,0);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.1,regY:-0.1,scaleX:0.57,scaleY:0.57,x:-27.05,y:-57.05},0).wait(1).to({regX:291,regY:350,x:138.75,y:142.5},0).wait(1).to({x:138.6},0).wait(1).to({x:138.45},0).wait(1).to({x:138.3},0).wait(1).to({x:138.2},0).wait(1).to({x:138.05},0).wait(1).to({x:137.9},0).wait(1).to({x:137.75},0).wait(1).to({x:137.6},0).wait(1).to({x:137.45},0).wait(1).to({x:137.3},0).wait(1).to({x:137.15},0).wait(1).to({x:136.95},0).wait(1).to({x:136.8},0).wait(1).to({x:136.65},0).wait(1).to({x:136.5},0).wait(1).to({x:136.3},0).wait(1).to({x:136.15},0).wait(1).to({x:136},0).wait(1).to({x:135.8},0).wait(1).to({x:135.65},0).wait(1).to({x:135.45},0).wait(1).to({x:135.3},0).wait(1).to({x:135.1},0).wait(1).to({x:134.95},0).wait(1).to({x:134.75},0).wait(1).to({x:134.6},0).wait(1).to({x:134.4},0).wait(1).to({x:134.2},0).wait(1).to({x:134.05},0).wait(1).to({x:133.85},0).wait(1).to({x:133.65},0).wait(1).to({x:133.45},0).wait(1).to({x:133.25},0).wait(1).to({x:133.1},0).wait(1).to({x:132.9},0).wait(1).to({x:132.7},0).wait(1).to({x:132.5},0).wait(1).to({x:132.3},0).wait(1).to({x:132.1},0).wait(1).to({x:131.9},0).wait(1).to({x:131.7},0).wait(1).to({x:131.5},0).wait(1).to({x:131.3},0).wait(1).to({x:131.1},0).wait(1).to({x:130.9},0).wait(1).to({x:130.7},0).wait(1).to({x:130.5},0).wait(1).to({x:130.3},0).wait(1).to({x:130.1},0).wait(1).to({x:129.9},0).wait(1).to({x:129.7},0).wait(1).to({x:129.5},0).wait(1).to({x:129.3},0).wait(1).to({x:129.05},0).wait(1).to({x:128.85},0).wait(1).to({x:128.65},0).wait(1).to({x:128.45},0).wait(1).to({x:128.25},0).wait(1).to({x:128.05},0).wait(1).to({x:127.85},0).wait(1).to({x:127.65},0).wait(1).to({x:127.45},0).wait(1).to({x:127.25},0).wait(1).to({x:127},0).wait(1).to({x:126.8},0).wait(1).to({x:126.6},0).wait(1).to({x:126.4},0).wait(1).to({x:126.2},0).wait(1).to({x:126},0).wait(1).to({x:125.8},0).wait(1).to({x:125.6},0).wait(1).to({x:125.4},0).wait(1).to({x:125.2},0).wait(1).to({x:125},0).wait(1).to({x:124.85},0).wait(1).to({x:124.65},0).wait(1).to({x:124.45},0).wait(1).to({x:124.25},0).wait(1).to({x:124.05},0).wait(1).to({x:123.85},0).wait(1).to({x:123.65},0).wait(1).to({x:123.5},0).wait(1).to({x:123.3},0).wait(1).to({x:123.1},0).wait(1).to({x:122.95},0).wait(1).to({x:122.75},0).wait(1).to({x:122.55},0).wait(1).to({x:122.4},0).wait(1).to({x:122.2},0).wait(1).to({x:122.05},0).wait(1).to({x:121.85},0).wait(1).to({x:121.7},0).wait(1).to({x:121.5},0).wait(1).to({x:121.35},0).wait(1).to({x:121.2},0).wait(1).to({x:121},0).wait(1).to({x:120.85},0).wait(1).to({x:120.7},0).wait(1).to({x:120.5},0).wait(1).to({x:120.35},0).wait(1).to({x:120.2},0).wait(1).to({x:120.05},0).wait(1).to({x:119.9},0).wait(1).to({x:119.75},0).wait(1).to({x:119.6},0).wait(1).to({x:119.45},0).wait(1).to({x:119.3},0).wait(1).to({x:119.15},0).wait(1).to({x:119},0).wait(1).to({x:118.9},0).wait(1).to({x:118.75},0).wait(1).to({x:118.6},0).wait(1).to({x:118.45},0).wait(1).to({x:118.35},0).wait(1).to({x:118.2},0).wait(1).to({x:118.1},0).wait(1).to({x:117.95},0).wait(1).to({x:117.85},0).wait(1).to({x:117.7},0).wait(1).to({x:117.6},0).wait(1).to({x:117.45},0).wait(1).to({x:117.35},0).wait(1).to({x:117.25},0).wait(1).to({x:117.15},0).wait(1).to({x:117},0).wait(1).to({x:116.9},0).wait(1).to({x:116.8},0).wait(1).to({x:116.7},0).wait(1).to({x:116.6},0).wait(1).to({x:116.5},0).wait(1).to({x:116.4},0).wait(1).to({x:116.3},0).wait(1).to({x:116.2},0).wait(1).to({x:116.1},0).wait(1).to({x:116.05},0).wait(1).to({x:115.95},0).wait(1).to({x:115.85},0).wait(1).to({x:115.75},0).wait(1).to({x:115.7},0).wait(1).to({x:115.6},0).wait(1).to({x:115.55},0).wait(1).to({x:115.45},0).wait(1).to({x:115.4},0).wait(1).to({x:115.3},0).wait(1).to({x:115.25},0).wait(1).to({x:115.15},0).wait(1).to({x:115.1},0).wait(1).to({x:115.05},0).wait(1).to({x:114.95},0).wait(1).to({x:114.9},0).wait(1).to({x:114.85},0).wait(1).to({x:114.8},0).wait(1).to({x:114.75},0).wait(1).to({x:114.7},0).wait(1).to({x:114.65},0).wait(1).to({x:114.6},0).wait(1).to({x:114.55},0).wait(1).to({x:114.5},0).wait(1).to({x:114.45},0).wait(1).to({x:114.4},0).wait(1).to({x:114.35},0).wait(1).to({x:114.3},0).wait(2).to({x:114.25},0).wait(1).to({x:114.2},0).wait(2).to({x:114.15},0).wait(1).to({x:114.1},0).wait(2).to({x:114.05},0).wait(2).to({x:114},0).wait(3).to({x:113.95},0).wait(3).to({x:113.9},0).wait(8).to({regX:-0.1,regY:-0.1,x:-52.05,y:-57.05},0).wait(30).to({scaleX:0.5799,scaleY:0.5799,x:-40.05,y:-77.05},0).wait(1).to({regX:291,regY:350,x:128.75,y:125.95},0).wait(1).to({y:125.8},0).wait(1).to({y:125.45},0).wait(1).to({y:125.05},0).wait(1).to({y:124.5},0).wait(1).to({y:123.8},0).wait(1).to({y:123.05},0).wait(1).to({y:122.25},0).wait(1).to({y:121.35},0).wait(1).to({y:120.45},0).wait(1).to({y:119.55},0).wait(1).to({y:118.7},0).wait(1).to({y:117.9},0).wait(1).to({y:117.1},0).wait(1).to({y:116.4},0).wait(1).to({y:115.8},0).wait(1).to({y:115.2},0).wait(1).to({y:114.75},0).wait(1).to({y:114.3},0).wait(1).to({y:113.95},0).wait(1).to({y:113.65},0).wait(1).to({y:113.4},0).wait(1).to({y:113.25},0).wait(1).to({y:113.1},0).wait(1).to({y:113.05},0).wait(1).to({regX:-0.1,regY:-0.1,x:-40.05,y:-90.05},0).wait(167).to({alpha:0},11,cjs.Ease.quadOut).to({_off:true},1).wait(1004));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(-717,514);
	this.ch2.alpha = 0.0117;

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(425).to({regX:0.9,regY:0.4,scaleX:0.6812,scaleY:0.6812,x:113.05,y:245.95,alpha:1},0).wait(1).to({regX:-41.4,regY:-263.8,x:84.1,y:66.45},0).wait(1).to({x:83.95,y:67},0).wait(1).to({x:83.8,y:67.6},0).wait(1).to({x:83.6,y:68.2},0).wait(1).to({x:83.45,y:68.85},0).wait(1).to({x:83.25,y:69.5},0).wait(1).to({x:83.1,y:70.2},0).wait(1).to({x:82.9,y:70.85},0).wait(1).to({x:82.75,y:71.45},0).wait(1).to({x:82.6,y:72},0).wait(1).to({x:82.45,y:72.55},0).wait(1).to({x:82.3,y:73},0).wait(1).to({x:82.2,y:73.45},0).wait(1).to({x:82.1,y:73.75},0).wait(1).to({x:82.05,y:74.05},0).wait(1).to({x:82,y:74.25},0).wait(1).to({x:81.95,y:74.4},0).wait(1).to({x:81.9,y:74.5},0).wait(1).to({regX:1,regY:0.4,x:110.8,y:254.5},0).wait(165).to({regX:-41.4,regY:-263.8,scaleX:0.6813,scaleY:0.6813,x:81.85,y:74.55},0).wait(1).to({scaleX:0.6814,scaleY:0.6814,y:74.5},0).wait(1).to({scaleX:0.6815,scaleY:0.6815,y:74.45},0).wait(1).to({scaleX:0.6817,scaleY:0.6817},0).wait(1).to({scaleX:0.6821,scaleY:0.6821,x:81.8,y:74.4},0).wait(1).to({scaleX:0.6825,scaleY:0.6825},0).wait(1).to({scaleX:0.6829,scaleY:0.6829},0).wait(1).to({scaleX:0.6835,scaleY:0.6835,x:81.7,y:74.35},0).wait(1).to({scaleX:0.6843,scaleY:0.6843,x:81.65,y:74.25},0).wait(1).to({scaleX:0.6851,scaleY:0.6851,y:74.15},0).wait(1).to({scaleX:0.6861,scaleY:0.6861,x:81.55,y:74.1},0).wait(1).to({scaleX:0.6872,scaleY:0.6872,x:81.45,y:74},0).wait(1).to({scaleX:0.6885,scaleY:0.6885,x:81.4,y:73.9},0).wait(1).to({scaleX:0.69,scaleY:0.69,x:81.3,y:73.75},0).wait(1).to({scaleX:0.6916,scaleY:0.6916,x:81.15,y:73.6},0).wait(1).to({scaleX:0.6935,scaleY:0.6935,x:81.05,y:73.45},0).wait(1).to({scaleX:0.6955,scaleY:0.6955,x:80.9,y:73.3},0).wait(1).to({scaleX:0.6976,scaleY:0.6976,x:80.75,y:73.1},0).wait(1).to({scaleX:0.6999,scaleY:0.6999,x:80.6,y:72.9},0).wait(1).to({scaleX:0.7023,scaleY:0.7023,x:80.5,y:72.7},0).wait(1).to({scaleX:0.7046,scaleY:0.7046,x:80.35,y:72.5},0).wait(1).to({scaleX:0.7069,scaleY:0.7069,x:80.15,y:72.3},0).wait(1).to({scaleX:0.709,scaleY:0.709,x:80,y:72.1},0).wait(1).to({scaleX:0.7109,scaleY:0.7109,x:79.85,y:71.95},0).wait(1).to({scaleX:0.7126,scaleY:0.7126,x:79.75,y:71.8},0).wait(1).to({scaleX:0.7141,scaleY:0.7141,x:79.7,y:71.65},0).wait(1).to({scaleX:0.7154,scaleY:0.7154,x:79.6,y:71.55},0).wait(1).to({scaleX:0.7165,scaleY:0.7165,x:79.5,y:71.45},0).wait(1).to({scaleX:0.7174,scaleY:0.7174,x:79.45,y:71.4},0).wait(1).to({scaleX:0.7182,scaleY:0.7182,x:79.4,y:71.3},0).wait(1).to({scaleX:0.7188,scaleY:0.7188,x:79.35,y:71.25},0).wait(1).to({scaleX:0.7192,scaleY:0.7192,x:79.3,y:71.2},0).wait(1).to({scaleX:0.7196,scaleY:0.7196},0).wait(1).to({scaleX:0.7198,scaleY:0.7198,y:71.15},0).wait(1).to({scaleX:0.7199,scaleY:0.7199,y:71.2},0).wait(1).to({regX:1.1,regY:0.5,scaleX:0.72,scaleY:0.72,x:109.8,y:261.35},0).wait(337).to({x:129.8,y:201.35},22,cjs.Ease.quadInOut).wait(4).to({regX:-41.4,regY:-263.8,x:99.1,y:11.2},0).wait(1).to({x:98.9,y:11.7},0).wait(1).to({x:98.6,y:12.5},0).wait(1).to({x:98.1,y:13.7},0).wait(1).to({x:97.4,y:15.4},0).wait(1).to({x:96.5,y:17.55},0).wait(1).to({x:95.35,y:20.25},0).wait(1).to({x:94,y:23.45},0).wait(1).to({x:92.45,y:27.2},0).wait(1).to({x:90.75,y:31.3},0).wait(1).to({x:88.9,y:35.7},0).wait(1).to({x:87.05,y:40.2},0).wait(1).to({x:85.25,y:44.55},0).wait(1).to({x:83.55,y:48.65},0).wait(1).to({x:81.95,y:52.35},0).wait(1).to({x:80.6,y:55.7},0).wait(1).to({x:79.35,y:58.65},0).wait(1).to({x:78.3,y:61.2},0).wait(1).to({x:77.4,y:63.35},0).wait(1).to({x:76.6,y:65.2},0).wait(1).to({x:76,y:66.75},0).wait(1).to({x:75.45,y:68},0).wait(1).to({x:75.05,y:69},0).wait(1).to({x:74.7,y:69.8},0).wait(1).to({x:74.45,y:70.4},0).wait(1).to({x:74.3,y:70.75},0).wait(1).to({x:74.2,y:71},0).wait(1).to({regX:1.1,regY:0.5,x:104.8,y:261.35},0).wait(66).to({regX:-41.4,regY:-263.8,x:74.15,y:71.05},0).wait(1).to({scaleX:0.7202,scaleY:0.7202},0).wait(1).to({scaleX:0.7205,scaleY:0.7205,x:74.1},0).wait(1).to({scaleX:0.721,scaleY:0.721,y:71},0).wait(1).to({scaleX:0.7216,scaleY:0.7216,y:70.95},0).wait(1).to({scaleX:0.7224,scaleY:0.7224,x:74},0).wait(1).to({scaleX:0.7233,scaleY:0.7233,x:73.95,y:70.9},0).wait(1).to({scaleX:0.7244,scaleY:0.7244,x:73.85,y:70.8},0).wait(1).to({scaleX:0.7258,scaleY:0.7258,x:73.75,y:70.75},0).wait(1).to({scaleX:0.7274,scaleY:0.7274,x:73.65,y:70.65},0).wait(1).to({scaleX:0.7292,scaleY:0.7292,x:73.5,y:70.55},0).wait(1).to({scaleX:0.7313,scaleY:0.7313,x:73.4,y:70.45},0).wait(1).to({scaleX:0.7336,scaleY:0.7336,x:73.2,y:70.3},0).wait(1).to({scaleX:0.7363,scaleY:0.7363,x:73,y:70.15},0).wait(1).to({scaleX:0.7394,scaleY:0.7394,x:72.8,y:70},0).wait(1).to({scaleX:0.7427,scaleY:0.7427,x:72.55,y:69.8},0).wait(1).to({scaleX:0.7465,scaleY:0.7465,x:72.3,y:69.65},0).wait(1).to({scaleX:0.7506,scaleY:0.7506,x:72,y:69.4},0).wait(1).to({scaleX:0.755,scaleY:0.755,x:71.7,y:69.15},0).wait(1).to({scaleX:0.7598,scaleY:0.7598,x:71.35,y:68.9},0).wait(1).to({scaleX:0.7649,scaleY:0.7649,x:71,y:68.65},0).wait(1).to({scaleX:0.7702,scaleY:0.7702,x:70.6,y:68.4},0).wait(1).to({scaleX:0.7755,scaleY:0.7755,x:70.25,y:68.05},0).wait(1).to({scaleX:0.7808,scaleY:0.7808,x:69.9,y:67.8},0).wait(1).to({scaleX:0.7859,scaleY:0.7859,x:69.45,y:67.55},0).wait(1).to({scaleX:0.7907,scaleY:0.7907,x:69.15,y:67.25},0).wait(1).to({scaleX:0.7952,scaleY:0.7952,x:68.85,y:67.05},0).wait(1).to({scaleX:0.7992,scaleY:0.7992,x:68.55,y:66.8},0).wait(1).to({scaleX:0.8028,scaleY:0.8028,x:68.25,y:66.6},0).wait(1).to({scaleX:0.806,scaleY:0.806,x:68.1,y:66.45},0).wait(1).to({scaleX:0.8088,scaleY:0.8088,x:67.85,y:66.3},0).wait(1).to({scaleX:0.8113,scaleY:0.8113,x:67.65,y:66.2},0).wait(1).to({scaleX:0.8133,scaleY:0.8133,x:67.55,y:66.05},0).wait(1).to({scaleX:0.815,scaleY:0.815,x:67.4,y:66},0).wait(1).to({scaleX:0.8165,scaleY:0.8165,x:67.3,y:65.9},0).wait(1).to({scaleX:0.8176,scaleY:0.8176,x:67.25,y:65.8},0).wait(1).to({scaleX:0.8185,scaleY:0.8185,x:67.15},0).wait(1).to({scaleX:0.8192,scaleY:0.8192,y:65.75},0).wait(1).to({scaleX:0.8196,scaleY:0.8196,x:67.1},0).wait(1).to({scaleX:0.8199,scaleY:0.8199,x:67.05,y:65.7},0).wait(1).to({regX:1.2,regY:0.6,scaleX:0.82,scaleY:0.82,x:102,y:282.5},0).wait(45).to({scaleX:0.5,scaleY:0.5,x:110.6,y:219.3},0).to({_off:true},192).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(425).to({_off:false},0).to({_off:true},952).wait(64));

	// bg_blur
	this.bg_blur = new lib.bg_zoom_half_blur();
	this.bg_blur.name = "bg_blur";
	this.bg_blur.parent = this;
	this.bg_blur.setTransform(-1000,0);
	this.bg_blur.alpha = 0.0117;

	this.timeline.addTween(cjs.Tween.get(this.bg_blur).wait(425).to({regX:-0.1,regY:-0.3,scaleX:0.6812,scaleY:0.6812,x:-80.5,y:-104.3,alpha:1},0).wait(1).to({regX:291,regY:350,x:117.7,y:134.8},0).wait(1).to({x:117.55,y:135.35},0).wait(1).to({x:117.4,y:135.95},0).wait(1).to({x:117.2,y:136.55},0).wait(1).to({x:117.05,y:137.2},0).wait(1).to({x:116.85,y:137.9},0).wait(1).to({x:116.7,y:138.55},0).wait(1).to({x:116.5,y:139.2},0).wait(1).to({x:116.35,y:139.8},0).wait(1).to({x:116.15,y:140.4},0).wait(1).to({x:116.05,y:140.9},0).wait(1).to({x:115.9,y:141.4},0).wait(1).to({x:115.8,y:141.8},0).wait(1).to({x:115.7,y:142.15},0).wait(1).to({x:115.6,y:142.4},0).wait(1).to({x:115.55,y:142.65},0).wait(1).to({x:115.5,y:142.8},0).wait(1).to({y:142.85},0).wait(1).to({regX:-0.2,regY:-0.2,x:-82.9,y:-95.75},0).wait(165).to({regX:291,regY:350,x:115.5,y:142.85},0).wait(1).to({scaleX:0.6813,scaleY:0.6813},0).wait(1).to({scaleX:0.6815,scaleY:0.6815},0).wait(1).to({scaleX:0.6817,scaleY:0.6817},0).wait(1).to({scaleX:0.682,scaleY:0.682,x:115.45},0).wait(1).to({scaleX:0.6824,scaleY:0.6824,x:115.5},0).wait(1).to({scaleX:0.6829,scaleY:0.6829},0).wait(1).to({scaleX:0.6835,scaleY:0.6835,x:115.45},0).wait(1).to({scaleX:0.6842,scaleY:0.6842,x:115.4},0).wait(1).to({scaleX:0.6851,scaleY:0.6851,y:142.9},0).wait(1).to({scaleX:0.6861,scaleY:0.6861,y:142.85},0).wait(1).to({scaleX:0.6872,scaleY:0.6872,x:115.35},0).wait(1).to({scaleX:0.6885,scaleY:0.6885},0).wait(1).to({scaleX:0.69,scaleY:0.69,x:115.25,y:142.9},0).wait(1).to({scaleX:0.6916,scaleY:0.6916,y:142.85},0).wait(1).to({scaleX:0.6934,scaleY:0.6934,x:115.2},0).wait(1).to({scaleX:0.6955,scaleY:0.6955,x:115.15},0).wait(1).to({scaleX:0.6976,scaleY:0.6976,x:115.1},0).wait(1).to({scaleX:0.6999,scaleY:0.6999,x:115.05},0).wait(1).to({scaleX:0.7023,scaleY:0.7023,x:114.95,y:142.9},0).wait(1).to({scaleX:0.7046,scaleY:0.7046},0).wait(1).to({scaleX:0.7069,scaleY:0.7069,x:114.85},0).wait(1).to({scaleX:0.709,scaleY:0.709,x:114.8,y:142.95},0).wait(1).to({scaleX:0.7109,scaleY:0.7109,x:114.75,y:142.9},0).wait(1).to({scaleX:0.7126,scaleY:0.7126,x:114.7},0).wait(1).to({scaleX:0.7141,scaleY:0.7141,y:142.95},0).wait(1).to({scaleX:0.7154,scaleY:0.7154,x:114.6},0).wait(1).to({scaleX:0.7165,scaleY:0.7165,y:142.9},0).wait(1).to({scaleX:0.7174,scaleY:0.7174,y:142.95},0).wait(1).to({scaleX:0.7181,scaleY:0.7181},0).wait(1).to({scaleX:0.7187,scaleY:0.7187,x:114.55,y:142.9},0).wait(1).to({scaleX:0.7192,scaleY:0.7192},0).wait(1).to({scaleX:0.7195,scaleY:0.7195,y:142.95},0).wait(1).to({scaleX:0.7198,scaleY:0.7198,y:142.9},0).wait(1).to({scaleX:0.7199,scaleY:0.7199},0).wait(1).to({regX:-0.2,regY:-0.3,scaleX:0.72,scaleY:0.72,x:-95.15,y:-109.2},0).wait(337).to({x:-75.15,y:-169.2},22,cjs.Ease.quadInOut).wait(4).to({regX:291,regY:350,x:134.45,y:83.15},0).wait(1).to({x:134.25,y:83.65},0).wait(1).to({x:133.95,y:84.45},0).wait(1).to({x:133.45,y:85.65},0).wait(1).to({x:132.75,y:87.35},0).wait(1).to({x:131.85,y:89.5},0).wait(1).to({x:130.7,y:92.2},0).wait(1).to({x:129.35,y:95.4},0).wait(1).to({x:127.8,y:99.15},0).wait(1).to({x:126.1,y:103.25},0).wait(1).to({x:124.25,y:107.65},0).wait(1).to({x:122.4,y:112.15},0).wait(1).to({x:120.6,y:116.5},0).wait(1).to({x:118.9,y:120.6},0).wait(1).to({x:117.3,y:124.3},0).wait(1).to({x:115.95,y:127.65},0).wait(1).to({x:114.7,y:130.6},0).wait(1).to({x:113.65,y:133.15},0).wait(1).to({x:112.75,y:135.3},0).wait(1).to({x:111.95,y:137.15},0).wait(1).to({x:111.35,y:138.7},0).wait(1).to({x:110.8,y:139.95},0).wait(1).to({x:110.4,y:140.95},0).wait(1).to({x:110.05,y:141.75},0).wait(1).to({x:109.8,y:142.35},0).wait(1).to({x:109.65,y:142.7},0).wait(1).to({x:109.55,y:142.95},0).wait(1).to({regX:-0.2,regY:-0.3,x:-100.15,y:-109.2},0).wait(66).to({regX:291,regY:350,x:109.5,y:143},0).wait(1).to({scaleX:0.7202,scaleY:0.7202},0).wait(1).to({scaleX:0.7205,scaleY:0.7205,y:143.05},0).wait(1).to({scaleX:0.721,scaleY:0.721},0).wait(1).to({scaleX:0.7216,scaleY:0.7216,x:109.45},0).wait(1).to({scaleX:0.7223,scaleY:0.7223,x:109.5,y:143.1},0).wait(1).to({scaleX:0.7233,scaleY:0.7233,y:143.15},0).wait(1).to({scaleX:0.7244,scaleY:0.7244,x:109.45,y:143.2},0).wait(1).to({scaleX:0.7258,scaleY:0.7258,x:109.4},0).wait(1).to({scaleX:0.7274,scaleY:0.7274,y:143.3},0).wait(1).to({scaleX:0.7292,scaleY:0.7292,x:109.35,y:143.35},0).wait(1).to({scaleX:0.7313,scaleY:0.7313,x:109.3,y:143.45},0).wait(1).to({scaleX:0.7336,scaleY:0.7336,y:143.55},0).wait(1).to({scaleX:0.7363,scaleY:0.7363,x:109.2,y:143.65},0).wait(1).to({scaleX:0.7393,scaleY:0.7393,x:109.15,y:143.75},0).wait(1).to({scaleX:0.7427,scaleY:0.7427,x:109.1,y:143.9},0).wait(1).to({scaleX:0.7464,scaleY:0.7464,x:109,y:144.05},0).wait(1).to({scaleX:0.7506,scaleY:0.7506,x:108.95,y:144.25},0).wait(1).to({scaleX:0.755,scaleY:0.755,x:108.85,y:144.4},0).wait(1).to({scaleX:0.7598,scaleY:0.7598,x:108.75,y:144.6},0).wait(1).to({scaleX:0.7649,scaleY:0.7649,x:108.65,y:144.8},0).wait(1).to({scaleX:0.7702,scaleY:0.7702,x:108.55,y:145},0).wait(1).to({scaleX:0.7755,scaleY:0.7755,x:108.45,y:145.2},0).wait(1).to({scaleX:0.7808,scaleY:0.7808,x:108.35,y:145.45},0).wait(1).to({scaleX:0.7859,scaleY:0.7859,x:108.25,y:145.65},0).wait(1).to({scaleX:0.7907,scaleY:0.7907,x:108.15,y:145.85},0).wait(1).to({scaleX:0.7951,scaleY:0.7951,x:108.1,y:146},0).wait(1).to({scaleX:0.7992,scaleY:0.7992,x:108,y:146.15},0).wait(1).to({scaleX:0.8028,scaleY:0.8028,x:107.9,y:146.35},0).wait(1).to({scaleX:0.806,scaleY:0.806,x:107.85,y:146.45},0).wait(1).to({scaleX:0.8088,scaleY:0.8088,x:107.8,y:146.6},0).wait(1).to({scaleX:0.8112,scaleY:0.8112,x:107.75,y:146.7},0).wait(1).to({scaleX:0.8133,scaleY:0.8133,x:107.7,y:146.75},0).wait(1).to({scaleX:0.815,scaleY:0.815,x:107.65,y:146.8},0).wait(1).to({scaleX:0.8165,scaleY:0.8165,y:146.85},0).wait(1).to({scaleX:0.8176,scaleY:0.8176,x:107.6,y:146.9},0).wait(1).to({scaleX:0.8185,scaleY:0.8185,x:107.65,y:146.95},0).wait(1).to({scaleX:0.8192,scaleY:0.8192,x:107.6},0).wait(1).to({scaleX:0.8196,scaleY:0.8196,y:147},0).wait(1).to({scaleX:0.8199,scaleY:0.8199},0).wait(1).to({regX:-0.3,regY:-0.3,scaleX:0.82,scaleY:0.82,x:-131.25,y:-140.25},0).to({_off:true},45).wait(256));

	// bg
	this.bg = new lib.bg_zoom_half();
	this.bg.name = "bg";
	this.bg.parent = this;
	this.bg.setTransform(-32.15,-38.15,0.5,0.5,0,0,0,-0.3,-0.3);
	this.bg._off = true;

	this.timeline.addTween(cjs.Tween.get(this.bg).wait(1185).to({_off:false},0).to({_off:true},192).wait(64));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1365).wait(76));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1377).wait(59).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1090.2,-720,1710.2,1420);
// library properties:
lib.properties = {
	id: '_397_3',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg", id:"_397_3_bg"},
		{src:"images/bg_blur.jpg", id:"_397_3_bg_blur"},
		{src:"images/ch_base.png", id:"_397_3_ch_base"},
		{src:"images/ch_base_no_hand.png", id:"_397_3_ch_base_no_hand"},
		{src:"images/ch_face2.png", id:"_397_3_ch_face2"},
		{src:"images/ch_face3.png", id:"_397_3_ch_face3"},
		{src:"images/ch_face4.png", id:"_397_3_ch_face4"},
		{src:"images/ch_face5.png", id:"_397_3_ch_face5"},
		{src:"images/ch_face6.png", id:"_397_3_ch_face6"},
		{src:"images/ch_face7.png", id:"_397_3_ch_face7"},
		{src:"images/finish.jpg", id:"_397_3_finish"},
		{src:"images/finish_blur.jpg", id:"_397_3_finish_blur"},
		{src:"images/glitter.png", id:"_397_3_glitter"},
		{src:"images/tie_fp.png", id:"_397_3_tie_fp"},
		{src:"images/tie_sp.png", id:"_397_3_tie_sp"}
	],
	preloads: []
};
