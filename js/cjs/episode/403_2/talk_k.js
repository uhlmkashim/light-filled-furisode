...
window.im_cjs.t[4][1] = "거드름피우지 말고 내밀어 봐.";
window.im_cjs.t[4][2] = "너의 뒤에, 숨기고 있지?";
window.im_cjs.t[4][3] = "탐욕스러운 여자애들이 원하는,";
window.im_cjs.t[4][4] = "정말 좋아하는 그것 말야.";

window.im_cjs.t[5][1] = "숨겨봤자 알 수 있어~. 그 냄새는,";
window.im_cjs.t[5][2] = "상영회를 좀 더 근사한 무언가로";
window.im_cjs.t[5][3] = "바꿔줄 수 있는 것…… 예를 들면,";
window.im_cjs.t[5][4] = "치즈와 토마토 냄새.";

window.im_cjs.t[6][1] = "즉, 너의 등뒤에 숨어있는 건";
window.im_cjs.t[6][2] = "…… 주문한 초특대･딜럭스";
window.im_cjs.t[6][3] = "스페셜리티 피자라고 봐! 오,";
window.im_cjs.t[6][4] = "정답! 응하~, 맛있어~♪";
...
window.im_cjs.t[8][3] = "허가하지! 자, 들어와.";
window.im_cjs.t[8][4] = "비밀의 시어터에 잘 왔어♪";
