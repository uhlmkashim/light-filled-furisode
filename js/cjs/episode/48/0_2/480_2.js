(function (cjs, an) {
    ...
    (lib.bg = function() {
        this.initialize(img._480_2_bg);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,1060,1400);
    
    
    (lib.ch_base = function() {
        this.initialize(img._480_2_ch_base);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,1060,1400);
    
    
    (lib.ch_face10 = function() {
        this.initialize(img._480_2_ch_face10);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face11 = function() {
        this.initialize(img._480_2_ch_face11);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face12 = function() {
        this.initialize(img._480_2_ch_face12);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face13 = function() {
        this.initialize(img._480_2_ch_face13);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face2 = function() {
        this.initialize(img._480_2_ch_face2);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face3 = function() {
        this.initialize(img._480_2_ch_face3);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face4 = function() {
        this.initialize(img._480_2_ch_face4);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face5 = function() {
        this.initialize(img._480_2_ch_face5);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face6 = function() {
        this.initialize(img._480_2_ch_face6);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face7 = function() {
        this.initialize(img._480_2_ch_face7);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face8 = function() {
        this.initialize(img._480_2_ch_face8);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.ch_face9 = function() {
        this.initialize(img._480_2_ch_face9);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,240);
    
    
    (lib.eftest3 = function() {
        this.initialize(img._480_2_eftest3);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,1060,1400);
    
    
    (lib.ef01 = function() {
        this.initialize(img._480_2_ef01);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,1060,1400);
    
    
    (lib.ef02 = function() {
        this.initialize(img._480_2_ef02);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,301,300);
    
    
    (lib.finish = function() {
        this.initialize(img._480_2_finish);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,480,620);
    
    
    (lib.finish_blur = function() {
        this.initialize(img._480_2_finish_blur);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,480,620);
    
    
    (lib.kirakira = function() {
        this.initialize(img._480_2_kirakira);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,116,113);
    
    
    (lib.tie_fp = function() {
        this.initialize(img._480_2_tie_fp);
    }).prototype = p = new cjs.Bitmap();
    p.nominalBounds = new cjs.Rectangle(0,0,240,32);
    
    
    (lib.tie_sp = function() {
        this.initialize(img._480_2_tie_sp);
    }).prototype = p = new cjs.Bitmap();
    ...
    (lib.rainbow = function(mode,startPosition,loop) {
        ...
        this.instance.setTransform(0,0,0.5015,0.5015);
    
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
    
    }).prototype = getMCSymbolPrototype(lib.rainbow, new cjs.Rectangle(0,0,531.6,702.1), null);
    
    
    (lib.mizusibuki = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{});
    
        // レイヤー_1
        this.instance = new lib.eftest3();
        this.instance.parent = this;
        this.instance.setTransform(9,18,0.4993,0.4993);
    
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));
    
    }).prototype = getMCSymbolPrototype(lib.mizusibuki, new cjs.Rectangle(9,18,529.3,699), null);
    
    
    (lib.maru = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{});
    ...
    }).prototype = getMCSymbolPrototype(lib.maru, new cjs.Rectangle(0,0,301,300), null);
    ...
    (lib.tie = function(mode,startPosition,loop) {
        ...
        // txt
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#333333").s().p("");
        this.shape.setTransform(32,0.4);
        ...
        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#333333").s().p("");
        this.shape_2.setTransform(-0.025,0.475);
    
        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#333333").s().p("");
        this.shape_3.setTransform(-16,0.4);
    
        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#333333").s().p("Ag7A9QAVgGARgJQATgJALgLIgTgNIgNgJIgGgDIAMgNIADACIAKAGIALAIIAOAJIAPgRIAJgPIAEgLIABgEIg8AAIgOAQIgQAOIgLAJIgFADIgOgMIAFgDIAOgKIAQgOQAJgKAGgKQAIgLAEgNIARAGIgFAKIgEAKIBHAAIAAAOIgCAGIgHAQQgFALgJALQgIAMgNANQgNANgRAKQgSALgZAIg");
        this.shape_4.setTransform(-32.3,0.45);
    ...
    (lib.ef_base = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{});
    
        // rainbow
        this.instance = new lib.rainbow();
        this.instance.parent = this;
        this.instance.setTransform(265.8,351.1,1,1,0,0,0,265.8,351.1);
        this.instance.alpha = 0.3008;
    
        this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0.1484},21,cjs.Ease.quadIn).to({alpha:0.2891},21,cjs.Ease.quadOut).wait(1));
    
        // ef01
        this.instance_1 = new lib.maru();
        this.instance_1.parent = this;
        this.instance_1.setTransform(381.65,228.25,0.4852,0.4852);
        this.instance_1.compositeOperation = "lighter";
    
        this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:0},21).to({alpha:0.9883},21).wait(1));
    
        // ef02
        this.instance_2 = new lib.maru();
        this.instance_2.parent = this;
        this.instance_2.setTransform(12.35,130.75,0.8031,0.8031,0,0,0,150.8,150.2);
        this.instance_2.alpha = 0;
        this.instance_2.compositeOperation = "lighter";
    
        this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:1},21).to({alpha:0},21).wait(1));
    
        // kirakira
        this.instance_3 = new lib.eff02_m();
        this.instance_3.parent = this;
        this.instance_3.setTransform(378.5,453.65,0.2097,0.2097,0,0,0,0.5,0);
        this.instance_3.compositeOperation = "lighter";
    
        this.instance_4 = new lib.eff02_m();
        this.instance_4.parent = this;
        this.instance_4.setTransform(468.05,676.95,0.1612,0.1612,0,0,0,1.2,0.3);
        this.instance_4.compositeOperation = "lighter";
    
        this.instance_5 = new lib.eff02_m();
        this.instance_5.parent = this;
        this.instance_5.setTransform(51.1,663.95,0.1108,0.1108,0,0,0,1.4,0.5);
        this.instance_5.compositeOperation = "lighter";
    
        this.instance_6 = new lib.eff02_m();
        this.instance_6.parent = this;
        this.instance_6.setTransform(195.5,740.5,0.1108,0.1108,0,0,0,1.4,0.5);
        this.instance_6.compositeOperation = "lighter";
    
        this.instance_7 = new lib.eff02_m();
        this.instance_7.parent = this;
        this.instance_7.setTransform(246.8,706.6,0.1108,0.1108,0,0,0,1.4,0.5);
        this.instance_7.compositeOperation = "lighter";
    
        this.instance_8 = new lib.eff02_m();
        this.instance_8.parent = this;
        this.instance_8.setTransform(292.7,749,0.1108,0.1108,0,0,0,1.4,0.5);
        this.instance_8.compositeOperation = "lighter";
    
        this.instance_9 = new lib.eff02_m();
        this.instance_9.parent = this;
        this.instance_9.setTransform(295.15,739.9,0.1108,0.1108,0,0,0,1.4,0.5);
        this.instance_9.compositeOperation = "lighter";
    
        this.instance_10 = new lib.eff02_m();
        this.instance_10.parent = this;
        this.instance_10.setTransform(238.3,716.3,0.1612,0.1612,0,0,0,1.2,0.3);
        this.instance_10.compositeOperation = "lighter";
    
        this.instance_11 = new lib.eff02_m();
        this.instance_11.parent = this;
        this.instance_11.setTransform(93.75,641.8,0.1684,0.1684,0,0,0,1.5,0.3);
        this.instance_11.compositeOperation = "lighter";
    
        this.instance_12 = new lib.eff02_m();
        this.instance_12.parent = this;
        this.instance_12.setTransform(172.6,632.9,0.1612,0.1612,0,0,0,1.2,0.3);
        this.instance_12.compositeOperation = "lighter";
    
        this.instance_13 = new lib.eff02_m();
        this.instance_13.parent = this;
        this.instance_13.setTransform(175.6,621.65,0.1612,0.1612,0,0,0,1.2,0.3);
        this.instance_13.compositeOperation = "lighter";
    
        this.instance_14 = new lib.eff02_m();
        this.instance_14.parent = this;
        this.instance_14.setTransform(228.8,641.95,0.1612,0.1612,0,0,0,1.2,0.3);
        this.instance_14.compositeOperation = "lighter";
    
        this.instance_15 = new lib.eff02_m();
        this.instance_15.parent = this;
        this.instance_15.setTransform(128.55,568.2,0.1434,0.1434,0,0,0,1.8,0.4);
        this.instance_15.compositeOperation = "lighter";
    
        this.instance_16 = new lib.eff02_m();
        this.instance_16.parent = this;
        this.instance_16.setTransform(278.55,596.05,0.1612,0.1612,0,0,0,1.2,0.3);
        this.instance_16.compositeOperation = "lighter";
    
        this.instance_17 = new lib.eff02_m();
        this.instance_17.parent = this;
        this.instance_17.setTransform(347.75,567.9,0.1612,0.1612,0,0,0,1.2,0.3);
        this.instance_17.compositeOperation = "lighter";
    
        this.instance_18 = new lib.eff02_m();
        this.instance_18.parent = this;
        this.instance_18.setTransform(199.4,577.4,0.186,0.186,0,0,0,1.1,0.2);
        this.instance_18.compositeOperation = "lighter";
    
        this.instance_19 = new lib.eff02_m();
        this.instance_19.parent = this;
        this.instance_19.setTransform(178.15,473.95,0.1137,0.1137,0,0,0,1.3,0.5);
        this.instance_19.compositeOperation = "lighter";
    
        this.instance_20 = new lib.eff02_m();
        this.instance_20.parent = this;
        this.instance_20.setTransform(141.4,531.1,0.186,0.186,0,0,0,1.1,0.2);
        this.instance_20.compositeOperation = "lighter";
    
        this.instance_21 = new lib.eff02_m();
        this.instance_21.parent = this;
        this.instance_21.setTransform(147,406.5,0.166,0.166,0,0,0,0.9,0.3);
        this.instance_21.compositeOperation = "lighter";
    
        this.instance_22 = new lib.eff02_m();
        this.instance_22.parent = this;
        this.instance_22.setTransform(60.5,442.45,0.166,0.166,0,0,0,0.9,0.3);
        this.instance_22.compositeOperation = "lighter";
    
        this.instance_23 = new lib.eff02_m();
        this.instance_23.parent = this;
        this.instance_23.setTransform(139.25,393,0.1934,0.1934,0,0,0,0.8,0.2);
        this.instance_23.compositeOperation = "lighter";
    
        this.instance_24 = new lib.eff02_m();
        this.instance_24.parent = this;
        this.instance_24.setTransform(52.75,367.45,0.1934,0.1934,0,0,0,0.8,0.2);
        this.instance_24.compositeOperation = "lighter";
    
        this.instance_25 = new lib.eff02_m();
        this.instance_25.parent = this;
        this.instance_25.setTransform(-9.95,212.55,0.1882,0.1882,0,0,0,0.8,0.2);
        this.instance_25.compositeOperation = "lighter";
    
        this.instance_26 = new lib.eff02_m();
        this.instance_26.parent = this;
        this.instance_26.setTransform(115.05,275.3,0.1882,0.1882,0,0,0,0.8,0.2);
        this.instance_26.compositeOperation = "lighter";
    
        this.instance_27 = new lib.eff02_m();
        this.instance_27.parent = this;
        this.instance_27.setTransform(447.7,181.35,0.1882,0.1882,0,0,0,0.8,0.2);
        this.instance_27.compositeOperation = "lighter";
    
        this.instance_28 = new lib.eff02_m();
        this.instance_28.parent = this;
        this.instance_28.setTransform(378.5,321.65,0.2097,0.2097,0,0,0,0.5,0);
        this.instance_28.compositeOperation = "lighter";
    
        this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).wait(43));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-108.7,0,640.3000000000001,702.1);
    ...
    (lib.window = function(mode,startPosition,loop) {
        ...
        // dummy
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#000000").s().p("");
        this.shape.setTransform(40.025,11.75);
    
        this.shape_1 = new cjs.Shape();
        this.shape_1.graphics.f("#000000").s().p("");
        this.shape_1.setTransform(24.025,11.625);
    ...
    (lib.character1_face_container = function(mode,startPosition,loop) {
        ...
        var mask = new cjs.Shape();
        mask._off = true;
        var mask_graphics_15 = new cjs.Graphics().p("AldCnQgZgDgKABQgUABgVgGQgdgJgHgVQgRhKAyhJQAfgwAlgZQAwgYAfgHQAwgMAwANQAsALBPAuQAnAWAdAVQALgSAdgZQA4gyBWglQBxgtBeBSQAvApAYAyIgFBZQgQAFgogCQggAPgqAKQgwAKgsAAQg0gBgdgRQgogYgGgBQgbgIhaAOQhMAMgdAJQgQAMgSALQgjAWhPATQg4AOghAAIgCAAg");
        ...
        this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:64.7827,y:56.9182}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
    ...
    p.nominalBounds = new cjs.Rectangle(-210,-160,530,700);
    ...
    (lib.character1_body = function(mode,startPosition,loop) {
        ...
        this.f.name = "f";
        this.f.parent = this;
        this.f.setTransform(-146.65,-564.4);
        ...
        this.b.name = "b";
        this.b.parent = this;
        this.b.setTransform(-236.65,-328.4);
    
        this.timeline.addTween(cjs.Tween.get(this.b).wait(2));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-356.6,-724.4,666.8,856.0999999999999);
    ...
    (lib.character1_container = function(mode,startPosition,loop) {
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:32.9,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:44.55,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:7.3,y:-372.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:32.9,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:44.55,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:7.3,y:-372.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:32.9,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:44.55,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:7.3,y:-372.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:32.9,y:-381.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:44.55,y:-385.6,alpha:0.2188},0).to({_off:true},1).wait(136));
        this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:17.5,y:-335.85,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:20.75,y:-341.7,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:18.2,y:-339.55,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:17.65,y:-336.3,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:18.75,y:-331.7,alpha:0},0).to({_off:true},1).wait(92));
    
        // effect_look_to_right
        this.instance_2 = new lib.spread_flower_pink("synched",0,false);
        this.instance_2.parent = this;
        this.instance_2.setTransform(-81.95,-501.15,1.4807,1.4807,0,0,180);
    
        this.instance_3 = new lib.good_effect("synched",0,false);
        this.instance_3.parent = this;
        this.instance_3.setTransform(-81.9,-501.2,1.481,1.481);
    
        this.instance_4 = new lib.notice();
        this.instance_4.parent = this;
        this.instance_4.setTransform(-8.25,-589.45,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
        this.instance_4._off = true;
    
        this.instance_5 = new lib.laugh("synched",0);
        this.instance_5.parent = this;
        this.instance_5.setTransform(7.75,-585.9,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
        this.instance_5._off = true;
    
        this.instance_6 = new lib.chord("synched",0,false);
        this.instance_6.parent = this;
        this.instance_6.setTransform(-15.35,-503.5,1.0026,1.0026,-6.2632,0,0,-23.4,76.9);
    
        this.instance_7 = new lib.question();
        this.instance_7.parent = this;
        this.instance_7.setTransform(-20.05,-586.4,1.053,1.053,29.448);
        this.instance_7.alpha = 0;
        this.instance_7._off = true;
    
        this.instance_8 = new lib.mc_exclamation("synched",0,false);
        this.instance_8.parent = this;
        this.instance_8.setTransform(-16.3,-601.8,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);
    
        this.instance_9 = new lib.drop1a("synched",0);
        this.instance_9.parent = this;
        this.instance_9.setTransform(-20.6,-584.3,1,1,0,0,0,-0.5,0.2);
        this.instance_9._off = true;
    
        this.instance_10 = new lib.drop2_v2("synched",0);
        this.instance_10.parent = this;
        this.instance_10.setTransform(-22,-584.15,0.9876,0.9876,0,-14.9998,165.0002);
        this.instance_10._off = true;
    
        this.instance_11 = new lib.shock("synched",0);
        this.instance_11.parent = this;
        this.instance_11.setTransform(-15.55,-587.15,1.3878,1.3878,0,121.2396,-58.7604);
    
        this.instance_12 = new lib.sigh("synched",0);
        this.instance_12.parent = this;
        this.instance_12.setTransform(-44.25,-439.1,1,1,0,0,180);
        this.instance_12.alpha = 0.6016;
        this.instance_12._off = true;
    
        this.instance_13 = new lib.heart("synched",0);
        this.instance_13.parent = this;
        this.instance_13.setTransform(-17.6,-548.55,0.4532,0.4532,0,0,180);
        this.instance_13._off = true;
    
        this.instance_14 = new lib.angry("synched",0);
        this.instance_14.parent = this;
        this.instance_14.setTransform(-11.05,-569.8,0.5276,0.5276);
        this.instance_14._off = true;
    
        this.instance_15 = new lib.mc_punpun();
        this.instance_15.parent = this;
        this.instance_15.setTransform(-142.1,-618.95,1.1377,1.1377);
    
        this.instance_16 = new lib.concent_wrapper("synched",0,false);
        this.instance_16.parent = this;
        this.instance_16.setTransform(-84.4,-507,1,1,0,0,0,-0.5,-0.1);
    
        this.instance_17 = new lib.mizusibuki();
        this.instance_17.parent = this;
        this.instance_17.setTransform(-117.75,-115.2,0.0857,0.0857,0,0,0,245.7,625.6);
        this.instance_17._off = true;
    
        this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},37).to({state:[{t:this.instance_3}]},10).to({state:[]},10).to({state:[{t:this.instance_4}]},76).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},2).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},15).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},20).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},7).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},6).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},16).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},24).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},5).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11,p:{x:-15.55,y:-587.15}}]},11).to({state:[]},1).to({state:[{t:this.instance_11,p:{x:-17.8,y:-592.4}}]},1).to({state:[]},1).to({state:[{t:this.instance_11,p:{x:-17.8,y:-592.4}}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},11).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},2).to({state:[{t:this.instance_13}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},6).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},5).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[]},1).to({state:[{t:this.instance_15}]},2).to({state:[]},12).to({state:[{t:this.instance_16}]},17).to({state:[]},9).to({state:[{t:this.instance_17}]},10).to({state:[{t:this.instance_17}]},6).to({state:[{t:this.instance_17}]},8).to({state:[]},1).wait(1));
        this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-589.5},0).wait(3).to({regX:-28.8,x:-8.6,y:-589.35,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:-8.25,y:-589.5,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-589.45,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-589.5},0).wait(3).to({regX:-28.8,x:-8.6,y:-589.35,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:-8.25,y:-589.5,alpha:0},0).to({_off:true},1).wait(309));
        this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({regY:20.4,skewX:-35.827,skewY:144.1725,x:7.65,y:-585.95},0).wait(1).to({regX:-31.4,regY:22.1,x:10.5,y:-585,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.4,x:7.65,y:-585.95,alpha:0,startPosition:19},0).to({_off:true},1).wait(288));
        this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-12.35,y:-599.35,alpha:0.5556},0).wait(1).to({x:-7.55,y:-607.2,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-5.65,y:-610,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-6.25,y:-609.25},0).wait(1).to({x:-7.3,y:-607.4},0).wait(1).to({x:-9.05,y:-604.3},0).wait(1).to({regX:0,regY:0,x:-11.25,y:-600.1},0).to({x:-10.5,y:-601.45},2).wait(8).to({regX:-0.2,regY:0.2,x:-11.1,y:-600.75,alpha:0.9298},0).wait(1).to({x:-12.2,y:-598.8,alpha:0.692},0).wait(1).to({x:-13.8,y:-595.95,alpha:0.339},0).wait(1).to({x:-15,y:-593.85,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-15.05,y:-593.3,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-20.05,y:-586.4},0).wait(1).to({regX:-0.2,regY:0.2,x:-12.35,y:-599.35,alpha:0.5556},0).wait(1).to({x:-7.55,y:-607.2,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-5.65,y:-610,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-6.25,y:-609.25},0).wait(1).to({x:-7.3,y:-607.4},0).wait(1).to({x:-9.05,y:-604.3},0).wait(1).to({regX:0,regY:0,x:-11.25,y:-600.1},0).to({x:-10.5,y:-601.45},2).wait(3).to({regX:-0.2,regY:0.2,x:-11.1,y:-600.75,alpha:0.9298},0).wait(1).to({x:-12.2,y:-598.8,alpha:0.692},0).wait(1).to({x:-13.8,y:-595.95,alpha:0.339},0).wait(1).to({x:-15,y:-593.85,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-15.05,y:-593.3,alpha:0},0).to({_off:true},1).wait(221));
        this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-19.6,y:-580.6},0).wait(1).to({y:-576.75},0).wait(1).to({y:-573.5},0).wait(1).to({y:-570.85},0).wait(1).to({y:-568.75},0).wait(1).to({y:-567.25},0).wait(1).to({y:-566.35},0).wait(1).to({regX:-0.5,regY:0.2,x:-20.6,y:-565.3},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-19.6,y:-566.1,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-20.6,y:-565.3,alpha:0},0).to({_off:true},1).wait(179));
        this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:9.425,y:-579.5375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:19.9,y:-578,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:-22,y:-584.15,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:9.425,y:-583.925,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:19.9,y:-583.85,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:-22,y:-584.15,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:9.425,y:-579.5375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:19.9,y:-578,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:-22,y:-584.15,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:9.425,y:-583.925,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:19.9,y:-583.85,alpha:0.2188},0).to({_off:true},1).wait(136));
        this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:-43.25,y:-438.1,alpha:1},0).wait(1).to({regX:0.9,x:-43.1,y:-437.15,alpha:0.8965},0).wait(1).to({x:-41.75,y:-435.95,alpha:0.7636},0).wait(1).to({x:-40.15,y:-434.5,alpha:0.6048},0).wait(1).to({x:-38.35,y:-432.9,alpha:0.4229},0).wait(1).to({x:-36.35,y:-431.05,alpha:0.2205},0).wait(1).to({regX:0,x:-33.25,y:-429.1,alpha:0},0).to({_off:true},1).wait(109));
        this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-15.85,y:-562.7},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-12.6,y:-568.55},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-15.1,y:-566.4},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-15.65,y:-563.15},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-14.6,y:-558.55},0).to({scaleX:1,scaleY:1,x:-13.6,y:-562.55},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-16.2,y:-561.55,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-14.6,y:-562.3,alpha:0.1016},0).to({_off:true},1).wait(85));
        this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-573.55},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-574.8},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(66));
        this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(452).to({_off:false},0).to({regX:244.9,regY:625.2,scaleX:1.0027,scaleY:1.0027,x:-118.8,y:-114.95},6,cjs.Ease.quadIn).to({regX:244.8,scaleX:1.0738,scaleY:1.0738,x:-118.85,y:-109.7,alpha:0},8,cjs.Ease.quadOut).to({_off:true},1).wait(1));
        ...
        this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:-91.6,regY:-374.4,x:-91.6,y:-382.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.6},0).wait(1).to({y:-380.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-379.9},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-380.15},0).wait(1).to({y:-373.2},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-371.15},0).wait(1).to({y:-373.55},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-379.35},0).wait(1).to({y:-373.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-379.35},0).wait(1).to({y:-373.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-373.5},0).wait(1).to({y:-374.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.4},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-387.35},0).wait(1).to({y:-383.75},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-372.4},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-374.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.4},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-387.35},0).wait(1).to({y:-383.75},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-372.4},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-374.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-91.6,regY:-374.4,x:-91.6,y:-373.8},0).wait(1).to({y:-371.4},0).wait(1).to({y:-369.05},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-369.05},0).wait(1).to({y:-371.4},0).wait(1).to({y:-373.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-91.6,regY:-374.4,x:-91.6,y:-374.25},0).wait(1).to({y:-373.7},0).wait(1).to({y:-372.6},0).wait(1).to({y:-371.25},0).wait(1).to({y:-370.15},0).wait(1).to({y:-369.6},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-369.6},0).wait(1).to({y:-370.15},0).wait(1).to({y:-371.25},0).wait(1).to({y:-372.6},0).wait(1).to({y:-373.7},0).wait(1).to({y:-374.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-369.65},0).wait(1).to({y:-373.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-372.2},0).wait(1).to({y:-374.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-91.6,regY:-374.4,rotation:0.0244,x:-91.45,y:-374.4},0).wait(1).to({rotation:0.1092,x:-90.8,y:-374.2},0).wait(1).to({rotation:0.275,x:-89.45,y:-373.95},0).wait(1).to({rotation:0.538,x:-87.4,y:-373.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:-84.8,y:-372.9},0).wait(1).to({rotation:1.1673,x:-82.35,y:-372.3},0).wait(1).to({rotation:1.367,x:-80.8,y:-371.9},0).wait(1).to({rotation:1.4695,x:-80,y:-371.7},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:-91.6,regY:-374.4,rotation:1.479,x:-80,y:-371.75},0).wait(1).to({rotation:1.4111,x:-80.55,y:-371.85},0).wait(1).to({rotation:1.2801,x:-81.55,y:-372.1},0).wait(1).to({rotation:1.0711,x:-83.2,y:-372.5},0).wait(1).to({rotation:0.7884,x:-85.45,y:-373},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:-87.8,y:-373.55},0).wait(1).to({rotation:0.2415,x:-89.75,y:-374},0).wait(1).to({rotation:0.0832,x:-91,y:-374.3},0).wait(1).to({rotation:0.0011,x:-91.6,y:-374.4},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-91.6,regY:-374.4,rotation:0.0244,x:-91.45,y:-374.4},0).wait(1).to({rotation:0.1092,x:-90.8,y:-374.2},0).wait(1).to({rotation:0.275,x:-89.45,y:-373.95},0).wait(1).to({rotation:0.538,x:-87.4,y:-373.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:-84.8,y:-372.9},0).wait(1).to({rotation:1.1673,x:-82.35,y:-372.3},0).wait(1).to({rotation:1.367,x:-80.8,y:-371.9},0).wait(1).to({rotation:1.4695,x:-80,y:-371.7},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:-91.6,regY:-374.4,rotation:1.4793,x:-80,y:-371.75},0).wait(1).to({rotation:1.4124,x:-80.5,y:-371.85},0).wait(1).to({rotation:1.2834,x:-81.5,y:-372.1},0).wait(1).to({rotation:1.0775,x:-83.2,y:-372.5},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:-85.4,y:-373.05},0).wait(1).to({rotation:0.5016,x:-87.75,y:-373.55},0).wait(1).to({rotation:0.2603,x:-89.65,y:-374},0).wait(1).to({rotation:0.1043,x:-90.85,y:-374.3},0).wait(1).to({rotation:0.0235,x:-91.45,y:-374.45},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:-91.6,regY:-374.4,x:-91.6,y:-379.95},0).wait(1).to({y:-381.85},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-381.75},0).wait(1).to({y:-379.65},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:-91.6,regY:-374.4,x:-91.6,y:-382.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.6},0).wait(1).to({y:-380.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:-91.6,regY:-374.4,rotation:0.0244,x:-91.45,y:-374.4},0).wait(1).to({rotation:0.1092,x:-90.8,y:-374.2},0).wait(1).to({rotation:0.275,x:-89.45,y:-373.95},0).wait(1).to({rotation:0.538,x:-87.4,y:-373.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:-84.8,y:-372.9},0).wait(1).to({rotation:1.1673,x:-82.35,y:-372.3},0).wait(1).to({rotation:1.367,x:-80.8,y:-371.9},0).wait(1).to({rotation:1.4695,x:-80,y:-371.7},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:-91.6,regY:-374.4,rotation:1.479,x:-80,y:-371.75},0).wait(1).to({rotation:1.4111,x:-80.55,y:-371.85},0).wait(1).to({rotation:1.2801,x:-81.55,y:-372.1},0).wait(1).to({rotation:1.0711,x:-83.2,y:-372.5},0).wait(1).to({rotation:0.7884,x:-85.45,y:-373},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:-87.8,y:-373.55},0).wait(1).to({rotation:0.2415,x:-89.75,y:-374},0).wait(1).to({rotation:0.0832,x:-91,y:-374.3},0).wait(1).to({rotation:0.0011,x:-91.6,y:-374.4},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-91.6,regY:-374.4,rotation:0.1421,x:-90.5,y:-374.2},0).wait(1).to({rotation:0.6998,x:-86.15,y:-373.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:-81.15,y:-371.95},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:-91.6,regY:-374.4,rotation:1.4399,x:-80.3,y:-371.8},0).wait(1).to({rotation:1.2196,x:-82.05,y:-372.25},0).wait(1).to({rotation:0.7884,x:-85.45,y:-373},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:-89.2,y:-373.8},0).wait(1).to({rotation:0.0482,x:-91.3,y:-374.35},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:-91.6,regY:-374.4,rotation:0.0865,x:-90.95,y:-374.3},0).wait(1).to({rotation:0.4213,x:-88.3,y:-373.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:-83.8,y:-372.6},0).wait(1).to({rotation:1.3945,x:-80.6,y:-371.85},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:-91.6,regY:-374.4,rotation:1.4399,x:-80.3,y:-371.8},0).wait(1).to({rotation:1.2196,x:-82.05,y:-372.25},0).wait(1).to({rotation:0.7884,x:-85.45,y:-373},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:-89.2,y:-373.8},0).wait(1).to({rotation:0.0482,x:-91.3,y:-374.35},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-382.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.6},0).wait(1).to({y:-380.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-91.6,regY:-374.4,x:-94.35,y:-366.65},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:-91.6,regY:-374.4,x:-91.6,y:-362.15},0).wait(1).to({y:-365.1},0).wait(1).to({y:-370.05},0).wait(1).to({y:-373.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-373.4},0).wait(1).to({y:-367.45},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:-91.6,regY:-374.4,x:-91.6,y:-366.6},0).wait(1).to({y:-370.9},0).wait(1).to({y:-375.2},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-374.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-91.6,regY:-374.4,x:-91.6,y:-381.1},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-381.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-382.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.6},0).wait(1).to({y:-380.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:-91.6,regY:-374.4,x:-94.35,y:-366.65},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:-91.6,regY:-374.4,x:-91.6,y:-363.65},0).wait(1).to({y:-371.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-375.4},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-374.55},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-373.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-91.6,regY:-374.4,x:-91.6,y:-373.8},0).wait(1).to({y:-371.4},0).wait(1).to({y:-369.05},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-369},0).wait(1).to({y:-369.3},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:-91.6,regY:-374.4,x:-91.6,y:-369.8},0).wait(1).to({y:-371.3},0).wait(1).to({y:-373.55},0).wait(1).to({y:-375},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-374.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-382},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.6},0).wait(1).to({y:-380.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:-91.6,regY:-374.4,x:-91.6,y:-381.9},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:-91.6,regY:-374.4,x:-91.6,y:-382.4},0).wait(1).to({y:-376.4},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:-91.6,regY:-374.4,x:-91.6,y:-369.75},0).wait(1).to({y:-370.95},0).wait(1).to({y:-372.9},0).wait(1).to({y:-374.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-379.35},0).wait(1).to({y:-373.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-379.35},0).wait(1).to({y:-373.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-373.5},0).wait(1).to({y:-374.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:-91.6,regY:-374.4,x:-88.6,y:-371},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:-91.6,regY:-374.4,x:-92.45,y:-364.95},0).wait(1).to({x:-91.8,y:-364.55},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:-91.6,regY:-374.4,x:-91.6,y:-365.1},0).wait(1).to({y:-367.55},0).wait(1).to({y:-371.25},0).wait(1).to({y:-373.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(25).to({regX:-91.6,regY:-374.4,x:-91.6,y:-382.8},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:-91.6,regY:-374.4,x:-91.6,y:-383.6},0).wait(1).to({y:-380.85},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(5));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-490.2,-907.3,846.8,1039.8);
    ...
    // stage content:
    (lib._480_2 = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:153,scene2:154,end2:251,scene3:252,end3:381,scene4:382,end4:509,scene5:510,end5:628,scene6:629,end6:779,scene7:780,end7:937});
        ...
        this.frame_30 = function() {
            this.ch1.gotoAndPlay("mizu sibuki");
        }
        this.frame_37 = function() {
            exportRoot._g.m1 = "いきますよ､えーいっ♪";
            exportRoot._u.setText();
            exportRoot._u.setFace("ch1", 1);
        }
        this.frame_61 = function() {
            exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
            exportRoot._g.m2 = "としてたら､";
            exportRoot._u.setText();
        ...
        this.frame_398 = function() {
            exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
            exportRoot._g.m2 = "したし! ";
            exportRoot._u.setText();
            
            exportRoot._u.setFace("ch1", 4);
        }
        this.frame_432 = function() {
            exportRoot._g.m2 = "したし! でも､";
            exportRoot._u.setText();
        ...
        this.frame_629 = function() {
            exportRoot._g.m1 = "ﾃﾞｰﾄってﾄﾞｷﾄﾞｷして､";
            exportRoot._g.m2 = "";
            exportRoot._g.m3 = "";
            exportRoot._g.m4 = "";
            exportRoot._u.setText();
        ...
        // actions tween:
        this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(15).call(this.frame_30).wait(7).call(this.frame_37).wait(24).call(this.frame_61).wait(17).call(this.frame_78).wait(28).call(this.frame_106).wait(26).call(this.frame_132).wait(21).call(this.frame_153).wait(1).call(this.frame_154).wait(16).call(this.frame_170).wait(24).call(this.frame_194).wait(37).call(this.frame_231).wait(20).call(this.frame_251).wait(1).call(this.frame_252).wait(17).call(this.frame_269).wait(37).call(this.frame_306).wait(12).call(this.frame_318).wait(17).call(this.frame_335).wait(15).call(this.frame_350).wait(13).call(this.frame_363).wait(18).call(this.frame_381).wait(1).call(this.frame_382).wait(16).call(this.frame_398).wait(34).call(this.frame_432).wait(14).call(this.frame_446).wait(15).call(this.frame_461).wait(23).call(this.frame_484).wait(25).call(this.frame_509).wait(1).call(this.frame_510).wait(25).call(this.frame_535).wait(23).call(this.frame_558).wait(22).call(this.frame_580).wait(28).call(this.frame_608).wait(20).call(this.frame_628).wait(1).call(this.frame_629).wait(17).call(this.frame_646).wait(18).call(this.frame_664).wait(27).call(this.frame_691).wait(32).call(this.frame_723).wait(12).call(this.frame_735).wait(2).call(this.frame_737).wait(20).call(this.frame_757).wait(22).call(this.frame_779).wait(1).call(this.frame_780).wait(25).call(this.frame_805).wait(39).call(this.frame_844).wait(34).call(this.frame_878).wait(27).call(this.frame_905).wait(20).call(this.frame_925).wait(12).call(this.frame_937).wait(5));
        ...
        this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(860).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(42));
        ...
        this.timeline.addTween(cjs.Tween.get(this.window_2).wait(900).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.6},0).wait(1).to({y:378.9},0).wait(1).to({y:375.6},0).wait(1).to({y:370.25},0).wait(1).to({y:362.8},0).wait(1).to({y:354.45},0).wait(1).to({y:347.5},0).wait(1).to({y:342.95},0).wait(1).to({y:340.65},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(29));
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},900).wait(42));
        ...
        this.timeline.addTween(cjs.Tween.get(this.glitters).wait(900).to({_off:false},0).wait(42));
        ...
        this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(900).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8489},0).wait(1).to({alpha:0.8403},0).wait(1).to({alpha:0.8253},0).wait(1).to({alpha:0.8029},0).wait(1).to({alpha:0.7723},0).wait(1).to({alpha:0.7324},0).wait(1).to({alpha:0.6823},0).wait(1).to({alpha:0.6211},0).wait(1).to({alpha:0.5487},0).wait(1).to({alpha:0.4662},0).wait(1).to({alpha:0.3767},0).wait(1).to({alpha:0.2865},0).wait(1).to({alpha:0.2036},0).wait(1).to({alpha:0.1357},0).wait(1).to({alpha:0.0874},0).wait(1).to({alpha:0.0595},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(24));
        ...
        this.timeline.addTween(cjs.Tween.get(this.fns).wait(900).to({_off:false},0).wait(42));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(888).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(42));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(757).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(154));
        ...
        this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(927));
        ...
        this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(629).to({_off:false},0).to({alpha:1},35).to({_off:true},116).wait(162));
        ...
        this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(629).to({_off:false},0).to({alpha:0.4492},35).to({_off:true},116).wait(162));
        ...
        this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).to({_off:true},885).wait(42));
    
        // ef
        this.bg1 = new lib.ef_base();
        this.bg1.name = "bg1";
        this.bg1.parent = this;
        this.bg1.setTransform(-174.8,-114.15,1.0892,1.0892);
        this.bg1.compositeOperation = "lighter";
        this.bg1._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({_off:false},0).wait(15).to({regX:-0.1,regY:-0.1,scaleX:0.5718,scaleY:0.5718,x:-24.55,y:-50.45},15,cjs.Ease.quadInOut).wait(207).to({scaleX:0.6572,scaleY:0.6572,x:-48.25,y:-66.6},40,cjs.Ease.quadInOut).wait(218).to({alpha:0},14).to({_off:true},1).wait(417));
        ...
        this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({scaleX:1.0892,scaleY:1.0892,x:213.7,y:674.9},0).wait(15).to({regX:0.2,regY:0.1,scaleX:0.5718,scaleY:0.5718,x:179.5,y:363.9},15,cjs.Ease.quadInOut).wait(207).to({scaleX:0.6572,scaleY:0.6572,x:186.35,y:409.55},40,cjs.Ease.quadInOut).wait(90).to({y:409.6},0).wait(128).to({y:409.55},0).to({alpha:0},14).to({_off:true},1).wait(417));
    
        // bg
        this.bg1_1 = new lib.bg_zoom_half();
        this.bg1_1.name = "bg1_1";
        this.bg1_1.parent = this;
        this.bg1_1.setTransform(-5.5,-21.4,0.4784,0.4784,0,0,0,-0.1,0.1);
    
        this.timeline.addTween(cjs.Tween.get(this.bg1_1).wait(15).to({regX:0,regY:0,scaleX:1.0892,scaleY:1.0892,x:-174.8,y:-114.15},0).wait(15).to({regX:-0.1,regY:-0.1,scaleX:0.5718,scaleY:0.5718,x:-24.55,y:-50.45},15,cjs.Ease.quadInOut).wait(207).to({scaleX:0.6572,scaleY:0.6572,x:-48.25,y:-66.6},40,cjs.Ease.quadInOut).wait(218).to({alpha:0},14).to({_off:true},1).wait(417));
    
        // ef 2
        this.bg1_2 = new lib.ef_base();
        this.bg1_2.name = "bg1_2";
        this.bg1_2.parent = this;
        this.bg1_2.setTransform(-148.35,-127.15,0.9951,0.9951,0,0,0,-0.5,-0.2);
        this.bg1_2.compositeOperation = "lighter";
        this.bg1_2._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.bg1_2).wait(484).to({_off:false},0).wait(26).to({y:-142.1},0).to({y:-116.25},25,cjs.Ease.quadInOut).wait(94).to({scaleX:1.2706,scaleY:1.2706,x:-225.2,y:-156.2},62,cjs.Ease.quadInOut).wait(89).to({regX:-0.3,regY:-0.1,scaleX:0.5132,scaleY:0.5132,x:-5.7,y:-47.6},0).to({_off:true},120).wait(42));
    
        // ch2
        this.ch2 = new lib.character1_container();
        this.ch2.name = "ch2";
        this.ch2.parent = this;
        this.ch2.setTransform(207.65,604.65,0.9951,0.9951,0,0,0,0.6,0.7);
        this.ch2._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.ch2).wait(484).to({_off:false},0).wait(26).to({y:589.7},0).to({y:605.5},25,cjs.Ease.quadInOut).wait(94).to({regY:0.6,scaleX:1.2706,scaleY:1.2706,x:229.35,y:765.2},62,cjs.Ease.quadInOut).wait(89).to({regX:0.4,regY:0.4,scaleX:0.5132,scaleY:0.5132,x:177.7,y:324.4},0).to({_off:true},120).wait(42));
    
        // bg 2
        this.bg1_3 = new lib.bg_zoom_half();
        this.bg1_3.name = "bg1_3";
        this.bg1_3.parent = this;
        this.bg1_3.setTransform(-148.35,-117.1,0.9951,0.9951,0,0,0,-0.5,-0.2);
        this.bg1_3._off = true;
    
        this.timeline.addTween(cjs.Tween.get(this.bg1_3).wait(484).to({_off:false},0).wait(26).to({y:-132.05},0).to({y:-116.25},25,cjs.Ease.quadInOut).wait(94).to({scaleX:1.2706,scaleY:1.2706,x:-225.2,y:-156.2},62,cjs.Ease.quadInOut).wait(89).to({regX:-0.3,regY:-0.1,scaleX:0.5132,scaleY:0.5132,x:-5.7,y:-47.6},0).to({_off:true},120).wait(42));
        ...
        this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},888).wait(54));
        ...
        this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},900).wait(37).to({_off:false},0).wait(5));
    
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-282,-720,1025.7,1456.1);
    // library properties:
    lib.properties = {
        id: '_480_2',
        width: 240,
        ...
        opacity: 1.00,
        manifest: [
            {src:"images/bg.jpg", id:"_480_2_bg"},
            {src:"images/ch_base.png", id:"_480_2_ch_base"},
            {src:"images/ch_face10.png", id:"_480_2_ch_face10"},
            {src:"images/ch_face11.png", id:"_480_2_ch_face11"},
            {src:"images/ch_face12.png", id:"_480_2_ch_face12"},
            {src:"images/ch_face13.png", id:"_480_2_ch_face13"},
            {src:"images/ch_face2.png", id:"_480_2_ch_face2"},
            {src:"images/ch_face3.png", id:"_480_2_ch_face3"},
            {src:"images/ch_face4.png", id:"_480_2_ch_face4"},
            {src:"images/ch_face5.png", id:"_480_2_ch_face5"},
            {src:"images/ch_face6.png", id:"_480_2_ch_face6"},
            {src:"images/ch_face7.png", id:"_480_2_ch_face7"},
            {src:"images/ch_face8.png", id:"_480_2_ch_face8"},
            {src:"images/ch_face9.png", id:"_480_2_ch_face9"},
            {src:"images/eftest3.png", id:"_480_2_eftest3"},
            {src:"images/ef01.png", id:"_480_2_ef01"},
            {src:"images/ef02.png", id:"_480_2_ef02"},
            {src:"images/finish.jpg", id:"_480_2_finish"},
            {src:"images/finish_blur.jpg", id:"_480_2_finish_blur"},
            {src:"images/kirakira.png", id:"_480_2_kirakira"},
            {src:"images/tie_fp.png", id:"_480_2_tie_fp"},
            {src:"images/tie_sp.png", id:"_480_2_tie_sp"}
        ],
        preloads: []
    };
