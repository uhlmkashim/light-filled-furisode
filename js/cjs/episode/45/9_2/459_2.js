...
(lib.bg_1 = function() {
	this.initialize(img._459_2_bg_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1184,1400);


(lib.bg_2 = function() {
	this.initialize(img._459_2_bg_2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1184,1400);


(lib.book = function() {
	this.initialize(img._459_2_book);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1184,1400);


(lib.ch_base = function() {
	this.initialize(img._459_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1184,1400);


(lib.ch_face1 = function() {
	this.initialize(img._459_2_ch_face1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,228,220);


(lib.ch_face2 = function() {
	this.initialize(img._459_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,228,220);


(lib.ch_face3 = function() {
	this.initialize(img._459_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,228,220);


(lib.ch_face4 = function() {
	this.initialize(img._459_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,228,220);


(lib.ch_face6 = function() {
	this.initialize(img._459_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,228,220);


(lib.finish = function() {
	this.initialize(img._459_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._459_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.mist = function() {
	this.initialize(img._459_2_mist);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,744,745);


(lib.shine = function() {
	this.initialize(img._459_2_shine);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1184,1400);


(lib.shine_sub = function() {
	this.initialize(img._459_2_shine_sub);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,474,1023);


(lib.tie_fp = function() {
	this.initialize(img._459_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._459_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.g_book = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-296,-350,0.5,0.5);

	this.instance_1 = new lib.mist();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-186,-186,0.5,0.5);

	this.instance_2 = new lib.shine();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-296,-350,0.5,0.5);

	this.instance_3 = new lib.shine_sub();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-296,-350,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-296,-350,592,700);
...
}).prototype = getMCSymbolPrototype(lib.bg2, new cjs.Rectangle(0,0,592,700), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,114,110), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,592,700), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,592,700);
...
(lib.book_motion = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// shine
	this.instance = new lib.g_book("single",3);
	this.instance.parent = this;
	this.instance.setTransform(211.35,180.35,0.7,0.7,0,0,0,295.9,349.9);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(135.7,138.1,0.5,0.5,0,0,0,296,350);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1},39).to({alpha:0},40).wait(1));

	// smoke1
	this.instance_2 = new lib.g_book("single",1);
	this.instance_2.parent = this;
	this.instance_2.setTransform(60.55,105.3,0.3365,0.3365,180,0,0,-3.2,3.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(1).to({regX:0,regY:0,scaleX:0.3383,scaleY:0.3383,x:59.4426,y:105.8525,alpha:0.9664},0).wait(1).to({scaleX:0.3402,scaleY:0.3402,x:59.4349,y:105.1718,alpha:0.931},0).wait(1).to({scaleX:0.3422,scaleY:0.3422,x:59.4267,y:104.4579,alpha:0.894},0).wait(1).to({scaleX:0.3443,scaleY:0.3443,x:59.4182,y:103.7108,alpha:0.8552},0).wait(1).to({scaleX:0.3465,scaleY:0.3465,x:59.4093,y:102.9305,alpha:0.8147},0).wait(1).to({scaleX:0.3487,scaleY:0.3487,x:59.4,y:102.117,alpha:0.7724},0).wait(1).to({scaleX:0.3511,scaleY:0.3511,x:59.3904,y:101.2703,alpha:0.7284},0).wait(1).to({scaleX:0.3535,scaleY:0.3535,x:59.3804,y:100.3904,alpha:0.6828},0).wait(1).to({scaleX:0.356,scaleY:0.356,x:59.37,y:99.4773,alpha:0.6353},0).wait(1).to({scaleX:0.3587,scaleY:0.3587,x:59.3592,y:98.531,alpha:0.5862},0).wait(1).to({scaleX:0.3614,scaleY:0.3614,x:59.348,y:97.5514,alpha:0.5353},0).wait(1).to({scaleX:0.3642,scaleY:0.3642,x:59.3365,y:96.5387,alpha:0.4828},0).wait(1).to({scaleX:0.3671,scaleY:0.3671,x:59.3245,y:95.4928,alpha:0.4284},0).wait(1).to({scaleX:0.3701,scaleY:0.3701,x:59.3122,y:94.4136,alpha:0.3724},0).wait(1).to({scaleX:0.3732,scaleY:0.3732,x:59.2996,y:93.3013,alpha:0.3147},0).wait(1).to({scaleX:0.3763,scaleY:0.3763,x:59.2865,y:92.1557,alpha:0.2552},0).wait(1).to({scaleX:0.3796,scaleY:0.3796,x:59.2731,y:90.977,alpha:0.194},0).wait(1).to({scaleX:0.383,scaleY:0.383,x:59.2593,y:89.765,alpha:0.131},0).wait(1).to({scaleX:0.3864,scaleY:0.3864,x:59.2451,y:88.5199,alpha:0.0664},0).wait(1).to({regX:-3.2,regY:3.7,scaleX:0.39,scaleY:0.39,x:60.5,y:85.85,alpha:0},0).to({regY:3.9,scaleX:0.32,scaleY:0.32,rotation:320.001,x:81,y:89.8},1,cjs.Ease.get(-1)).wait(1).to({regX:0,regY:0,rotation:320.0014,x:80.9997,y:88.1742,alpha:0.0028},0).wait(1).to({scaleX:0.3201,scaleY:0.3201,rotation:320.0026,x:80.9987,y:88.0966,alpha:0.0111},0).wait(1).to({scaleX:0.3203,scaleY:0.3203,rotation:320.0047,x:80.9971,y:87.9674,alpha:0.025},0).wait(1).to({scaleX:0.3206,scaleY:0.3206,rotation:320.0076,x:80.9948,y:87.7866,alpha:0.0444},0).wait(1).to({scaleX:0.321,scaleY:0.321,rotation:320.0113,x:80.9919,y:87.554,alpha:0.0693},0).wait(1).to({scaleX:0.3215,scaleY:0.3215,rotation:320.0159,x:80.9883,y:87.2697,alpha:0.0998},0).wait(1).to({scaleX:0.322,scaleY:0.322,rotation:320.0212,x:80.9841,y:86.9338,alpha:0.1359},0).wait(1).to({scaleX:0.3227,scaleY:0.3227,rotation:320.0274,x:80.9792,y:86.5462,alpha:0.1775},0).wait(1).to({scaleX:0.3234,scaleY:0.3234,rotation:320.0345,x:80.9737,y:86.1069,alpha:0.2246},0).wait(1).to({scaleX:0.3242,scaleY:0.3242,rotation:320.0424,x:80.9675,y:85.616,alpha:0.2773},0).wait(1).to({scaleX:0.3251,scaleY:0.3251,rotation:320.051,x:80.9607,y:85.0733,alpha:0.3355},0).wait(1).to({scaleX:0.3261,scaleY:0.3261,rotation:320.0606,x:80.9533,y:84.479,alpha:0.3993},0).wait(1).to({scaleX:0.3272,scaleY:0.3272,rotation:320.0709,x:80.9451,y:83.833,alpha:0.4686},0).wait(1).to({scaleX:0.3283,scaleY:0.3283,rotation:320.0821,x:80.9364,y:83.1353,alpha:0.5435},0).wait(1).to({scaleX:0.3296,scaleY:0.3296,rotation:320.0941,x:80.927,y:82.3859,alpha:0.6239},0).wait(1).to({scaleX:0.3309,scaleY:0.3309,rotation:320.1069,x:80.9169,y:81.5849,alpha:0.7099},0).wait(1).to({scaleX:0.3323,scaleY:0.3323,rotation:320.1206,x:80.9062,y:80.7321,alpha:0.8014},0).wait(1).to({regX:-3.1,regY:4,scaleX:0.3338,scaleY:0.3338,rotation:320.1351,x:80.9,y:81.45,alpha:0.8984},0).to({regX:-3.2,regY:3.9,scaleX:0.336,scaleY:0.336,rotation:320.1105,y:80.55,alpha:1},1).wait(1).to({regX:0,regY:0,scaleX:0.3378,scaleY:0.3378,rotation:320.1068,x:80.833,y:77.8384,alpha:0.9664},0).wait(1).to({scaleX:0.3397,scaleY:0.3397,rotation:320.1029,x:80.8152,y:76.775,alpha:0.931},0).wait(1).to({scaleX:0.3417,scaleY:0.3417,rotation:320.0989,x:80.7965,y:75.6597,alpha:0.894},0).wait(1).to({scaleX:0.3438,scaleY:0.3438,rotation:320.0947,x:80.7769,y:74.4925,alpha:0.8552},0).wait(1).to({scaleX:0.346,scaleY:0.346,rotation:320.0902,x:80.7564,y:73.2734,alpha:0.8147},0).wait(1).to({scaleX:0.3483,scaleY:0.3483,rotation:320.0856,x:80.7351,y:72.0025,alpha:0.7724},0).wait(1).to({scaleX:0.3507,scaleY:0.3507,rotation:320.0808,x:80.7129,y:70.6797,alpha:0.7284},0).wait(1).to({scaleX:0.3531,scaleY:0.3531,rotation:320.0758,x:80.6898,y:69.305,alpha:0.6828},0).wait(1).to({scaleX:0.3557,scaleY:0.3557,rotation:320.0706,x:80.6659,y:67.8784,alpha:0.6353},0).wait(1).to({scaleX:0.3583,scaleY:0.3583,rotation:320.0653,x:80.6411,y:66.4,alpha:0.5862},0).wait(1).to({scaleX:0.3611,scaleY:0.3611,rotation:320.0597,x:80.6154,y:64.8696,alpha:0.5353},0).wait(1).to({scaleX:0.3639,scaleY:0.3639,rotation:320.054,x:80.5888,y:63.2875,alpha:0.4828},0).wait(1).to({scaleX:0.3669,scaleY:0.3669,rotation:320.0481,x:80.5614,y:61.6534,alpha:0.4284},0).wait(1).to({scaleX:0.3699,scaleY:0.3699,rotation:320.0419,x:80.5331,y:59.9674,alpha:0.3724},0).wait(1).to({scaleX:0.373,scaleY:0.373,rotation:320.0356,x:80.5039,y:58.2296,alpha:0.3147},0).wait(1).to({scaleX:0.3762,scaleY:0.3762,rotation:320.0291,x:80.4738,y:56.4399,alpha:0.2552},0).wait(1).to({scaleX:0.3795,scaleY:0.3795,rotation:320.0224,x:80.4429,y:54.5984,alpha:0.194},0).wait(1).to({scaleX:0.3829,scaleY:0.3829,rotation:320.0156,x:80.4111,y:52.7049,alpha:0.131},0).wait(1).to({scaleX:0.3864,scaleY:0.3864,rotation:320.0085,x:80.3784,y:50.7596,alpha:0.0664},0).wait(1).to({regX:-3.1,regY:3.9,scaleX:0.39,scaleY:0.39,rotation:320.0013,x:80.35,y:50.75,alpha:0},0).to({regY:3.8,scaleX:0.3199,scaleY:0.3199,rotation:180,x:60.5,y:111.3},1,cjs.Ease.get(-1)).wait(1).to({regX:0,regY:0,scaleX:0.32,scaleY:0.32,x:59.5,y:112.4836,alpha:0.0028},0).wait(1).to({scaleX:0.3201,scaleY:0.3201,y:112.4346,alpha:0.0111},0).wait(1).to({scaleX:0.3203,scaleY:0.3203,y:112.3528,alpha:0.025},0).wait(1).to({scaleX:0.3207,scaleY:0.3207,y:112.2383,alpha:0.0444},0).wait(1).to({scaleX:0.3211,scaleY:0.3211,y:112.0911,alpha:0.0693},0).wait(1).to({scaleX:0.3216,scaleY:0.3216,y:111.9111,alpha:0.0998},0).wait(1).to({scaleX:0.3222,scaleY:0.3222,y:111.6985,alpha:0.1359},0).wait(1).to({scaleX:0.3229,scaleY:0.3229,y:111.4531,alpha:0.1775},0).wait(1).to({scaleX:0.3237,scaleY:0.3237,y:111.1751,alpha:0.2246},0).wait(1).to({scaleX:0.3245,scaleY:0.3245,y:110.8643,alpha:0.2773},0).wait(1).to({scaleX:0.3255,scaleY:0.3255,y:110.5208,alpha:0.3355},0).wait(1).to({scaleX:0.3265,scaleY:0.3265,y:110.1445,alpha:0.3993},0).wait(1).to({scaleX:0.3277,scaleY:0.3277,y:109.7356,alpha:0.4686},0).wait(1).to({scaleX:0.3289,scaleY:0.3289,y:109.294,alpha:0.5435},0).wait(1).to({scaleX:0.3303,scaleY:0.3303,y:108.8196,alpha:0.6239},0).wait(1).to({scaleX:0.3317,scaleY:0.3317,y:108.3125,alpha:0.7099},0).wait(1).to({scaleX:0.3332,scaleY:0.3332,y:107.7727,alpha:0.8014},0).wait(1).to({regX:-3.1,regY:3.6,scaleX:0.3348,scaleY:0.3348,x:60.55,y:105.95,alpha:0.8984},0).wait(1));

	// smoke2
	this.instance_3 = new lib.g_book("single",1);
	this.instance_3.parent = this;
	this.instance_3.setTransform(52,128.9,0.32,0.32,0,0,0,-3.1,3.8);
	this.instance_3.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({regX:0,regY:0,x:53.0003,y:127.6736,alpha:0.0028},0).wait(1).to({scaleX:0.3202,scaleY:0.3202,x:53.0013,y:127.5946,alpha:0.0111},0).wait(1).to({scaleX:0.3204,scaleY:0.3204,x:53.0029,y:127.4628,alpha:0.0249},0).wait(1).to({scaleX:0.3207,scaleY:0.3207,x:53.0052,y:127.2782,alpha:0.0443},0).wait(1).to({scaleX:0.3211,scaleY:0.3211,x:53.0081,y:127.041,alpha:0.0693},0).wait(1).to({scaleX:0.3216,scaleY:0.3216,x:53.0117,y:126.751,alpha:0.0997},0).wait(1).to({scaleX:0.3222,scaleY:0.3222,x:53.0159,y:126.4083,alpha:0.1357},0).wait(1).to({scaleX:0.3229,scaleY:0.3229,x:53.0207,y:126.0129,alpha:0.1773},0).wait(1).to({scaleX:0.3237,scaleY:0.3237,x:53.0262,y:125.5648,alpha:0.2244},0).wait(1).to({scaleX:0.3246,scaleY:0.3246,x:53.0324,y:125.0639,alpha:0.277},0).wait(1).to({scaleX:0.3255,scaleY:0.3255,x:53.0392,y:124.5103,alpha:0.3352},0).wait(1).to({scaleX:0.3266,scaleY:0.3266,x:53.0466,y:123.904,alpha:0.3989},0).wait(1).to({scaleX:0.3277,scaleY:0.3277,x:53.0547,y:123.245,alpha:0.4681},0).wait(1).to({scaleX:0.329,scaleY:0.329,x:53.0634,y:122.5332,alpha:0.5429},0).wait(1).to({scaleX:0.3303,scaleY:0.3303,x:53.0728,y:121.7688,alpha:0.6233},0).wait(1).to({scaleX:0.3317,scaleY:0.3317,x:53.0828,y:120.9516,alpha:0.7091},0).wait(1).to({scaleX:0.3333,scaleY:0.3333,x:53.0935,y:120.0817,alpha:0.8006},0).wait(1).to({scaleX:0.3349,scaleY:0.3349,x:53.1049,y:119.159,alpha:0.8975},0).wait(1).to({regX:-3.1,regY:3.9,scaleX:0.3366,scaleY:0.3366,x:52.05,y:119.45,alpha:1},0).wait(1).to({regX:0,regY:0,scaleX:0.3384,scaleY:0.3384,x:53.1034,y:117.1158,alpha:0.9664},0).wait(1).to({scaleX:0.3403,scaleY:0.3403,x:53.1069,y:116.0286,alpha:0.931},0).wait(1).to({scaleX:0.3422,scaleY:0.3422,x:53.1106,y:114.8883,alpha:0.894},0).wait(1).to({scaleX:0.3443,scaleY:0.3443,x:53.1145,y:113.695,alpha:0.8552},0).wait(1).to({scaleX:0.3465,scaleY:0.3465,x:53.1185,y:112.4486,alpha:0.8147},0).wait(1).to({scaleX:0.3487,scaleY:0.3487,x:53.1228,y:111.1492,alpha:0.7724},0).wait(1).to({scaleX:0.3511,scaleY:0.3511,x:53.1272,y:109.7968,alpha:0.7284},0).wait(1).to({scaleX:0.3535,scaleY:0.3535,x:53.1317,y:108.3913,alpha:0.6828},0).wait(1).to({scaleX:0.3561,scaleY:0.3561,x:53.1365,y:106.9328,alpha:0.6353},0).wait(1).to({scaleX:0.3587,scaleY:0.3587,x:53.1414,y:105.4213,alpha:0.5862},0).wait(1).to({scaleX:0.3614,scaleY:0.3614,x:53.1465,y:103.8567,alpha:0.5353},0).wait(1).to({scaleX:0.3642,scaleY:0.3642,x:53.1517,y:102.2391,alpha:0.4828},0).wait(1).to({scaleX:0.3671,scaleY:0.3671,x:53.1572,y:100.5685,alpha:0.4284},0).wait(1).to({scaleX:0.3701,scaleY:0.3701,x:53.1628,y:98.8448,alpha:0.3724},0).wait(1).to({scaleX:0.3732,scaleY:0.3732,x:53.1685,y:97.0681,alpha:0.3147},0).wait(1).to({scaleX:0.3764,scaleY:0.3764,x:53.1745,y:95.2384,alpha:0.2552},0).wait(1).to({scaleX:0.3796,scaleY:0.3796,x:53.1806,y:93.3556,alpha:0.194},0).wait(1).to({scaleX:0.383,scaleY:0.383,x:53.1869,y:91.4198,alpha:0.131},0).wait(1).to({scaleX:0.3864,scaleY:0.3864,x:53.1934,y:89.4309,alpha:0.0664},0).wait(1).to({regX:-3.1,regY:4,scaleX:0.39,scaleY:0.39,x:52,y:88.9,alpha:0},0).to({regY:4.2,scaleX:0.32,scaleY:0.32,rotation:50.0006,x:109.3,y:91.7},1,cjs.Ease.get(-1)).wait(1).to({regX:0,regY:0,rotation:50.0009,x:111.0004,y:91.5688,alpha:0.0028},0).wait(1).to({scaleX:0.3202,scaleY:0.3202,rotation:50.0018,x:111.0016,y:91.4754,alpha:0.0111},0).wait(1).to({scaleX:0.3204,scaleY:0.3204,rotation:50.0034,x:111.0037,y:91.3196,alpha:0.0249},0).wait(1).to({scaleX:0.3207,scaleY:0.3207,rotation:50.0055,x:111.0065,y:91.1016,alpha:0.0443},0).wait(1).to({scaleX:0.3211,scaleY:0.3211,rotation:50.0082,x:111.0102,y:90.8212,alpha:0.0693},0).wait(1).to({scaleX:0.3216,scaleY:0.3216,rotation:50.0115,x:111.0147,y:90.4785,alpha:0.0997},0).wait(1).to({scaleX:0.3222,scaleY:0.3222,rotation:50.0155,x:111.02,y:90.0735,alpha:0.1357},0).wait(1).to({scaleX:0.3228,scaleY:0.3228,rotation:50.02,x:111.0261,y:89.6063,alpha:0.1773},0).wait(1).to({scaleX:0.3236,scaleY:0.3236,rotation:50.0252,x:111.0331,y:89.0767,alpha:0.2244},0).wait(1).to({scaleX:0.3244,scaleY:0.3244,rotation:50.031,x:111.0408,y:88.4848,alpha:0.277},0).wait(1).to({scaleX:0.3254,scaleY:0.3254,rotation:50.0373,x:111.0494,y:87.8306,alpha:0.3352},0).wait(1).to({scaleX:0.3264,scaleY:0.3264,rotation:50.0443,x:111.0588,y:87.1141,alpha:0.3989},0).wait(1).to({scaleX:0.3275,scaleY:0.3275,rotation:50.0519,x:111.069,y:86.3353,alpha:0.4681},0).wait(1).to({scaleX:0.3287,scaleY:0.3287,rotation:50.0601,x:111.08,y:85.4942,alpha:0.5429},0).wait(1).to({scaleX:0.33,scaleY:0.33,rotation:50.0689,x:111.0918,y:84.5908,alpha:0.6233},0).wait(1).to({scaleX:0.3314,scaleY:0.3314,rotation:50.0783,x:111.1045,y:83.6251,alpha:0.7091},0).wait(1).to({scaleX:0.3328,scaleY:0.3328,rotation:50.0883,x:111.1179,y:82.5971,alpha:0.8006},0).wait(1).to({scaleX:0.3344,scaleY:0.3344,rotation:50.0989,x:111.1322,y:81.5068,alpha:0.8975},0).wait(1).to({regX:-3,regY:4,scaleX:0.336,scaleY:0.336,rotation:50.1101,x:109.4,y:80.45,alpha:1},0).wait(1).to({regX:0,regY:0,scaleX:0.3378,scaleY:0.3378,rotation:50.1065,x:111.1071,y:79.1377,alpha:0.9664},0).wait(1).to({scaleX:0.3397,scaleY:0.3397,rotation:50.1026,x:111.1145,y:77.8633,alpha:0.931},0).wait(1).to({scaleX:0.3417,scaleY:0.3417,rotation:50.0986,x:111.1223,y:76.5267,alpha:0.894},0).wait(1).to({scaleX:0.3438,scaleY:0.3438,rotation:50.0944,x:111.1304,y:75.1279,alpha:0.8552},0).wait(1).to({scaleX:0.346,scaleY:0.346,rotation:50.09,x:111.1389,y:73.667,alpha:0.8147},0).wait(1).to({scaleX:0.3483,scaleY:0.3483,rotation:50.0854,x:111.1478,y:72.1439,alpha:0.7724},0).wait(1).to({scaleX:0.3507,scaleY:0.3507,rotation:50.0806,x:111.1571,y:70.5586,alpha:0.7284},0).wait(1).to({scaleX:0.3531,scaleY:0.3531,rotation:50.0756,x:111.1667,y:68.9112,alpha:0.6828},0).wait(1).to({scaleX:0.3557,scaleY:0.3557,rotation:50.0704,x:111.1766,y:67.2015,alpha:0.6353},0).wait(1).to({scaleX:0.3583,scaleY:0.3584,rotation:50.0651,x:111.187,y:65.4297,alpha:0.5862},0).wait(1).to({scaleX:0.3611,scaleY:0.3611,rotation:50.0596,x:111.1976,y:63.5958,alpha:0.5353},0).wait(1).to({scaleX:0.3639,scaleY:0.3639,rotation:50.0538,x:111.2087,y:61.6997,alpha:0.4828},0).wait(1).to({scaleX:0.3669,scaleY:0.3669,rotation:50.0479,x:111.2201,y:59.7414,alpha:0.4284},0).wait(1).to({scaleX:0.3699,scaleY:0.3699,rotation:50.0418,x:111.2319,y:57.7209,alpha:0.3724},0).wait(1).to({scaleX:0.373,scaleY:0.373,rotation:50.0355,x:111.244,y:55.6382,alpha:0.3147},0).wait(1).to({scaleX:0.3762,scaleY:0.3762,rotation:50.029,x:111.2565,y:53.4934,alpha:0.2552},0).wait(1).to({scaleX:0.3795,scaleY:0.3795,rotation:50.0224,x:111.2694,y:51.2864,alpha:0.194},0).wait(1).to({scaleX:0.3829,scaleY:0.3829,rotation:50.0155,x:111.2826,y:49.0173,alpha:0.131},0).wait(1).to({scaleX:0.3864,scaleY:0.3864,rotation:50.0085,x:111.2962,y:46.6859,alpha:0.0664},0).wait(1).to({regX:-2.9,regY:4.1,scaleX:0.39,scaleY:0.39,rotation:50.0013,x:109.35,y:44.45,alpha:0},0).wait(1));

	// book
	this.instance_4 = new lib.g_book("single",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(148,175,0.5,0.5,0,0,0,296,350);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(80));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-203,-309.5,416.5,496.9);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("AAoBLIAAgIIhQAAIAAAIIgRAAIAAhGIByAAIAABHgAgoAzIBQAAIAAgeIhQAAgAA3gHIgFgIIgXADIgoACIg7ACIgDgQIAOAAIAMAAIAOgRIALgRIAIgLIACgGIARAEIgCAEIgHALIgKAQIgMAQIApgCIAbgDIgKgLIgJgJIgEgEIANgIIAFADIAKAKIAOARIAQAVIgQAKIgEgHg");
	this.shape.setTransform(48,0.45);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("");
	this.shape_1.setTransform(31.9,0.65);
	...
	this.shape_2.setTransform(16.125,0.975);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(-0.1,0.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
	this.shape_4.setTransform(-16.025,0.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#333333").s().p("");
	this.shape_5.setTransform(-31.95,0.325);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#333333").s().p("");
	this.shape_6.setTransform(-48,0.425);
...
(lib.chord = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-42.5,54.8,0.5582,0.5582,-11.7676,0,0,15.6,17.5);
	this.instance.alpha = 0.1016;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(2).to({_off:false},0).to({regX:15.8,scaleX:0.9628,scaleY:0.9628,rotation:2.8579,guide:{path:[-42.4,54.8,-47.2,44.4,-48.3,33.2,-50.3,13.1,-38.1,-0.9,-35.1,-4.4,-32.9,-8.1]},alpha:0.6602},5).wait(1).to({regX:16.7,regY:23.1,scaleX:1.0446,scaleY:1.0446,rotation:-11.9241,x:-25.6,y:-15.1,alpha:0.7734},0).wait(1).to({scaleX:1.1263,scaleY:1.1263,rotation:-26.7061,x:-22.6,y:-29.4,alpha:0.8867},0).wait(1).to({regX:15.8,regY:17.2,scaleX:1.2081,scaleY:1.2081,rotation:-41.488,x:-28.9,y:-47.55,alpha:1},0).to({scaleX:1.2082,scaleY:1.2082,rotation:-17.0378,guide:{path:[-28.7,-47.5,-29,-48.2,-29.3,-48.9,-31.9,-55.2,-36.3,-58.4]},alpha:0},3).to({_off:true},1).wait(1));

	// chord
	this.instance_1 = new lib.chord1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-32.75,77.9,0.9892,0.9892,-56.4847,0,0,15.7,17.3);
	this.instance_1.alpha = 0.1016;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:15.8,regY:17.2,scaleX:1.2082,scaleY:1.2082,rotation:18.5132,guide:{path:[-32.5,78,-31.9,75.6,-31.1,73.1,-22.1,45.9,-3.9,33.4,14,21.5,19.8,-1.4,22.5,-11.6,22.4,-20.2]},alpha:1},7).to({rotation:18.5132,x:29.55,y:-47.05,alpha:0},3).to({_off:true},1).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-60.8,-84.5,115.19999999999999,184.8);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AovIcIAAw3IRfAAIAAQ3g");
	mask.setTransform(57,55);
...
p.nominalBounds = new cjs.Rectangle(1,1,112,108);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AmRC9IgogJIghgaQgigbAAgCIAlhdIA5hbIBEgzIBkgtIBqgTIBbAiIB+AaICAhBICWgMIA8AaIBDBFIAZBQIACBbIg/AaIgVARIhdAQIlLgEIg9AEIgoAOIhVAWIhbAQIhAAGg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:56.125,y:44.75}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:57,regY:55,x:57,y:55,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:57,regY:55,x:57,y:55,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:57,regY:55,x:57,y:55,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:57,regY:55,x:57,y:55,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-253,-219,592,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-89.4,-77);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-209.4,-473,592,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(151.6,-298.3,1.1645,1.1645,0,0,180);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(160.05,-247.7,0.4532,0.4532,0,0,180);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.2,y:-307.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:188.85,y:-311.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:151.6,y:-298.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.2,y:-307.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:188.85,y:-311.6,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:151.6,y:-298.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.2,y:-307.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:188.85,y:-311.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:151.6,y:-298.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:177.2,y:-307.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:188.85,y:-311.6,alpha:0.2188},0).to({_off:true},1).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:161.8,y:-261.85,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:165.05,y:-267.7,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:162.5,y:-265.55,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:161.95,y:-262.3,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:163.05,y:-257.7,alpha:0},0).to({_off:true},1).wait(66));

	// effect_look_to_right
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(93.45,-205.55,1.4807,1.4807,0,0,180);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(93.5,-205.6,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(167.15,-293.85,1.1857,1.1857,169.9438,0,0,-29.1,20.5);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(183.15,-290.3,1.4181,1.4181,0,-35.8376,144.173,-30.2,20.5);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(160,-207.9,0.8996,0.8996,-6.2572,0,0,-23.4,76.9);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(155.35,-290.8,1.053,1.053,29.448);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(163.4,-291.15,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(154.8,-288.7,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(153.4,-288.55,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(159.85,-291.55,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(133.4,-138.25,1,1,0,0,180);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(160.05,-247.7,0.4532,0.4532,0,0,180);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(166.6,-268.95,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(35.55,-318.1,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(93.25,-206.15,1,1,0,0,0,-0.5,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-293.9},0).wait(3).to({regX:-28.8,x:166.75,y:-293.75,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:167.15,y:-293.9,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,scaleX:1.1857,scaleY:1.1857,rotation:169.9438,y:-293.85,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,scaleX:1.1864,scaleY:1.1864,rotation:169.9437,y:-293.9},0).wait(3).to({regX:-28.8,x:166.75,y:-293.75,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,x:167.15,y:-293.9,alpha:0},0).to({_off:true},1).wait(283));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).wait(15).to({regY:20.4,skewX:-35.827,skewY:144.1725,x:183.05,y:-290.35},0).wait(1).to({regX:-31.4,regY:22.1,x:185.85,y:-289.4,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.4,x:183.05,y:-290.35,alpha:0,startPosition:19},0).to({_off:true},1).wait(262));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:163,y:-303.75,alpha:0.5556},0).wait(1).to({x:167.8,y:-311.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:169.75,y:-314.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:169.1,y:-313.65},0).wait(1).to({x:168.05,y:-311.8},0).wait(1).to({x:166.3,y:-308.7},0).wait(1).to({regX:0,regY:0,x:164.15,y:-304.5},0).to({x:164.9,y:-305.85},2).wait(8).to({regX:-0.2,regY:0.2,x:164.25,y:-305.15,alpha:0.9298},0).wait(1).to({x:163.15,y:-303.2,alpha:0.692},0).wait(1).to({x:161.55,y:-300.35,alpha:0.339},0).wait(1).to({x:160.35,y:-298.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-297.7,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:155.35,y:-290.8},0).wait(1).to({regX:-0.2,regY:0.2,x:163,y:-303.75,alpha:0.5556},0).wait(1).to({x:167.8,y:-311.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:169.75,y:-314.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:169.1,y:-313.65},0).wait(1).to({x:168.05,y:-311.8},0).wait(1).to({x:166.3,y:-308.7},0).wait(1).to({regX:0,regY:0,x:164.15,y:-304.5},0).to({x:164.9,y:-305.85},2).wait(3).to({regX:-0.2,regY:0.2,x:164.25,y:-305.15,alpha:0.9298},0).wait(1).to({x:163.15,y:-303.2,alpha:0.692},0).wait(1).to({x:161.55,y:-300.35,alpha:0.339},0).wait(1).to({x:160.35,y:-298.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-297.7,alpha:0},0).to({_off:true},1).wait(195));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:155.8,y:-285},0).wait(1).to({y:-281.15},0).wait(1).to({y:-277.9},0).wait(1).to({y:-275.25},0).wait(1).to({y:-273.15},0).wait(1).to({y:-271.65},0).wait(1).to({y:-270.75},0).wait(1).to({regX:-0.5,regY:0.2,x:154.8,y:-269.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:155.8,y:-270.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:154.8,y:-269.7,alpha:0},0).to({_off:true},1).wait(153));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:184.825,y:-283.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.3,y:-282.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:153.4,y:-288.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:184.825,y:-288.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.3,y:-288.25,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:153.4,y:-288.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:184.825,y:-283.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.3,y:-282.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:153.4,y:-288.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:184.825,y:-288.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:195.3,y:-288.25,alpha:0.2188},0).to({_off:true},1).wait(110));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(351).to({_off:false},0).wait(1).to({x:134.4,y:-137.25,alpha:1},0).wait(1).to({regX:0.9,x:134.5,y:-136.3,alpha:0.8965},0).wait(1).to({x:135.85,y:-135.1,alpha:0.7636},0).wait(1).to({x:137.45,y:-133.65,alpha:0.6048},0).wait(1).to({x:139.25,y:-132.05,alpha:0.4229},0).wait(1).to({x:141.25,y:-130.2,alpha:0.2205},0).wait(1).to({regX:0,x:144.4,y:-128.25,alpha:0},0).to({_off:true},1).wait(83));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:161.8,y:-261.85},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:165.05,y:-267.7},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:162.5,y:-265.55},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:161.95,y:-262.3},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:163.05,y:-257.7},0).to({scaleX:1,scaleY:1,x:164.05,y:-261.7},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:161.45,y:-260.7,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:163.05,y:-261.45,alpha:0.1016},0).to({_off:true},1).wait(59));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-272.7},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-273.95},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(40));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:86.6,regY:-123,x:86.6,y:-131.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-132.2},0).wait(1).to({y:-129.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-128.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-128.75},0).wait(1).to({y:-121.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-119.75},0).wait(1).to({y:-122.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-127.95},0).wait(1).to({y:-122.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-127.95},0).wait(1).to({y:-122.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-122.1},0).wait(1).to({y:-122.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-132},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-135.95},0).wait(1).to({y:-132.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-121},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-123.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-132},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-135.95},0).wait(1).to({y:-132.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-121},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-123.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.6,regY:-123,x:86.6,y:-122.4},0).wait(1).to({y:-120},0).wait(1).to({y:-117.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-117.65},0).wait(1).to({y:-120},0).wait(1).to({y:-122.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.6,regY:-123,x:86.6,y:-122.85},0).wait(1).to({y:-122.3},0).wait(1).to({y:-121.2},0).wait(1).to({y:-119.85},0).wait(1).to({y:-118.75},0).wait(1).to({y:-118.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-118.2},0).wait(1).to({y:-118.75},0).wait(1).to({y:-119.85},0).wait(1).to({y:-121.2},0).wait(1).to({y:-122.3},0).wait(1).to({y:-122.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-118.25},0).wait(1).to({y:-121.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-120.8},0).wait(1).to({y:-122.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.6,regY:-123,rotation:0.0244,x:86.65,y:-122.9},0).wait(1).to({rotation:0.1092,x:86.95,y:-122.5},0).wait(1).to({rotation:0.275,x:87.55,y:-121.7},0).wait(1).to({rotation:0.538,x:88.45,y:-120.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:89.6,y:-118.85},0).wait(1).to({rotation:1.1673,x:90.6,y:-117.35},0).wait(1).to({rotation:1.367,x:91.3,y:-116.35},0).wait(1).to({rotation:1.4695,x:91.65,y:-115.85},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:86.6,regY:-123,rotation:1.479,x:91.6,y:-115.85},0).wait(1).to({rotation:1.4111,x:91.4,y:-116.15},0).wait(1).to({rotation:1.2801,x:90.95,y:-116.8},0).wait(1).to({rotation:1.0711,x:90.25,y:-117.85},0).wait(1).to({rotation:0.7884,x:89.3,y:-119.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:88.25,y:-120.65},0).wait(1).to({rotation:0.2415,x:87.35,y:-121.85},0).wait(1).to({rotation:0.0832,x:86.85,y:-122.6},0).wait(1).to({rotation:0.0011,x:86.6,y:-123},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:86.6,regY:-123,rotation:0.0244,x:86.65,y:-122.9},0).wait(1).to({rotation:0.1092,x:86.95,y:-122.5},0).wait(1).to({rotation:0.275,x:87.55,y:-121.7},0).wait(1).to({rotation:0.538,x:88.45,y:-120.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:89.6,y:-118.85},0).wait(1).to({rotation:1.1673,x:90.6,y:-117.35},0).wait(1).to({rotation:1.367,x:91.3,y:-116.35},0).wait(1).to({rotation:1.4695,x:91.65,y:-115.85},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:86.6,regY:-123,rotation:1.4793,x:91.6,y:-115.85},0).wait(1).to({rotation:1.4124,x:91.4,y:-116.15},0).wait(1).to({rotation:1.2834,x:90.95,y:-116.8},0).wait(1).to({rotation:1.0775,x:90.25,y:-117.8},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:89.3,y:-119.2},0).wait(1).to({rotation:0.5016,x:88.3,y:-120.65},0).wait(1).to({rotation:0.2603,x:87.4,y:-121.8},0).wait(1).to({rotation:0.1043,x:86.85,y:-122.6},0).wait(1).to({rotation:0.0235,x:86.65,y:-122.95},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:86.6,regY:-123,x:86.6,y:-128.55},0).wait(1).to({y:-130.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-130.35},0).wait(1).to({y:-128.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:86.6,regY:-123,x:86.6,y:-131.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-132.2},0).wait(1).to({y:-129.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:86.6,regY:-123,rotation:-0.0253,x:86.55,y:-122.95},0).wait(1).to({rotation:-0.1129,x:86.45,y:-122.5},0).wait(1).to({rotation:-0.2845,x:86.35,y:-121.8},0).wait(1).to({rotation:-0.5565,x:86.1,y:-120.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:85.8,y:-119.15},0).wait(1).to({rotation:-1.2075,x:85.5,y:-117.75},0).wait(1).to({rotation:-1.4141,x:85.3,y:-116.9},0).wait(1).to({rotation:-1.5201,x:85.25,y:-116.45},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:9},0).wait(1).to({regX:86.6,regY:-123,rotation:-1.5305,x:85.2,y:-116.4},0).wait(1).to({rotation:-1.4624,x:85.25,y:-116.7},0).wait(1).to({rotation:-1.3309,x:85.4,y:-117.25},0).wait(1).to({rotation:-1.121,x:85.55,y:-118.2},0).wait(1).to({rotation:-0.8372,x:85.85,y:-119.5},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:86.1,y:-120.8},0).wait(1).to({rotation:-0.2881,x:86.3,y:-121.9},0).wait(1).to({rotation:-0.1291,x:86.4,y:-122.6},0).wait(1).to({rotation:-0.0467,x:86.5,y:-122.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:86.6,regY:-123,rotation:0.1421,x:87.05,y:-122.35},0).wait(1).to({rotation:0.6998,x:89,y:-119.65},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:91.15,y:-116.55},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:86.6,regY:-123,rotation:1.4399,x:91.5,y:-116},0).wait(1).to({rotation:1.2196,x:90.7,y:-117.1},0).wait(1).to({rotation:0.7884,x:89.3,y:-119.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:87.6,y:-121.5},0).wait(1).to({rotation:0.0482,x:86.7,y:-122.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:86.6,regY:-123,rotation:0.0865,x:86.9,y:-122.6},0).wait(1).to({rotation:0.4213,x:88.05,y:-120.95},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:90.05,y:-118.15},0).wait(1).to({rotation:1.3945,x:91.4,y:-116.2},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:86.6,regY:-123,rotation:1.4399,x:91.5,y:-116},0).wait(1).to({rotation:1.2196,x:90.7,y:-117.1},0).wait(1).to({rotation:0.7884,x:89.3,y:-119.2},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:87.6,y:-121.5},0).wait(1).to({rotation:0.0482,x:86.7,y:-122.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-131.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-132.2},0).wait(1).to({y:-129.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:86.6,regY:-123,x:83.85,y:-115.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:86.6,regY:-123,x:86.6,y:-110.75},0).wait(1).to({y:-113.7},0).wait(1).to({y:-118.65},0).wait(1).to({y:-122.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-122},0).wait(1).to({y:-116.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:86.6,regY:-123,x:86.6,y:-115.2},0).wait(1).to({y:-119.5},0).wait(1).to({y:-123.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-123.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.6,regY:-123,x:86.6,y:-129.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-129.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-131.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-132.2},0).wait(1).to({y:-129.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:86.6,regY:-123,x:83.85,y:-115.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:86.6,regY:-123,x:86.6,y:-112.25},0).wait(1).to({y:-120},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-124},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-123.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-122.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.6,regY:-123,x:86.6,y:-122.4},0).wait(1).to({y:-120},0).wait(1).to({y:-117.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-117.6},0).wait(1).to({y:-117.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:86.6,regY:-123,x:86.6,y:-118.4},0).wait(1).to({y:-119.9},0).wait(1).to({y:-122.15},0).wait(1).to({y:-123.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-123.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-130.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-132.2},0).wait(1).to({y:-129.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:86.6,regY:-123,x:86.6,y:-130.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:86.6,regY:-123,x:86.6,y:-131},0).wait(1).to({y:-125},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:86.6,regY:-123,x:86.6,y:-118.35},0).wait(1).to({y:-119.55},0).wait(1).to({y:-121.5},0).wait(1).to({y:-122.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-127.95},0).wait(1).to({y:-122.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-127.95},0).wait(1).to({y:-122.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:86.6,regY:-123,x:86.6,y:-122.1},0).wait(1).to({y:-122.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:86.6,regY:-123,x:89.6,y:-119.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:86.6,regY:-123,x:85.75,y:-113.55},0).wait(1).to({x:86.4,y:-113.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:86.6,regY:-123,x:86.6,y:-113.7},0).wait(1).to({y:-116.15},0).wait(1).to({y:-119.85},0).wait(1).to({y:-122.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-456.9,-680.4,957.8,922.3);
...
// stage content:
(lib._459_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:213,scene2:214,end2:406,scene3:407,end3:583,scene4:584,end4:749,scene5:750,end5:942,scene6:943,end6:1131,scene7:1132,end7:1291});
	...
	this.frame_30 = function() {
		exportRoot._g.m1 = "なぁ､ﾌﾟﾛﾃﾞｭｰｻｰはん……";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_1144 = function() {
		exportRoot._g.m1 = "あんな､ﾌﾟﾛﾃﾞｭｰｻｰはん｡";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(15).call(this.frame_30).wait(28).call(this.frame_58).wait(12).call(this.frame_70).wait(39).call(this.frame_109).wait(17).call(this.frame_126).wait(59).call(this.frame_185).wait(28).call(this.frame_213).wait(1).call(this.frame_214).wait(20).call(this.frame_234).wait(36).call(this.frame_270).wait(19).call(this.frame_289).wait(23).call(this.frame_312).wait(26).call(this.frame_338).wait(41).call(this.frame_379).wait(27).call(this.frame_406).wait(1).call(this.frame_407).wait(22).call(this.frame_429).wait(35).call(this.frame_464).wait(60).call(this.frame_524).wait(26).call(this.frame_550).wait(33).call(this.frame_583).wait(1).call(this.frame_584).wait(18).call(this.frame_602).wait(47).call(this.frame_649).wait(38).call(this.frame_687).wait(38).call(this.frame_725).wait(24).call(this.frame_749).wait(1).call(this.frame_750).wait(16).call(this.frame_766).wait(27).call(this.frame_793).wait(33).call(this.frame_826).wait(14).call(this.frame_840).wait(18).call(this.frame_858).wait(28).call(this.frame_886).wait(26).call(this.frame_912).wait(8).call(this.frame_920).wait(8).call(this.frame_928).wait(14).call(this.frame_942).wait(1).call(this.frame_943).wait(30).call(this.frame_973).wait(25).call(this.frame_998).wait(25).call(this.frame_1023).wait(27).call(this.frame_1050).wait(11).call(this.frame_1061).wait(9).call(this.frame_1070).wait(20).call(this.frame_1090).wait(17).call(this.frame_1107).wait(24).call(this.frame_1131).wait(1).call(this.frame_1132).wait(12).call(this.frame_1144).wait(25).call(this.frame_1169).wait(30).call(this.frame_1199).wait(22).call(this.frame_1221).wait(22).call(this.frame_1243).wait(20).call(this.frame_1263).wait(28).call(this.frame_1291).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1296));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1291).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1296));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1277));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1281));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1290));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(1206).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1243).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.3},0).wait(1).to({y:377.45},0).wait(1).to({y:371.8},0).wait(1).to({y:362.8},0).wait(1).to({y:352.5},0).wait(1).to({y:344.9},0).wait(1).to({y:341.05},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(42));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1243).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1243).to({_off:false},0).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.ranko_finish_blur).wait(1243).to({_off:false},0).wait(1).to({regX:120,regY:155,x:120,y:155,alpha:0.8481},0).wait(1).to({alpha:0.837},0).wait(1).to({alpha:0.8173},0).wait(1).to({alpha:0.7876},0).wait(1).to({alpha:0.7468},0).wait(1).to({alpha:0.6931},0).wait(1).to({alpha:0.6255},0).wait(1).to({alpha:0.5435},0).wait(1).to({alpha:0.4487},0).wait(1).to({alpha:0.3463},0).wait(1).to({alpha:0.2464},0).wait(1).to({alpha:0.1607},0).wait(1).to({alpha:0.0982},0).wait(1).to({alpha:0.0621},0).wait(1).to({regX:0,regY:0,x:0,y:0,alpha:0.0508},0).to({_off:true},1).wait(37));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1243).to({_off:false},0).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1231).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(750).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(374).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(156));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(16).to({regX:1,x:121,y:-3.05},0).wait(1).to({y:-6.2},0).wait(1).to({y:-11.4},0).wait(1).to({y:-18.4},0).wait(1).to({y:-27},0).wait(1).to({y:-36.95},0).wait(1).to({y:-47.85},0).wait(1).to({y:-59.3},0).wait(1).to({y:-70.8},0).wait(1).to({y:-81.9},0).wait(1).to({y:-92},0).wait(1).to({y:-100.65},0).wait(1).to({y:-107.25},0).wait(1).to({y:-111.5},0).wait(1).to({regX:0,x:120,y:-113},0).wait(80).to({regX:1,x:121,y:-113.7},0).wait(1).to({y:-115.85},0).wait(1).to({y:-119.3},0).wait(1).to({y:-123.9},0).wait(1).to({y:-129.55},0).wait(1).to({y:-136.05},0).wait(1).to({y:-143.2},0).wait(1).to({y:-150.8},0).wait(1).to({y:-158.6},0).wait(1).to({y:-166.4},0).wait(1).to({y:-173.9},0).wait(1).to({y:-180.9},0).wait(1).to({y:-187.1},0).wait(1).to({y:-192.3},0).wait(1).to({y:-196.25},0).wait(1).to({y:-198.75},0).wait(1).to({regX:0,x:120,y:-199.65},0).to({_off:true},1).wait(1169));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(16).to({regX:1,x:121,y:308.4},0).wait(1).to({y:309.6},0).wait(1).to({y:311.55},0).wait(1).to({y:314.2},0).wait(1).to({y:317.45},0).wait(1).to({y:321.2},0).wait(1).to({y:325.35},0).wait(1).to({y:329.65},0).wait(1).to({y:334.05},0).wait(1).to({y:338.2},0).wait(1).to({y:342.05},0).wait(1).to({y:345.3},0).wait(1).to({y:347.8},0).wait(1).to({y:349.4},0).wait(1).to({regX:0,x:120,y:350},0).wait(80).to({regX:1,x:121,y:351.3},0).wait(1).to({y:355.2},0).wait(1).to({y:361.5},0).wait(1).to({y:369.9},0).wait(1).to({y:380.2},0).wait(1).to({y:392},0).wait(1).to({y:405.05},0).wait(1).to({y:418.9},0).wait(1).to({y:433.15},0).wait(1).to({y:447.35},0).wait(1).to({y:461.05},0).wait(1).to({y:473.8},0).wait(1).to({y:485.1},0).wait(1).to({y:494.6},0).wait(1).to({y:501.8},0).wait(1).to({y:506.4},0).wait(1).to({regX:0,x:120,y:508},0).to({_off:true},1).wait(1169));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(584).to({_off:false},0).to({alpha:1},18).to({_off:true},148).wait(546));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(584).to({_off:false},0).to({alpha:0.4492},18).to({_off:true},148).wait(546));

	// book コピー 5
	this.instance_13 = new lib.book_motion();
	this.instance_13.parent = this;
	this.instance_13.setTransform(252.05,311.35,0.8931,0.8931,0,0,0,148.1,175.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({regX:148.2,scaleX:1.4458,scaleY:1.4458,x:245.95,y:206.2},0).to({x:257.3},29).to({regX:148.3,regY:175.2,scaleX:2.3543,scaleY:2.3543,x:479.6,y:623.5},26,cjs.Ease.cubicInOut).wait(39).to({regX:148.1,regY:175.1,scaleX:0.8931,scaleY:0.8931,x:263.75,y:311.35},66,cjs.Ease.quadInOut).wait(39).to({regY:175.2,scaleX:1.1346,scaleY:1.1346,x:299.4,y:354.9},56,cjs.Ease.quadInOut).wait(314).to({regX:148.2,regY:175.3,scaleX:1.6356,scaleY:1.6356,x:367.15,y:487.35},58,cjs.Ease.quadInOut).wait(108).to({regX:148.1,regY:175.2,scaleX:0.9726,scaleY:0.9726,x:263.8,y:322.7},0).wait(193).to({scaleX:1.1346,scaleY:1.1346,x:289,y:354.9},30,cjs.Ease.cubicInOut).wait(159).to({regX:148.2,regY:175.3,scaleX:1.6356,scaleY:1.6356,x:373.15,y:486.35},0).to({_off:true},113).wait(51));

	// ch コピー 5
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(81.3,209.95,0.4465,0.4465,0,0,0,0.4,0.1);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.2,regY:0.3,scaleX:0.7228,scaleY:0.7228,x:-30.65,y:42.15},0).to({x:-19.3},29).to({regX:0.4,regY:0.5,scaleX:1.177,scaleY:1.177,x:29.1,y:356.35},26,cjs.Ease.cubicInOut).wait(39).to({regY:0.1,scaleX:0.4465,scaleY:0.4465,x:93,y:209.95},66,cjs.Ease.quadInOut).wait(39).to({regX:0.5,regY:0.2,scaleX:0.5673,scaleY:0.5673,x:82.5,y:226.05},56,cjs.Ease.quadInOut).wait(314).to({regX:0.6,regY:0.5,scaleX:0.8177,scaleY:0.8177,x:54.35,y:301.75},58,cjs.Ease.quadInOut).wait(108).to({regX:0.4,regY:0.2,scaleX:0.4863,scaleY:0.4863,x:77.8,y:212.25},0).wait(193).to({regX:0.5,scaleX:0.5673,scaleY:0.5673,x:72.1,y:226.05},30,cjs.Ease.cubicInOut).wait(159).to({regX:0.6,regY:0.5,scaleX:0.8177,scaleY:0.8177,x:60.35,y:300.75},0).to({_off:true},113).wait(51));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-12.35,-1.25,0.4465,0.4465,0,0,0,-0.4,0);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.5,regY:-0.2,scaleX:0.7228,scaleY:0.7228,x:-182.05,y:-299.85},0).to({x:-170.7},29).to({regX:-0.7,regY:-0.4,scaleX:1.177,scaleY:1.177,x:-217.5,y:-200.6},26,cjs.Ease.cubicInOut).wait(39).to({regX:-0.4,regY:0,scaleX:0.4465,scaleY:0.4465,x:-0.65,y:-1.25},66,cjs.Ease.quadInOut).wait(39).to({regX:-0.5,regY:-0.2,scaleX:0.5673,scaleY:0.5673,x:-36.45,y:-42.2},56,cjs.Ease.quadInOut).wait(314).to({regX:-0.7,regY:-0.1,scaleX:0.8177,scaleY:0.8177,x:-117.05,y:-85.05},58,cjs.Ease.quadInOut).to({_off:true},108).wait(382).to({_off:false,x:-111.05,y:-86.05},0).to({_off:true},113).wait(51));

	// モブあり
	this.instance_14 = new lib.bg2();
	this.instance_14.parent = this;
	this.instance_14.setTransform(119.9,155.05,0.4465,0.4465,0,0,0,295.7,350);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},15).wait(735).to({_off:false,regY:349.9,scaleX:0.4863,scaleY:0.4863,x:119.95,y:152.45},0).wait(193).to({scaleX:0.5673,scaleY:0.5673,x:121.2,y:156.4},30,cjs.Ease.cubicInOut).to({_off:true},159).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},1233).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1245).wait(46).to({_off:false},0).wait(5));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg_1.jpg", id:"_459_2_bg_1"},
		{src:"images/bg_2.jpg", id:"_459_2_bg_2"},
		{src:"images/book.png", id:"_459_2_book"},
		{src:"images/ch_base.png", id:"_459_2_ch_base"},
		{src:"images/ch_face1.png", id:"_459_2_ch_face1"},
		{src:"images/ch_face2.png", id:"_459_2_ch_face2"},
		{src:"images/ch_face3.png", id:"_459_2_ch_face3"},
		{src:"images/ch_face4.png", id:"_459_2_ch_face4"},
		{src:"images/ch_face6.png", id:"_459_2_ch_face6"},
		{src:"images/finish.jpg", id:"_459_2_finish"},
		{src:"images/finish_blur.jpg", id:"_459_2_finish_blur"},
		{src:"images/mist.png", id:"_459_2_mist"},
		{src:"images/shine.png", id:"_459_2_shine"},
		{src:"images/shine_sub.png", id:"_459_2_shine_sub"},
		{src:"images/tie_fp.png", id:"_459_2_tie_fp"},
		{src:"images/tie_sp.png", id:"_459_2_tie_sp"}
	],
	preloads: []
};
