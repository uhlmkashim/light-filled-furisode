...
window.im_cjs.t[1][1] = "와…… 예뻐……. 정말로,";
window.im_cjs.t[1][2] = "이렇게 멋진 경치야…….";
...
window.im_cjs.t[5][2] = "점점 높은 곳에 와 있는";
window.im_cjs.t[5][3] = "거네요~. 말로 할 수 없을 정도로";
window.im_cjs.t[5][4] = "아름다운 곳에……♪";

window.im_cjs.t[6][1] = "그건, 제가 보통 여자애인";
window.im_cjs.t[6][2] = "채로는 할 수 없는 일이니까요!";
window.im_cjs.t[6][3] = "프로듀서 씨의 힘으로 특별한";
window.im_cjs.t[6][4] = "체험을 하고 있어요.";

window.im_cjs.t[7][1] = "어라? 저, 이상한 말을";
window.im_cjs.t[7][2] = "했나요? 그래도, 제대로 말로";
window.im_cjs.t[7][3] = "하고 싶으니까요! 프로듀서 씨,";
window.im_cjs.t[7][4] = "언제나 감사합니다♪";
