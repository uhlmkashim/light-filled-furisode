...
(lib.bg = function() {
	this.initialize(img._401_3_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1148,1400);


(lib.ch_base = function() {
	this.initialize(img._401_3_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1148,1400);


(lib.ch_face2 = function() {
	this.initialize(img._401_3_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,272);


(lib.ch_face3 = function() {
	this.initialize(img._401_3_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,272);


(lib.ch_face4 = function() {
	this.initialize(img._401_3_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,272);


(lib.ch_face6 = function() {
	this.initialize(img._401_3_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,272);


(lib.ch_face7 = function() {
	this.initialize(img._401_3_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,272);


(lib.ch_face8 = function() {
	this.initialize(img._401_3_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,272);


(lib.ch_face9 = function() {
	this.initialize(img._401_3_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,280,272);


(lib.cut_1 = function() {
	this.initialize(img._401_3_cut_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1024,740);


(lib.finish = function() {
	this.initialize(img._401_3_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._401_3_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.first_scene = function() {
	this.initialize(img._401_3_first_scene);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.glitter = function() {
	this.initialize(img._401_3_glitter);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,40,40);


(lib.leef_a = function() {
	this.initialize(img._401_3_leef_a);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,144,92);


(lib.leef_b = function() {
	this.initialize(img._401_3_leef_b);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,144,136);


(lib.leef_d = function() {
	this.initialize(img._401_3_leef_d);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,88,152);


(lib.leef_e = function() {
	this.initialize(img._401_3_leef_e);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,140,68);


(lib.leef_f = function() {
	this.initialize(img._401_3_leef_f);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,52,160);


(lib.leef_g = function() {
	this.initialize(img._401_3_leef_g);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,140,64);


(lib.leef_l = function() {
	this.initialize(img._401_3_leef_l);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,80,140);


(lib.sun_light = function() {
	this.initialize(img._401_3_sun_light);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,48,284);


(lib.tie_fp = function() {
	this.initialize(img._401_3_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._401_3_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
(lib.cut_1_part = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// レイヤー_1
	this.instance = new lib.cut_1();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.cut_1_part, new cjs.Rectangle(0,0,512,370), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,140,136), null);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(32,0.65);
	...
	this.shape_1.setTransform(16.025,0.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("AAUA5IgUgPIgWgOIgSgMQgHgEgEgGQgDgEAAgFQAAgEADgFQADgDAGgFIAQgKIAWgNIAVgQQALgHAHgGIAOAOIgUAOIgWANIgSALIgQAKIgGAEQAAAAgBABQAAAAAAABQgBAAAAABQAAAAAAAAIACADIAFADIAUAMIAVAPIAWAPIAUAOIgRAOIgSgQg");
	this.shape_2.setTransform(-0.175,0.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(-16,0.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("");
...
(lib.cut_1_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{start_1:1,start_2:23});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(1).call(this.frame_1).wait(21).call(this.frame_22).wait(1).call(this.frame_23).wait(3).call(this.frame_26).wait(1));

	// glitter
	this.instance = new lib.glitter_common_parts1();
	this.instance.parent = this;
	this.instance.setTransform(280.2,93.6,0.2,0.2,0,0,0,-0.3,0);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(26));

	// glitter
	this.instance_1 = new lib.glitter_common_parts1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(431.1,66.6,0.15,0.15,0,0,0,-0.4,-0.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(4).to({_off:false},0).wait(23));

	// glitter
	this.instance_2 = new lib.glitter_common_parts1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(501.95,93.1,0.13,0.13,0,0,0,-0.8,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off:false},0).wait(20));

	// glitter
	this.instance_3 = new lib.glitter_common_parts1();
	this.instance_3.parent = this;
	this.instance_3.setTransform(331.25,92.7,0.07,0.07,0,0,0,-0.7,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({_off:false},0).wait(18));

	// glitter
	this.instance_4 = new lib.glitter_common_parts1();
	this.instance_4.parent = this;
	this.instance_4.setTransform(324.35,135.75,0.0982,0.0982,0,0,0,-1,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({_off:false},0).wait(15));

	// glitter
	this.instance_5 = new lib.glitter_common_parts1();
	this.instance_5.parent = this;
	this.instance_5.setTransform(398.9,91.65,0.1048,0.1048,0,0,0,-1,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).wait(14));

	// glitter
	this.instance_6 = new lib.glitter_common_parts1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(300.1,67.95,0.1048,0.1048,0,0,0,-1,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(15).to({_off:false},0).wait(12));

	// glitter
	this.instance_7 = new lib.glitter_common_parts1();
	this.instance_7.parent = this;
	this.instance_7.setTransform(469.15,130.6,0.077,0.077,0,0,0,-1.3,0);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(17).to({_off:false},0).wait(10));

	// glitter
	this.instance_8 = new lib.glitter_common_parts1();
	this.instance_8.parent = this;
	this.instance_8.setTransform(447.05,80.95,0.0766,0.0766,0,0,0,-1.9,0);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(18).to({_off:false},0).wait(9));

	// glitter
	this.instance_9 = new lib.glitter_common_parts1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(20.15,207.25,0.2,0.2,0,0,0,-0.3,0);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(1).to({_off:false},0).wait(26));

	// glitter
	this.instance_10 = new lib.glitter_common_parts1();
	this.instance_10.parent = this;
	this.instance_10.setTransform(197.65,97.6,0.15,0.15,0,0,0,-0.4,-0.4);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(4).to({_off:false},0).wait(23));

	// glitter
	this.instance_11 = new lib.glitter_common_parts1();
	this.instance_11.parent = this;
	this.instance_11.setTransform(237.85,153.6,0.13,0.13,0,0,0,-0.8,0);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(7).to({_off:false},0).wait(20));

	// glitter
	this.instance_12 = new lib.glitter_common_parts1();
	this.instance_12.parent = this;
	this.instance_12.setTransform(59.25,140.7,0.07,0.07,0,0,0,-0.7,0);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(9).to({_off:false},0).wait(18));

	// glitter
	this.instance_13 = new lib.glitter_common_parts1();
	this.instance_13.parent = this;
	this.instance_13.setTransform(112.05,252.1,0.0982,0.0982,0,0,0,-1,0);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(12).to({_off:false},0).wait(15));

	// glitter
	this.instance_14 = new lib.glitter_common_parts1();
	this.instance_14.parent = this;
	this.instance_14.setTransform(112.25,173.75,0.1048,0.1048,0,0,0,-1,0);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(13).to({_off:false},0).wait(14));

	// glitter
	this.instance_15 = new lib.glitter_common_parts1();
	this.instance_15.parent = this;
	this.instance_15.setTransform(100.4,96.35,0.1048,0.1048,0,0,0,-1,0);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(15).to({_off:false},0).wait(12));

	// glitter
	this.instance_16 = new lib.glitter_common_parts1();
	this.instance_16.parent = this;
	this.instance_16.setTransform(204.25,203.65,0.077,0.077,0,0,0,-1.3,0);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(17).to({_off:false},0).wait(10));

	// glitter
	this.instance_17 = new lib.glitter_common_parts1();
	this.instance_17.parent = this;
	this.instance_17.setTransform(175.05,128.95,0.0766,0.0766,0,0,0,-1.9,0);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(18).to({_off:false},0).wait(9));

	// cut_1_part
	this.instance_18 = new lib.cut_1_part();
	this.instance_18.parent = this;
	this.instance_18.setTransform(256,185,1,1,0,0,0,256,185);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(27));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,512,370);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("AqxKeIAA07IVjAAIAAU7g");
	mask.setTransform(70,68);
...
p.nominalBounds = new cjs.Rectangle(1,1,138,134);
...
(lib.window = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
...
(lib.glitters = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(64.95,232.25,0.0766,0.0766);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(32.45,212.2,0.1958,0.1958);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(228.85,198.3,0.1412,0.1412);
	this.instance_2._off = true;
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(235.15,93.05,0.159,0.159,0,0,0,-1.3,2.9);
	this.instance_3._off = true;
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(227.2,55.5,0.0849,0.0849);
	this.instance_4._off = true;
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(98.3,35.1,0.1362,0.1362);
	this.instance_6._off = true;
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(12.1,178.15,0.1106,0.1106);
	this.instance_7._off = true;
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(159.55,260.1,0.1702,0.1702);
	this.instance_8._off = true;
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(196.5,34.05,0.2555,0.2555);
	this.instance_9._off = true;
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AHVEvIguADIg3gIIg9gTIhYgqIgtggIhYgqIkFg2IhjABIh+gMIg3gPIgvgXIiphqIAAh/IBlgyQBrg1gBACICAgtICogDIA8AZIBFCQIDzBNIB9hlIA8APIAwAdIBQBFIApA5IAeB2IALBlIA4AyIARAeIgGAfg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:68.275,y:52.05}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:70,regY:68,x:70,y:68,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:70,regY:68,x:70,y:68,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:70,regY:68,x:70,y:68,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:70,regY:68,x:70,y:68,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-202,-216,574,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-156,-154);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-276,-550,586.2,700);
...
(lib.leef_1_move_set = function(mode,startPosition,loop) {
	...
	// glass4
	this.instance_2 = new lib.leef_1_move_pattern();
	this.instance_2.parent = this;
...
p.nominalBounds = new cjs.Rectangle(0,-213.9,899.5,579);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.leef_1).to({_off:true},547).wait(20));

	// blue_light_move
	this.instance = new lib.blue_light_move();
	this.instance.parent = this;
	this.instance.setTransform(-159.85,-421.15,1,1,0,0,180,364.7,391.2);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-456.15,-667.8,1.5911,1.9152,0,0.6031,-4.4861,-42.3,-92.5);
	this.instance_1.alpha = 0.1484;
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(567));

	// effect2
	this.instance_2 = new lib.drop1_v2("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-57.7,-366.4,1.1645,1.1645);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-83.3,y:-375.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.95,y:-379.7,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-57.7,y:-366.4,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-83.3,y:-375.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.95,y:-379.7,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-57.7,y:-366.4,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-83.3,y:-375.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.95,y:-379.7,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-57.7,y:-366.4,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-83.3,y:-375.4,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-94.95,y:-379.7,alpha:0.2188},0).to({_off:true},1).wait(235));

	// effect
	this.instance_3 = new lib.spread_flower_pink("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(-6,-284,1.4808,1.4808);

	this.instance_4 = new lib.good_effect("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-6,-284,1.481,1.481);

	this.instance_5 = new lib.notice();
	this.instance_5.parent = this;
	this.instance_5.setTransform(-113.55,-367.35,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_5._off = true;

	this.instance_6 = new lib.laugh("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-119.4,-364.2,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_6._off = true;

	this.instance_7 = new lib.chord("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(-68.35,-274.65,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_8 = new lib.question();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-79.5,-327.75,1.053,1.053,-28.4906);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.instance_9 = new lib.mc_exclamation("synched",0,false);
	this.instance_9.parent = this;
	this.instance_9.setTransform(-84.9,-347.7,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_10 = new lib.drop1a("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-65.75,-355.35,1,1,0,0,0,-0.5,0.2);
	this.instance_10._off = true;

	this.instance_11 = new lib.drop2_v2("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-59.5,-356.65,0.9876,0.9876,14.9998);
	this.instance_11._off = true;

	this.instance_12 = new lib.shock("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(-113.2,-338.25,1.3878,1.3878,-121.2396);

	this.instance_13 = new lib.sigh("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-31.9,-215.35);
	this.instance_13.alpha = 0.6016;
	this.instance_13._off = true;

	this.instance_14 = new lib.heart("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(-68.4,-336.5,0.4532,0.4532);
	this.instance_14._off = true;

	this.instance_15 = new lib.angry("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(59.05,-325.1,0.5276,0.5276);
	this.instance_15._off = true;

	this.instance_16 = new lib.mc_punpun();
	this.instance_16.parent = this;
	this.instance_16.setTransform(-40.5,-384.75,1.1377,1.1377);

	this.instance_17 = new lib.concent_wrapper("synched",0,false);
	this.instance_17.parent = this;
	this.instance_17.setTransform(-2.75,-283.3,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3}]},37).to({state:[{t:this.instance_4}]},10).to({state:[]},10).to({state:[{t:this.instance_5}]},76).to({state:[]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},2).to({state:[]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},15).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},20).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},2).to({state:[{t:this.instance_8}]},7).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},6).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},2).to({state:[{t:this.instance_8}]},2).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_10}]},16).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},9).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},24).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},5).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},11).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},2).to({state:[{t:this.instance_14}]},3).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[]},1).to({state:[{t:this.instance_15}]},6).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_15}]},5).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_15}]},1).to({state:[]},1).to({state:[{t:this.instance_16}]},2).to({state:[]},12).to({state:[{t:this.instance_17}]},17).to({state:[{t:this.instance_6}]},9).to({state:[{t:this.instance_6}]},15).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},2).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},9).to({state:[{t:this.instance_6}]},15).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},15).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},20).wait(21));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-113.15,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-113.55,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-113.15,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-113.55,alpha:0},0).to({_off:true},1).wait(304).to({_off:false,regY:20.6,scaleX:0.8957,scaleY:0.8957,skewX:-169.8313,skewY:10.1687,x:-138.35,y:-210.75,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-138.05,y:-210.55,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.6,x:-138.35,y:-210.75,alpha:0},0).to({_off:true},1).wait(92));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-121.9,y:-363.35,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-119.4,y:-364.2,alpha:0,startPosition:19},0).to({_off:true},1).wait(262).to({_off:false,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-121.9,y:-363.35,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-119.4,y:-364.2,alpha:0,startPosition:19},0).to({_off:true},1).wait(22).to({_off:false,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-121.9,y:-363.35,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-119.4,y:-364.2,alpha:0,startPosition:19},0).to({_off:true},1).wait(1).to({_off:false,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-121.9,y:-363.35,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-119.4,y:-364.2,alpha:0,startPosition:19},0).to({_off:true},1).wait(42));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-86.45,y:-341.15,alpha:0.5556},0).wait(1).to({x:-90.55,y:-349.4,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-91.85,y:-352.45,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-91.6,y:-351.5},0).wait(1).to({x:-90.6,y:-349.65},0).wait(1).to({x:-88.9,y:-346.5},0).wait(1).to({regX:0,regY:0,x:-86.45,y:-342.45},0).to({x:-87.2,y:-343.8},2).wait(8).to({regX:-0.2,regY:0.2,x:-86.95,y:-342.9,alpha:0.9298},0).wait(1).to({x:-85.9,y:-340.95,alpha:0.692},0).wait(1).to({x:-84.3,y:-338.05,alpha:0.339},0).wait(1).to({x:-83.15,y:-335.9,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-82.7,y:-335.6,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-79.95,y:-327.35},0).wait(1).to({regX:-0.2,regY:0.2,x:-86.9,y:-340.75,alpha:0.5556},0).wait(1).to({x:-91,y:-349,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-92.3,y:-352.05,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-92.05,y:-351.1},0).wait(1).to({x:-91.05,y:-349.25},0).wait(1).to({x:-89.35,y:-346.1},0).wait(1).to({regX:0,regY:0,x:-86.9,y:-342.05},0).to({x:-87.65,y:-343.4},2).wait(3).to({regX:-0.2,regY:0.2,x:-87.4,y:-342.5,alpha:0.9298},0).wait(1).to({x:-86.35,y:-340.55,alpha:0.692},0).wait(1).to({x:-84.75,y:-337.65,alpha:0.339},0).wait(1).to({x:-83.6,y:-335.5,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-83.15,y:-335.2,alpha:0},0).to({_off:true},1).wait(320));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:-64.75,y:-351.65},0).wait(1).to({y:-347.8},0).wait(1).to({y:-344.55},0).wait(1).to({y:-341.9},0).wait(1).to({y:-339.8},0).wait(1).to({y:-338.3},0).wait(1).to({y:-337.4},0).wait(1).to({regX:-0.5,regY:0.2,x:-65.75,y:-336.35},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:-64.75,y:-337.15,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:-65.75,y:-336.35,alpha:0},0).to({_off:true},1).wait(278));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.925,y:-352.0375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-101.4,y:-350.5,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-59.5,y:-356.65,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.925,y:-356.425,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-101.4,y:-356.35,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-59.5,y:-356.65,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.925,y:-352.0375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-101.4,y:-350.5,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-59.5,y:-356.65,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-90.925,y:-356.425,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-101.4,y:-356.35,alpha:0.2188},0).to({_off:true},1).wait(235));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(351).to({_off:false},0).wait(1).to({x:-32.9,y:-214.35,alpha:1},0).wait(1).to({regX:0.9,x:-33,y:-213.4,alpha:0.8965},0).wait(1).to({x:-34.35,y:-212.2,alpha:0.7636},0).wait(1).to({x:-35.95,y:-210.75,alpha:0.6048},0).wait(1).to({x:-37.75,y:-209.15,alpha:0.4229},0).wait(1).to({x:-39.75,y:-207.3,alpha:0.2205},0).wait(1).to({regX:0,x:-42.9,y:-205.35,alpha:0},0).to({_off:true},1).wait(208));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-70.15,y:-350.65},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-73.4,y:-356.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-70.85,y:-354.35},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-70.3,y:-351.1},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-71.4,y:-346.5},0).to({scaleX:1,scaleY:1,x:-72.4,y:-350.5},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-69.8,y:-349.5,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-71.4,y:-350.25,alpha:0.1016},0).to({_off:true},1).wait(184));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-328.85},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-330.1},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(165));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:11,regY:-200,x:11,y:-202.5},0).wait(1).to({regX:0,regY:0,x:0,y:-3},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.65},0).wait(1).to({y:-201.6},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.5},0).wait(1).to({regX:0,regY:0,x:0,y:-4},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.5},0).wait(1).to({y:-197.9},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:11,regY:-200,x:11,y:-196.75},0).wait(1).to({y:-199.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-5},0).wait(1).to({regX:11,regY:-200,x:11,y:-203.35},0).wait(1).to({y:-198.65},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-5},0).wait(1).to({regX:11,regY:-200,x:11,y:-203.55},0).wait(1).to({y:-199.45},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:11,regY:-200,x:11,y:-199.4},0).wait(1).to({y:-199.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.25},0).wait(1).to({regX:0,regY:0,x:0,y:-5},0).wait(1).to({regX:11,regY:-200,x:11,y:-204.5},0).wait(1).to({y:-202.8},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-200,x:11,y:-198},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-200,x:11,y:-200.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.25},0).wait(1).to({regX:0,regY:0,x:0,y:-5},0).wait(1).to({regX:11,regY:-200,x:11,y:-204.5},0).wait(1).to({y:-202.8},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-200,x:11,y:-198},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-200,x:11,y:-200.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-200,x:11,y:-199.7},0).wait(1).to({y:-198.5},0).wait(1).to({y:-197.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-200,x:11,y:-197.35},0).wait(1).to({y:-198.5},0).wait(1).to({y:-199.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-200,x:11,y:-199.95},0).wait(1).to({y:-199.6},0).wait(1).to({y:-198.95},0).wait(1).to({y:-198.1},0).wait(1).to({y:-197.45},0).wait(1).to({y:-197.1},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-200,x:11,y:-197.1},0).wait(1).to({y:-197.45},0).wait(1).to({y:-198.1},0).wait(1).to({y:-198.95},0).wait(1).to({y:-199.6},0).wait(1).to({y:-199.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:4},2).wait(1).to({regX:11,regY:-200,x:11,y:-196.85},0).wait(1).to({y:-199.2},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:2},2).wait(1).to({regX:11,regY:-200,x:11,y:-199.3},0).wait(1).to({y:-199.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-200,scaleX:1.0002,scaleY:1.0002,rotation:-0.0124,x:10.95,y:-200.05},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0556,x:10.85,y:-200.1},0).wait(1).to({scaleX:1.0018,scaleY:1.0018,rotation:-0.14,x:10.65,y:-200.2},0).wait(1).to({scaleX:1.0035,scaleY:1.0035,rotation:-0.2738,x:10.45,y:-200.4},0).wait(1).to({scaleX:1.0057,scaleY:1.0057,rotation:-0.4418,x:10.1,y:-200.6},0).wait(1).to({scaleX:1.0076,scaleY:1.0076,rotation:-0.5941,x:9.8,y:-200.75},0).wait(1).to({scaleX:1.0089,scaleY:1.0089,rotation:-0.6957,x:9.6,y:-200.9},0).wait(1).to({scaleX:1.0096,scaleY:1.0096,rotation:-0.7479,x:9.45,y:-201},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.0098,scaleY:1.0098,rotation:-0.7628,x:1,y:1.1},0).wait(1).to({regX:11,regY:-200,scaleX:1.0096,scaleY:1.0096,rotation:-0.7531,x:9.3,y:-201.1},0).wait(1).to({scaleX:1.0092,scaleY:1.0092,rotation:-0.7201,x:9.35,y:-201.05},0).wait(1).to({scaleX:1.0084,scaleY:1.0084,rotation:-0.6564,x:9.5,y:-201},0).wait(1).to({scaleX:1.007,scaleY:1.007,rotation:-0.5548,x:9.75,y:-200.85},0).wait(1).to({scaleX:1.0052,scaleY:1.0052,rotation:-0.4173,x:10,y:-200.7},0).wait(1).to({scaleX:1.0033,scaleY:1.0033,rotation:-0.2704,x:10.3,y:-200.45},0).wait(1).to({scaleX:1.0017,scaleY:1.0017,rotation:-0.1513,x:10.45,y:-200.35},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0742,x:10.7,y:-200.15},0).wait(1).to({scaleX:1.0001,scaleY:1.0001,rotation:-0.0343,x:10.8,y:-200.05},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-200,scaleX:1.0002,scaleY:1.0002,rotation:-0.0124,x:10.95,y:-200.05},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0556,x:10.85,y:-200.1},0).wait(1).to({scaleX:1.0018,scaleY:1.0018,rotation:-0.14,x:10.65,y:-200.2},0).wait(1).to({scaleX:1.0035,scaleY:1.0035,rotation:-0.2738,x:10.45,y:-200.4},0).wait(1).to({scaleX:1.0057,scaleY:1.0057,rotation:-0.4418,x:10.1,y:-200.6},0).wait(1).to({scaleX:1.0076,scaleY:1.0076,rotation:-0.5941,x:9.8,y:-200.75},0).wait(1).to({scaleX:1.0089,scaleY:1.0089,rotation:-0.6957,x:9.6,y:-200.9},0).wait(1).to({scaleX:1.0096,scaleY:1.0096,rotation:-0.7479,x:9.45,y:-201},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.0098,scaleY:1.0098,rotation:-0.7628,x:1,y:1.1},0).wait(1).to({regX:11,regY:-200,scaleX:1.0096,scaleY:1.0096,rotation:-0.7528,x:9.3,y:-201.1},0).wait(1).to({scaleX:1.0092,scaleY:1.0092,rotation:-0.7188,x:9.35,y:-201.05},0).wait(1).to({scaleX:1.0084,scaleY:1.0084,rotation:-0.6532,x:9.5,y:-201},0).wait(1).to({scaleX:1.007,scaleY:1.007,rotation:-0.5484,x:9.75,y:-200.85},0).wait(1).to({scaleX:1.0052,scaleY:1.0052,rotation:-0.4067,x:10,y:-200.7},0).wait(1).to({scaleX:1.0033,scaleY:1.0033,rotation:-0.2553,x:10.35,y:-200.45},0).wait(1).to({scaleX:1.0017,scaleY:1.0017,rotation:-0.1325,x:10.55,y:-200.35},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0531,x:10.75,y:-200.15},0).wait(1).to({scaleX:1.0002,scaleY:1.0002,rotation:-0.0119,x:10.85,y:-200.1},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:0,x:0,y:0},0).wait(16).to({regX:11,regY:-200,x:11,y:-202.75},0).wait(1).to({y:-203.7},0).wait(1).to({regX:0,regY:0,x:0,y:-4},0).wait(1).to({regX:11,regY:-200,x:11,y:-203.6},0).wait(1).to({y:-202.35},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:11,regY:-200,x:11,y:-203.35},0).wait(1).to({regX:0,regY:0,x:0,y:-4},0).wait(1).to({regX:11,regY:-200,x:11,y:-203.55},0).wait(1).to({y:-202.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:11,regY:-200,scaleX:1.0002,scaleY:1.0002,rotation:-0.0163,x:10.95,y:-200.05},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0728,x:10.7,y:-200.1},0).wait(1).to({scaleX:1.0018,scaleY:1.0018,rotation:-0.1835,x:10.15,y:-200.25},0).wait(1).to({scaleX:1.0036,scaleY:1.0036,rotation:-0.3589,x:9.4,y:-200.4},0).wait(1).to({scaleX:1.0058,scaleY:1.0058,rotation:-0.5791,x:8.3,y:-200.65},0).wait(1).to({scaleX:1.0077,scaleY:1.0077,rotation:-0.7788,x:7.4,y:-200.85},0).wait(1).to({scaleX:1.009,scaleY:1.009,rotation:-0.912,x:6.8,y:-201.05},0).wait(1).to({scaleX:1.0097,scaleY:1.0097,rotation:-0.9804,x:6.45,y:-201.1},0).wait(1).to({regX:0,regY:0,scaleX:1.0099,scaleY:1.0099,rotation:-0.9999,x:-1.25,y:1},0).wait(1).to({regX:11,regY:-200,scaleX:1.0098,scaleY:1.0098,rotation:-0.9871,x:6.4,y:-201.15},0).wait(1).to({scaleX:1.0093,scaleY:1.0093,rotation:-0.9436,x:6.65},0).wait(1).to({scaleX:1.0085,scaleY:1.0085,rotation:-0.8595,x:7.05,y:-201},0).wait(1).to({scaleX:1.0071,scaleY:1.0071,rotation:-0.7252,x:7.7,y:-200.85},0).wait(1).to({scaleX:1.0053,scaleY:1.0053,rotation:-0.5437,x:8.5,y:-200.65},0).wait(1).to({scaleX:1.0033,scaleY:1.0033,rotation:-0.3497,x:9.45,y:-200.4},0).wait(1).to({scaleX:1.0017,scaleY:1.0017,rotation:-0.1925,x:10.15,y:-200.3},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0907,x:10.65,y:-200.15},0).wait(1).to({scaleX:1.0001,scaleY:1.0001,rotation:-0.038,x:10.85,y:-200},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-200,rotation:-0.147,x:10.65,y:-199.6},0).wait(1).to({rotation:-0.7239,x:9.4,y:-197.8},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3727,x:7.95,y:-195.75},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(18).to({regX:11,regY:-200,rotation:-1.4913,x:7.7,y:-195.4},0).wait(1).to({rotation:-1.2701,x:8.15,y:-196.15},0).wait(1).to({rotation:-0.8372,x:9.15,y:-197.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:10.15,y:-198.95},0).wait(1).to({rotation:-0.094,x:10.7,y:-199.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-200,rotation:-0.0894,x:10.8,y:-199.75},0).wait(1).to({rotation:-0.4358,x:10.05,y:-198.7},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.0316,x:8.7,y:-196.85},0).wait(1).to({rotation:-1.4426,x:7.8,y:-195.55},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:2,y:5},0).wait(8).to({regX:11,regY:-200,rotation:-1.4913,x:7.7,y:-195.4},0).wait(1).to({rotation:-1.2701,x:8.15,y:-196.15},0).wait(1).to({rotation:-0.8372,x:9.15,y:-197.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3606,x:10.15,y:-198.95},0).wait(1).to({rotation:-0.094,x:10.7,y:-199.8},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:11,regY:-200,x:11,y:-208.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-200,x:11,y:-209.2},0).wait(1).to({y:-206.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:11,regY:-200,x:8.25,y:-192.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:11,regY:-200,x:11,y:-187.75},0).wait(1).to({y:-190.7},0).wait(1).to({y:-195.65},0).wait(1).to({y:-199.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:11,regY:-200,x:11,y:-199},0).wait(1).to({y:-193.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:11,regY:-200,x:11,y:-192.2},0).wait(1).to({y:-196.5},0).wait(1).to({y:-200.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:11,regY:-200,x:11,y:-200.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-200,x:11,y:-201.65},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:11,regY:-200,x:11,y:-201.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.5},0).wait(1).to({regX:0,regY:0,x:0,y:-3},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.6},0).wait(1).to({y:-201.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:11,regY:-200,x:8.25,y:-192.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:11,regY:-200,x:11,y:-189.25},0).wait(1).to({y:-197},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:11,regY:-200,x:11,y:-201},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:11,regY:-200,x:11,y:-200.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:11,regY:-200,x:11,y:-199.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-200,x:11,y:-199.4},0).wait(1).to({y:-197},0).wait(1).to({y:-194.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:11,regY:-200,x:11,y:-194.6},0).wait(1).to({y:-194.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:11,regY:-200,x:11,y:-195.4},0).wait(1).to({y:-196.9},0).wait(1).to({y:-199.15},0).wait(1).to({y:-200.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-200,x:11,y:-200.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:1},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.35},0).wait(1).to({regX:0,regY:0,x:0,y:-3},0).wait(1).to({regX:11,regY:-200,x:11,y:-202.65},0).wait(1).to({y:-201.6},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:11,regY:-200,x:11,y:-207.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:11,regY:-200,x:11,y:-208},0).wait(1).to({y:-202},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:11,regY:-200,x:11,y:-195.35},0).wait(1).to({y:-196.55},0).wait(1).to({y:-198.5},0).wait(1).to({y:-199.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-200,x:11,y:-204.95},0).wait(1).to({y:-199.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-200,x:11,y:-204.95},0).wait(1).to({y:-199.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-200,x:11,y:-199.1},0).wait(1).to({y:-199.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-200,x:14,y:-196.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:11,regY:-200,x:10.15,y:-190.55},0).wait(1).to({x:10.8,y:-190.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:11,regY:-200,x:11,y:-190.7},0).wait(1).to({y:-193.15},0).wait(1).to({y:-196.85},0).wait(1).to({y:-199.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:11,regY:-200,scaleX:1.0002,scaleY:1.0002,rotation:-0.0124,x:10.95,y:-200.05},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0556,x:10.85,y:-200.1},0).wait(1).to({scaleX:1.0018,scaleY:1.0018,rotation:-0.14,x:10.65,y:-200.2},0).wait(1).to({scaleX:1.0035,scaleY:1.0035,rotation:-0.2738,x:10.45,y:-200.4},0).wait(1).to({scaleX:1.0057,scaleY:1.0057,rotation:-0.4418,x:10.1,y:-200.6},0).wait(1).to({scaleX:1.0076,scaleY:1.0076,rotation:-0.5941,x:9.8,y:-200.75},0).wait(1).to({scaleX:1.0089,scaleY:1.0089,rotation:-0.6957,x:9.6,y:-200.9},0).wait(1).to({scaleX:1.0096,scaleY:1.0096,rotation:-0.7479,x:9.45,y:-201},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.0098,scaleY:1.0098,rotation:-0.7628,x:1,y:1.1},0).wait(1).to({regX:11,regY:-200,scaleX:1.0096,scaleY:1.0096,rotation:-0.7531,x:9.3,y:-201.1},0).wait(1).to({scaleX:1.0092,scaleY:1.0092,rotation:-0.7201,x:9.35,y:-201.05},0).wait(1).to({scaleX:1.0084,scaleY:1.0084,rotation:-0.6564,x:9.5,y:-201},0).wait(1).to({scaleX:1.007,scaleY:1.007,rotation:-0.5548,x:9.75,y:-200.85},0).wait(1).to({scaleX:1.0052,scaleY:1.0052,rotation:-0.4173,x:10,y:-200.7},0).wait(1).to({scaleX:1.0033,scaleY:1.0033,rotation:-0.2704,x:10.3,y:-200.45},0).wait(1).to({scaleX:1.0017,scaleY:1.0017,rotation:-0.1513,x:10.45,y:-200.35},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0742,x:10.7,y:-200.15},0).wait(1).to({scaleX:1.0001,scaleY:1.0001,rotation:-0.0343,x:10.8,y:-200.05},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:-0.0227,x:0,y:0},0).wait(2).to({rotation:0},0).wait(1).to({regX:11,regY:-200,scaleX:1.0002,scaleY:1.0002,rotation:-0.0124,x:10.95,y:-200.05},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0556,x:10.85,y:-200.1},0).wait(1).to({scaleX:1.0018,scaleY:1.0018,rotation:-0.14,x:10.65,y:-200.2},0).wait(1).to({scaleX:1.0035,scaleY:1.0035,rotation:-0.2738,x:10.45,y:-200.4},0).wait(1).to({scaleX:1.0057,scaleY:1.0057,rotation:-0.4418,x:10.1,y:-200.6},0).wait(1).to({scaleX:1.0076,scaleY:1.0076,rotation:-0.5941,x:9.8,y:-200.75},0).wait(1).to({scaleX:1.0089,scaleY:1.0089,rotation:-0.6957,x:9.6,y:-200.9},0).wait(1).to({scaleX:1.0096,scaleY:1.0096,rotation:-0.7479,x:9.45,y:-201},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.0098,scaleY:1.0098,rotation:-0.7628,x:1,y:1.1},0).wait(1).to({regX:11,regY:-200,scaleX:1.0096,scaleY:1.0096,rotation:-0.7531,x:9.3,y:-201.1},0).wait(1).to({scaleX:1.0092,scaleY:1.0092,rotation:-0.7201,x:9.35,y:-201.05},0).wait(1).to({scaleX:1.0084,scaleY:1.0084,rotation:-0.6564,x:9.5,y:-201},0).wait(1).to({scaleX:1.007,scaleY:1.007,rotation:-0.5548,x:9.75,y:-200.85},0).wait(1).to({scaleX:1.0052,scaleY:1.0052,rotation:-0.4173,x:10,y:-200.7},0).wait(1).to({scaleX:1.0033,scaleY:1.0033,rotation:-0.2704,x:10.3,y:-200.45},0).wait(1).to({scaleX:1.0017,scaleY:1.0017,rotation:-0.1513,x:10.45,y:-200.35},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:-0.0742,x:10.7,y:-200.15},0).wait(1).to({scaleX:1.0001,scaleY:1.0001,rotation:-0.0343,x:10.8,y:-200.05},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:-0.0227,x:0,y:0},0).wait(2).to({rotation:0},0).wait(1).to({regX:11,regY:-200,x:11,y:-199.95},0).wait(1).to({y:-199.6},0).wait(1).to({y:-198.95},0).wait(1).to({y:-198.1},0).wait(1).to({y:-197.45},0).wait(1).to({y:-197.1},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-200,x:11,y:-197.1},0).wait(1).to({y:-197.45},0).wait(1).to({y:-198.1},0).wait(1).to({y:-198.95},0).wait(1).to({y:-199.6},0).wait(1).to({y:-199.95},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(50).to({regX:11,regY:-200,scaleX:1.0002,scaleY:1.0002,rotation:0.0163,x:11.05,y:-200},0).wait(1).to({scaleX:1.0007,scaleY:1.0007,rotation:0.0728,x:11.3,y:-199.85},0).wait(1).to({scaleX:1.0018,scaleY:1.0018,rotation:0.1834,x:11.8,y:-199.5},0).wait(1).to({scaleX:1.0035,scaleY:1.0035,rotation:0.3586,x:12.65,y:-199.05},0).wait(1).to({scaleX:1.0057,scaleY:1.0057,rotation:0.5787,x:13.7,y:-198.4},0).wait(1).to({scaleX:1.0076,scaleY:1.0076,rotation:0.7782,x:14.65,y:-197.85},0).wait(1).to({scaleX:1.0089,scaleY:1.0089,rotation:0.9113,x:15.25,y:-197.45},0).wait(1).to({scaleX:1.0096,scaleY:1.0096,rotation:0.9797,x:15.55,y:-197.3},0).wait(1).to({regX:0.1,regY:0.1,scaleX:1.0097,scaleY:1.0097,rotation:0.9992,x:1,y:4.45},0).wait(1).to({regX:11,regY:-200,scaleX:1.0096,scaleY:1.0096,rotation:0.9859,x:15.4,y:-197.45},0).wait(1).to({scaleX:1.0092,scaleY:1.0092,rotation:0.9403,x:15.2,y:-197.55},0).wait(1).to({scaleX:1.0083,scaleY:1.0083,rotation:0.8523,x:14.8,y:-197.8},0).wait(1).to({scaleX:1.007,scaleY:1.007,rotation:0.712,x:14.2,y:-198.2},0).wait(1).to({scaleX:1.0052,scaleY:1.0052,rotation:0.5221,x:13.3,y:-198.75},0).wait(1).to({scaleX:1.0033,scaleY:1.0033,rotation:0.3193,x:12.35,y:-199.25},0).wait(1).to({scaleX:1.0017,scaleY:1.0017,rotation:0.1548,x:11.55,y:-199.7},0).wait(1).to({scaleX:1.0006,scaleY:1.0006,rotation:0.0484,x:11.1,y:-200},0).wait(1).to({scaleX:1.0001,scaleY:1.0001,rotation:-0.0067,x:10.9,y:-200.05},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,rotation:-0.0227,x:0,y:0},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.leef_2).wait(567));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-524.5,-812.3,929.4,978.8);


// stage content:
(lib._401_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:157,scene2:158,end2:318,scene3:319,end3:493,scene4:494,end4:642,scene5:643,end5:770,scene6:771,end6:895,scene7:896,end7:1091});
	...
	this.frame_0 = function() {
		...
		this.ch1.leef_1.gotoAndStop("stop");
	...
	this.frame_40 = function() {
		exportRoot._g.m1 = "お待たせしました～っ､特製･";
		exportRoot._u.setText();
	}
	this.frame_45 = function() {
		this.cut_1.gotoAndPlay("start");
	}
	this.frame_52 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "のﾒﾙﾍﾝ弁当です! ";
		exportRoot._u.setText();
	}
	this.frame_85 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "焼きに";
		exportRoot._u.setText();
	}
	this.frame_108 = function() {
		exportRoot._g.m3 = "焼きにｻｸｻｸの唐揚げ､";
		exportRoot._u.setText();
	}
	...
	this.frame_157 = function() {
		...
		this.cut_1.gotoAndPlay("start_2");
		
		this.ch1.leef_1.gotoAndStop("stop");
		this.ch1.leef_2.gotoAndStop("stop");
	}
	this.frame_158 = function() {
		exportRoot._g.m1 = "そして､極めつけは……";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	this.frame_189 = function() {
		exportRoot._g.m1 = "そして､極めつけは……ﾒﾙﾍﾝ･";
		exportRoot._u.setText();
	...
	this.frame_341 = function() {
		exportRoot._g.m1 = "あれれ? ﾅﾅの料理ｽｷﾙに";
		exportRoot._u.setText();
	...
	this.frame_836 = function() {
		...
		this.ch1.gotoAndPlay("chord_no");
	}
	this.frame_866 = function() {
		exportRoot._g.m4 = "ぐーたら､";
		exportRoot._u.setText();
	...
	this.frame_896 = function() {
		...
		exportRoot._u.setFace("ch1", 7);
		this.ch1.gotoAndPlay("laugh_no");
		
		this.ch1.leef_1.gotoAndPlay("run");
		this.ch1.leef_2.gotoAndPlay("run");
	}
	this.frame_917 = function() {
		exportRoot._g.m1 = "決まりですね! じゃあ､";
		exportRoot._g.m2 = "";
		exportRoot._g.m3 = "";
		exportRoot._g.m4 = "";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(3).call(this.frame_18).wait(22).call(this.frame_40).wait(5).call(this.frame_45).wait(7).call(this.frame_52).wait(33).call(this.frame_85).wait(23).call(this.frame_108).wait(21).call(this.frame_129).wait(28).call(this.frame_157).wait(1).call(this.frame_158).wait(31).call(this.frame_189).wait(12).call(this.frame_201).wait(28).call(this.frame_229).wait(41).call(this.frame_270).wait(10).call(this.frame_280).wait(18).call(this.frame_298).wait(20).call(this.frame_318).wait(1).call(this.frame_319).wait(22).call(this.frame_341).wait(24).call(this.frame_365).wait(31).call(this.frame_396).wait(28).call(this.frame_424).wait(17).call(this.frame_441).wait(26).call(this.frame_467).wait(26).call(this.frame_493).wait(1).call(this.frame_494).wait(36).call(this.frame_530).wait(42).call(this.frame_572).wait(23).call(this.frame_595).wait(35).call(this.frame_630).wait(12).call(this.frame_642).wait(1).call(this.frame_643).wait(21).call(this.frame_664).wait(46).call(this.frame_710).wait(27).call(this.frame_737).wait(14).call(this.frame_751).wait(19).call(this.frame_770).wait(1).call(this.frame_771).wait(18).call(this.frame_789).wait(22).call(this.frame_811).wait(25).call(this.frame_836).wait(30).call(this.frame_866).wait(15).call(this.frame_881).wait(14).call(this.frame_895).wait(1).call(this.frame_896).wait(21).call(this.frame_917).wait(10).call(this.frame_927).wait(27).call(this.frame_954).wait(16).call(this.frame_970).wait(33).call(this.frame_1003).wait(17).call(this.frame_1020).wait(14).call(this.frame_1034).wait(24).call(this.frame_1058).wait(33).call(this.frame_1091).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1096));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1091).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1096));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1077));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1081));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(2).to({alpha:0.1016},3).to({_off:true},1).wait(1090));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1003).to({_off:false},0).wait(1).to({regX:3.5,regY:59.1,x:123.5,y:380.6},0).wait(1).to({y:378.9},0).wait(1).to({y:375.6},0).wait(1).to({y:370.25},0).wait(1).to({y:362.8},0).wait(1).to({y:354.45},0).wait(1).to({y:347.5},0).wait(1).to({y:342.95},0).wait(1).to({y:340.65},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1003).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1003).to({_off:false},0).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1003).to({_off:false},0).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(991).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(36).to({_off:false},0).to({alpha:1},8).wait(2).to({alpha:0},9).to({_off:true},1).wait(1040));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(149).to({_off:false},0).to({alpha:1},21,cjs.Ease.get(1)).to({alpha:0},12,cjs.Ease.get(-1)).to({_off:true},1).wait(894));

	// blue_light_move
	this.instance_12 = new lib.blue_light_move();
	this.instance_12.parent = this;
	this.instance_12.setTransform(61.25,110.25,0.8637,0.8,0,-2.9509,-160.8083,364.6,391.1);
	this.instance_12.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({_off:true},15).wait(1081));

	// sun_effect
	this.instance_13 = new lib.hikari();
	this.instance_13.parent = this;
	this.instance_13.setTransform(-141.9,-155,1.2681,1.5321,0,0.6026,-0.6253,-42.4,-92.5);
	this.instance_13.alpha = 0.1484;
	this.instance_13.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true},15).wait(1081));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({_off:true},15).wait(1081));

	// first_scene
	this.instance_15 = new lib.first_scene_1();
	this.instance_15.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({_off:true},15).wait(1081));

	// overlay_top
	this.instance_16 = new lib.overlay_black();
	this.instance_16.parent = this;
	this.instance_16.setTransform(120,-113);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({_off:false},0).to({_off:true},174).wait(907));

	// overlay_bottom
	this.instance_17 = new lib.overlay_black();
	this.instance_17.parent = this;
	this.instance_17.setTransform(120,350);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(15).to({_off:false},0).to({_off:true},174).wait(907));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(15).to({_off:false},0).to({_off:true},30).wait(144).to({_off:false},0).to({_off:true},814).wait(93));

	// cut_1
	this.cut_1 = new lib.cut_1_1();
	this.cut_1.name = "cut_1";
	this.cut_1.parent = this;
	this.cut_1.setTransform(253,151.35,1,1,0,0,0,256,185);
	this.cut_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.cut_1).wait(45).to({_off:false},0).wait(2).to({y:151.2},0).wait(1).to({y:151},0).wait(1).to({y:150.7},0).wait(1).to({y:150.25},0).wait(1).to({y:149.75},0).wait(1).to({y:149.05},0).wait(1).to({y:148.25},0).wait(1).to({y:147.3},0).wait(1).to({y:146.2},0).wait(1).to({y:145},0).wait(1).to({y:143.6},0).wait(1).to({y:142.1},0).wait(1).to({y:140.55},0).wait(1).to({y:138.9},0).wait(1).to({y:137.3},0).wait(1).to({y:135.75},0).wait(1).to({y:134.3},0).wait(1).to({y:132.95},0).wait(1).to({y:131.8},0).wait(1).to({y:130.75},0).wait(1).to({y:129.9},0).wait(1).to({y:129.15},0).wait(1).to({y:128.6},0).wait(1).to({y:128.1},0).wait(1).to({y:127.8},0).wait(1).to({y:127.55},0).wait(1).to({y:127.4},0).wait(1).to({y:127.35},0).wait(12).to({y:127.4},0).wait(1).to({x:252.85},0).wait(1).to({x:252.65,y:127.45},0).wait(1).to({x:252.3,y:127.5},0).wait(1).to({x:251.9,y:127.6},0).wait(1).to({x:251.4,y:127.7},0).wait(1).to({x:250.8,y:127.85},0).wait(1).to({x:250.05,y:128},0).wait(1).to({x:249.2,y:128.15},0).wait(1).to({x:248.25,y:128.35},0).wait(1).to({x:247.15,y:128.6},0).wait(1).to({x:245.95,y:128.85},0).wait(1).to({x:244.6,y:129.1},0).wait(1).to({x:243.15,y:129.4},0).wait(1).to({x:241.5,y:129.75},0).wait(1).to({x:239.7,y:130.1},0).wait(1).to({x:237.75,y:130.5},0).wait(1).to({x:235.65,y:130.95},0).wait(1).to({x:233.35,y:131.4},0).wait(1).to({x:230.85,y:131.95},0).wait(1).to({x:228.15,y:132.5},0).wait(1).to({x:225.3,y:133.1},0).wait(1).to({x:222.2,y:133.7},0).wait(1).to({x:218.85,y:134.4},0).wait(1).to({x:215.3,y:135.15},0).wait(1).to({x:211.45,y:135.9},0).wait(1).to({x:207.4,y:136.75},0).wait(1).to({x:203.05,y:137.65},0).wait(1).to({x:198.4,y:138.6},0).wait(1).to({x:193.5,y:139.6},0).wait(1).to({x:188.25,y:140.7},0).wait(1).to({x:182.7,y:141.8},0).wait(1).to({x:176.8,y:143.05},0).wait(1).to({x:170.6,y:144.3},0).wait(1).to({x:164.1,y:145.65},0).wait(1).to({x:157.25,y:147.05},0).wait(1).to({x:150.1,y:148.55},0).wait(1).to({x:142.6,y:150.05},0).wait(1).to({x:134.9,y:151.65},0).wait(1).to({x:126.95,y:153.3},0).wait(1).to({x:118.8,y:154.95},0).wait(1).to({x:110.55,y:156.65},0).wait(1).to({x:102.25,y:158.35},0).wait(1).to({x:93.95,y:160.05},0).wait(1).to({x:85.7,y:161.75},0).wait(1).to({x:77.65,y:163.4},0).wait(1).to({x:69.8,y:165},0).wait(1).to({x:62.25,y:166.55},0).wait(1).to({x:55.05,y:168.05},0).wait(1).to({x:48.2,y:169.45},0).wait(1).to({x:41.75,y:170.8},0).wait(1).to({x:35.7,y:172.05},0).wait(1).to({x:30.05,y:173.2},0).wait(1).to({x:24.85,y:174.25},0).wait(1).to({x:20.05,y:175.25},0).wait(1).to({x:15.7,y:176.15},0).wait(1).to({x:11.65,y:176.95},0).wait(1).to({x:8.05,y:177.7},0).wait(1).to({x:4.75,y:178.4},0).wait(1).to({x:1.8,y:179},0).wait(1).to({x:-0.8,y:179.5},0).wait(1).to({x:-3.1,y:180},0).wait(1).to({x:-5.15,y:180.4},0).wait(1).to({x:-6.9,y:180.8},0).wait(1).to({x:-8.45,y:181.1},0).wait(1).to({x:-9.7,y:181.35},0).wait(1).to({x:-10.75,y:181.55},0).wait(1).to({x:-11.6,y:181.75},0).wait(1).to({x:-12.2,y:181.85},0).wait(1).to({x:-12.65,y:181.95},0).wait(1).to({x:-12.9,y:182},0).wait(1).to({x:-13},0).to({_off:true},32).wait(907));

	// ch
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(-724,550);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.1,regY:0.2,scaleX:0.83,scaleY:0.83,x:116.1,y:353.15},0).wait(1).to({regX:-74.2,regY:-489.8,x:54.75,y:-53.5},0).wait(1).to({x:55.15},0).wait(1).to({x:55.55},0).wait(1).to({x:56},0).wait(1).to({x:56.5},0).wait(1).to({x:57},0).wait(1).to({x:57.5},0).wait(1).to({x:58.05},0).wait(1).to({x:58.6},0).wait(1).to({x:59.1},0).wait(1).to({x:59.65},0).wait(1).to({x:60.15},0).wait(1).to({x:60.65},0).wait(1).to({x:61.1},0).wait(1).to({x:61.55},0).wait(1).to({x:61.95},0).wait(1).to({x:62.35},0).wait(1).to({x:62.7},0).wait(1).to({x:63},0).wait(1).to({x:63.25},0).wait(1).to({x:63.5},0).wait(1).to({x:63.75},0).wait(1).to({x:63.9},0).wait(1).to({x:64.05},0).wait(1).to({x:64.15},0).wait(1).to({x:64.25},0).wait(1).to({x:64.35},0).wait(2).to({regX:0.1,regY:0.2,x:126.1,y:353.15},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-724,y:550,alpha:0.0117},0).wait(144).to({regX:0.3,regY:0.1,scaleX:0.7,scaleY:0.7,x:149.2,y:294.05,alpha:1},0).wait(1).to({regX:-74.2,regY:-489.8,x:97.05,y:-48.65},0).wait(1).to({y:-48},0).wait(1).to({y:-46.95},0).wait(1).to({y:-45.65},0).wait(1).to({y:-44.35},0).wait(1).to({y:-43.25},0).wait(1).to({y:-42.3},0).wait(1).to({y:-41.55},0).wait(1).to({y:-41},0).wait(1).to({y:-40.55},0).wait(1).to({y:-40.25},0).wait(1).to({y:-40.05},0).wait(1).to({y:-39.9},0).wait(1).to({regX:0.3,regY:0.1,x:149.2,y:303.05},0).wait(135).to({regX:-74.2,regY:-489.8,scaleX:0.7001,scaleY:0.7001,x:97,y:-39.9},0).wait(1).to({scaleX:0.7003,scaleY:0.7003,x:96.9,y:-39.85},0).wait(1).to({scaleX:0.7008,scaleY:0.7008,x:96.7,y:-39.9},0).wait(1).to({scaleX:0.7015,scaleY:0.7015,x:96.45,y:-39.95},0).wait(1).to({scaleX:0.7025,scaleY:0.7025,x:96.1,y:-40},0).wait(1).to({scaleX:0.7037,scaleY:0.7037,x:95.6,y:-40.05},0).wait(1).to({scaleX:0.7052,scaleY:0.7052,x:95,y:-40.15},0).wait(1).to({scaleX:0.707,scaleY:0.707,x:94.3,y:-40.25},0).wait(1).to({scaleX:0.7091,scaleY:0.7091,x:93.45,y:-40.35},0).wait(1).to({scaleX:0.7116,scaleY:0.7116,x:92.45,y:-40.45},0).wait(1).to({scaleX:0.7144,scaleY:0.7144,x:91.35,y:-40.6},0).wait(1).to({scaleX:0.7175,scaleY:0.7175,x:90.15,y:-40.75},0).wait(1).to({scaleX:0.7208,scaleY:0.7208,x:88.85,y:-40.9},0).wait(1).to({scaleX:0.7242,scaleY:0.7242,x:87.5,y:-41.1},0).wait(1).to({scaleX:0.7277,scaleY:0.7277,x:86.1,y:-41.25},0).wait(1).to({scaleX:0.7312,scaleY:0.7312,x:84.75,y:-41.4},0).wait(1).to({scaleX:0.7344,scaleY:0.7344,x:83.5,y:-41.6},0).wait(1).to({scaleX:0.7374,scaleY:0.7374,x:82.35,y:-41.75},0).wait(1).to({scaleX:0.74,scaleY:0.74,x:81.3,y:-41.85},0).wait(1).to({scaleX:0.7423,scaleY:0.7423,x:80.35,y:-42},0).wait(1).to({scaleX:0.7443,scaleY:0.7443,x:79.55,y:-42.05},0).wait(1).to({scaleX:0.7459,scaleY:0.7459,x:78.95,y:-42.15},0).wait(1).to({scaleX:0.7473,scaleY:0.7473,x:78.45,y:-42.2},0).wait(1).to({scaleX:0.7483,scaleY:0.7483,x:78.05,y:-42.25},0).wait(1).to({scaleX:0.7491,scaleY:0.7491,x:77.7,y:-42.35},0).wait(1).to({scaleX:0.7496,scaleY:0.7496,x:77.55},0).wait(1).to({scaleX:0.7499,scaleY:0.7499,x:77.4},0).wait(1).to({regX:0.4,regY:0.1,scaleX:0.75,scaleY:0.75,x:133.3,y:325.05},0).wait(230).to({regX:0.5,regY:0.2,x:133.35,y:325.15},0).wait(1).to({regX:-74.2,regY:-489.8,scaleX:0.7501,scaleY:0.7501,x:77.35,y:-42.35},0).wait(1).to({scaleX:0.7503,scaleY:0.7503,y:-42.45},0).wait(1).to({scaleX:0.7506,scaleY:0.7506,x:77.3,y:-42.5},0).wait(1).to({scaleX:0.7512,scaleY:0.7512,x:77.25,y:-42.6},0).wait(1).to({scaleX:0.7518,scaleY:0.7518,x:77.2,y:-42.75},0).wait(1).to({scaleX:0.7527,scaleY:0.7527,x:77.15,y:-42.95},0).wait(1).to({scaleX:0.7538,scaleY:0.7538,x:77.05,y:-43.15},0).wait(1).to({scaleX:0.7551,scaleY:0.7551,x:76.95,y:-43.4},0).wait(1).to({scaleX:0.7566,scaleY:0.7566,x:76.85,y:-43.75},0).wait(1).to({scaleX:0.7583,scaleY:0.7583,x:76.75,y:-44.1},0).wait(1).to({scaleX:0.7603,scaleY:0.7603,x:76.6,y:-44.5},0).wait(1).to({scaleX:0.7625,scaleY:0.7625,x:76.4,y:-44.95},0).wait(1).to({scaleX:0.765,scaleY:0.765,x:76.25,y:-45.4},0).wait(1).to({scaleX:0.7676,scaleY:0.7676,x:76.05,y:-46},0).wait(1).to({scaleX:0.7705,scaleY:0.7705,x:75.85,y:-46.6},0).wait(1).to({scaleX:0.7735,scaleY:0.7735,x:75.6,y:-47.25},0).wait(1).to({scaleX:0.7767,scaleY:0.7767,x:75.35,y:-47.9},0).wait(1).to({scaleX:0.78,scaleY:0.78,x:75.15,y:-48.55},0).wait(1).to({scaleX:0.7832,scaleY:0.7832,x:74.9,y:-49.25},0).wait(1).to({scaleX:0.7865,scaleY:0.7865,x:74.65,y:-49.85},0).wait(1).to({scaleX:0.7896,scaleY:0.7896,x:74.4,y:-50.5},0).wait(1).to({scaleX:0.7925,scaleY:0.7925,x:74.2,y:-51.15},0).wait(1).to({scaleX:0.7953,scaleY:0.7953,x:74,y:-51.7},0).wait(1).to({scaleX:0.7978,scaleY:0.7978,x:73.8,y:-52.25},0).wait(1).to({scaleX:0.8001,scaleY:0.8001,x:73.65,y:-52.7},0).wait(1).to({scaleX:0.8022,scaleY:0.8022,x:73.5,y:-53.1},0).wait(1).to({scaleX:0.8039,scaleY:0.8039,x:73.35,y:-53.45},0).wait(1).to({scaleX:0.8054,scaleY:0.8054,x:73.25,y:-53.75},0).wait(1).to({scaleX:0.8067,scaleY:0.8067,x:73.15,y:-54.05},0).wait(1).to({scaleX:0.8078,scaleY:0.8078,x:73.05,y:-54.25},0).wait(1).to({scaleX:0.8086,scaleY:0.8086,x:73,y:-54.45},0).wait(1).to({scaleX:0.8092,scaleY:0.8092,x:72.95,y:-54.55},0).wait(1).to({scaleX:0.8096,scaleY:0.8096,y:-54.65},0).wait(1).to({scaleX:0.8099,scaleY:0.8099,x:72.9,y:-54.7},0).wait(1).to({regX:0.5,regY:0.3,scaleX:0.81,scaleY:0.81,x:133.4,y:342.25},0).wait(160).to({regX:-74.2,regY:-489.8,scaleX:0.8098,scaleY:0.8098,x:72.85,y:-54.75},0).wait(1).to({scaleX:0.8093,scaleY:0.8093,x:72.9,y:-54.6},0).wait(1).to({scaleX:0.8083,scaleY:0.8083,x:72.95,y:-54.4},0).wait(1).to({scaleX:0.807,scaleY:0.807,x:73.05,y:-54.15},0).wait(1).to({scaleX:0.8053,scaleY:0.8053,x:73.15,y:-53.85},0).wait(1).to({scaleX:0.8031,scaleY:0.8031,x:73.25,y:-53.45},0).wait(1).to({scaleX:0.8004,scaleY:0.8004,x:73.4,y:-52.95},0).wait(1).to({scaleX:0.7972,scaleY:0.7972,x:73.6,y:-52.35},0).wait(1).to({scaleX:0.7936,scaleY:0.7936,x:73.8,y:-51.7},0).wait(1).to({scaleX:0.7893,scaleY:0.7893,x:74.1,y:-50.9},0).wait(1).to({scaleX:0.7845,scaleY:0.7845,x:74.35,y:-50},0).wait(1).to({scaleX:0.779,scaleY:0.779,x:74.65,y:-48.95},0).wait(1).to({scaleX:0.773,scaleY:0.773,x:75,y:-47.8},0).wait(1).to({scaleX:0.7663,scaleY:0.7663,x:75.4,y:-46.55},0).wait(1).to({scaleX:0.7589,scaleY:0.7589,x:75.8,y:-45.15},0).wait(1).to({scaleX:0.7509,scaleY:0.7509,x:76.3,y:-43.65},0).wait(1).to({scaleX:0.7422,scaleY:0.7422,x:76.8,y:-42.05},0).wait(1).to({scaleX:0.7328,scaleY:0.7328,x:77.35,y:-40.25},0).wait(1).to({scaleX:0.7228,scaleY:0.7228,x:77.85,y:-38.45},0).wait(1).to({scaleX:0.7123,scaleY:0.7123,x:78.5,y:-36.45},0).wait(1).to({scaleX:0.7013,scaleY:0.7013,x:79.1,y:-34.4},0).wait(1).to({scaleX:0.6899,scaleY:0.6899,x:79.8,y:-32.3},0).wait(1).to({scaleX:0.6783,scaleY:0.6783,x:80.45,y:-30.05},0).wait(1).to({scaleX:0.6665,scaleY:0.6665,x:81.15,y:-27.9},0).wait(1).to({scaleX:0.6547,scaleY:0.6547,x:81.85,y:-25.65},0).wait(1).to({scaleX:0.643,scaleY:0.643,x:82.5,y:-23.5},0).wait(1).to({scaleX:0.6316,scaleY:0.6316,x:83.15,y:-21.35},0).wait(1).to({scaleX:0.6206,scaleY:0.6206,x:83.75,y:-19.3},0).wait(1).to({scaleX:0.61,scaleY:0.61,x:84.4,y:-17.3},0).wait(1).to({scaleX:0.6001,scaleY:0.6001,x:85,y:-15.45},0).wait(1).to({scaleX:0.5907,scaleY:0.5907,x:85.45,y:-13.7},0).wait(1).to({scaleX:0.5821,scaleY:0.5821,x:86,y:-12.1},0).wait(1).to({scaleX:0.5741,scaleY:0.5741,x:86.45,y:-10.6},0).wait(1).to({scaleX:0.5668,scaleY:0.5668,x:86.85,y:-9.2},0).wait(1).to({scaleX:0.5602,scaleY:0.5602,x:87.25,y:-8},0).wait(1).to({scaleX:0.5543,scaleY:0.5543,x:87.55,y:-6.9},0).wait(1).to({scaleX:0.549,scaleY:0.549,x:87.9,y:-5.9},0).wait(1).to({scaleX:0.5444,scaleY:0.5444,x:88.15,y:-5.05},0).wait(1).to({scaleX:0.5403,scaleY:0.5403,x:88.4,y:-4.25},0).wait(1).to({scaleX:0.5369,scaleY:0.5369,x:88.55,y:-3.6},0).wait(1).to({scaleX:0.534,scaleY:0.534,x:88.8,y:-3.1},0).wait(1).to({scaleX:0.5316,scaleY:0.5316,x:88.9,y:-2.6},0).wait(1).to({scaleX:0.5297,scaleY:0.5297,x:89,y:-2.3},0).wait(1).to({scaleX:0.5282,scaleY:0.5282,x:89.1,y:-1.95},0).wait(1).to({scaleX:0.5272,scaleY:0.5272,x:89.15,y:-1.8},0).wait(1).to({scaleX:0.5266,scaleY:0.5266,y:-1.7},0).wait(1).to({regX:0.6,regY:0.4,scaleX:0.5265,scaleY:0.5265,x:128.55,y:256.35},0).wait(80).to({regX:-74.2,regY:-489.8,x:89.15,y:-1.75},0).wait(1).to({scaleX:0.5267,scaleY:0.5267,x:89.1,y:-1.8},0).wait(1).to({scaleX:0.5271,scaleY:0.5271,y:-1.9},0).wait(1).to({scaleX:0.5277,scaleY:0.5277,x:89.05,y:-1.95},0).wait(1).to({scaleX:0.5284,scaleY:0.5284,x:89,y:-2.1},0).wait(1).to({scaleX:0.5293,scaleY:0.5293,x:88.95,y:-2.25},0).wait(1).to({scaleX:0.5305,scaleY:0.5305,x:88.85,y:-2.5},0).wait(1).to({scaleX:0.5319,scaleY:0.5319,x:88.75,y:-2.75},0).wait(1).to({scaleX:0.5335,scaleY:0.5335,x:88.6,y:-3.05},0).wait(1).to({scaleX:0.5354,scaleY:0.5354,x:88.4,y:-3.45},0).wait(1).to({scaleX:0.5375,scaleY:0.5375,x:88.25,y:-3.85},0).wait(1).to({scaleX:0.54,scaleY:0.54,x:88.1,y:-4.25},0).wait(1).to({scaleX:0.5426,scaleY:0.5426,x:87.85,y:-4.75},0).wait(1).to({scaleX:0.5454,scaleY:0.5454,x:87.65,y:-5.3},0).wait(1).to({scaleX:0.5484,scaleY:0.5484,x:87.4,y:-5.85},0).wait(1).to({scaleX:0.5515,scaleY:0.5515,x:87.15,y:-6.45},0).wait(1).to({scaleX:0.5545,scaleY:0.5545,x:86.9,y:-7},0).wait(1).to({scaleX:0.5575,scaleY:0.5575,x:86.65,y:-7.6},0).wait(1).to({scaleX:0.5603,scaleY:0.5603,x:86.45,y:-8.1},0).wait(1).to({scaleX:0.5628,scaleY:0.5628,x:86.25,y:-8.55},0).wait(1).to({scaleX:0.5651,scaleY:0.5651,x:86,y:-9},0).wait(1).to({scaleX:0.5672,scaleY:0.5672,x:85.85,y:-9.4},0).wait(1).to({scaleX:0.569,scaleY:0.569,x:85.75,y:-9.7},0).wait(1).to({scaleX:0.5705,scaleY:0.5705,x:85.6,y:-10},0).wait(1).to({scaleX:0.5717,scaleY:0.5717,x:85.55,y:-10.3},0).wait(1).to({scaleX:0.5728,scaleY:0.5728,x:85.4,y:-10.5},0).wait(1).to({scaleX:0.5736,scaleY:0.5736,x:85.35,y:-10.6},0).wait(1).to({scaleX:0.5741,scaleY:0.5741,x:85.3,y:-10.7},0).wait(1).to({scaleX:0.5746,scaleY:0.5746,x:85.25,y:-10.8},0).wait(1).to({scaleX:0.5748,scaleY:0.5748,y:-10.85},0).wait(1).to({regX:0.7,regY:0.5,scaleX:0.5749,scaleY:0.5749,x:128.25,y:271},0).to({_off:true},57).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({scaleX:0.8299,scaleY:0.8299,x:-113,y:-103},0).wait(1).to({regX:287,regY:350,x:125.6,y:187.5},0).wait(1).to({x:126},0).wait(1).to({x:126.4},0).wait(1).to({x:126.85},0).wait(1).to({x:127.35},0).wait(1).to({x:127.85},0).wait(1).to({x:128.35},0).wait(1).to({x:128.9},0).wait(1).to({x:129.45},0).wait(1).to({x:129.95},0).wait(1).to({x:130.5},0).wait(1).to({x:131},0).wait(1).to({x:131.5},0).wait(1).to({x:131.95},0).wait(1).to({x:132.4},0).wait(1).to({x:132.8},0).wait(1).to({x:133.2},0).wait(1).to({x:133.55},0).wait(1).to({x:133.85},0).wait(1).to({x:134.1},0).wait(1).to({x:134.35},0).wait(1).to({x:134.6},0).wait(1).to({x:134.75},0).wait(1).to({x:134.9},0).wait(1).to({x:135},0).wait(1).to({x:135.1},0).wait(1).to({x:135.2},0).wait(2).to({regX:0,regY:0,x:-103,y:-103},0).wait(1).to({scaleX:1,scaleY:1,x:-1000,y:0,alpha:0.0117},0).wait(144).to({scaleX:0.7,scaleY:0.7,x:-44,y:-91,alpha:1},0).wait(1).to({regX:287,regY:350,x:156.9,y:154.25},0).wait(1).to({y:154.95},0).wait(1).to({y:156.1},0).wait(1).to({y:157.5},0).wait(1).to({y:158.85},0).wait(1).to({y:159.95},0).wait(1).to({y:160.85},0).wait(1).to({y:161.55},0).wait(1).to({y:162.05},0).wait(1).to({y:162.45},0).wait(1).to({y:162.7},0).wait(1).to({y:162.9},0).wait(1).to({y:163},0).wait(1).to({regX:0,regY:0,x:-44,y:-82},0).wait(135).to({regX:287,regY:350,scaleX:0.7001,scaleY:0.7001,x:156.85,y:163},0).wait(1).to({scaleX:0.7003,scaleY:0.7003,x:156.8,y:163.1},0).wait(1).to({scaleX:0.7008,scaleY:0.7008,x:156.65,y:163.25},0).wait(1).to({scaleX:0.7015,scaleY:0.7015,x:156.45,y:163.35},0).wait(1).to({scaleX:0.7025,scaleY:0.7025,x:156.15,y:163.6},0).wait(1).to({scaleX:0.7037,scaleY:0.7037,x:155.75,y:163.95},0).wait(1).to({scaleX:0.7052,scaleY:0.7052,x:155.3,y:164.3},0).wait(1).to({scaleX:0.707,scaleY:0.707,x:154.7,y:164.75},0).wait(1).to({scaleX:0.7091,scaleY:0.7091,x:154,y:165.3},0).wait(1).to({scaleX:0.7116,scaleY:0.7116,x:153.25,y:165.9},0).wait(1).to({scaleX:0.7144,scaleY:0.7144,x:152.35,y:166.55},0).wait(1).to({scaleX:0.7174,scaleY:0.7174,x:151.4,y:167.35},0).wait(1).to({scaleX:0.7208,scaleY:0.7208,x:150.35,y:168.2},0).wait(1).to({scaleX:0.7242,scaleY:0.7242,x:149.3,y:169.05},0).wait(1).to({scaleX:0.7277,scaleY:0.7277,x:148.2,y:169.95},0).wait(1).to({scaleX:0.7311,scaleY:0.7311,x:147.1,y:170.8},0).wait(1).to({scaleX:0.7344,scaleY:0.7344,x:146.1,y:171.55},0).wait(1).to({scaleX:0.7373,scaleY:0.7373,x:145.15,y:172.3},0).wait(1).to({scaleX:0.74,scaleY:0.74,x:144.3,y:173},0).wait(1).to({scaleX:0.7423,scaleY:0.7423,x:143.6,y:173.55},0).wait(1).to({scaleX:0.7443,scaleY:0.7443,x:142.95,y:174.05},0).wait(1).to({scaleX:0.7459,scaleY:0.7459,x:142.45,y:174.45},0).wait(1).to({scaleX:0.7472,scaleY:0.7472,x:142.05,y:174.8},0).wait(1).to({scaleX:0.7483,scaleY:0.7483,x:141.7,y:175.05},0).wait(1).to({scaleX:0.749,scaleY:0.749,x:141.45,y:175.25},0).wait(1).to({scaleX:0.7495,scaleY:0.7495,x:141.3,y:175.4},0).wait(1).to({scaleX:0.7498,scaleY:0.7498,x:141.2,y:175.45},0).wait(1).to({regX:-0.1,regY:-0.1,scaleX:0.7499,scaleY:0.7499,x:-74.05,y:-87.05},0).wait(230).to({scaleX:0.75,scaleY:0.75},0).wait(1).to({regX:287,regY:350,x:141.25,y:175.5},0).wait(1).to({scaleX:0.7502,scaleY:0.7502,y:175.55},0).wait(1).to({scaleX:0.7506,scaleY:0.7506},0).wait(1).to({scaleX:0.7511,scaleY:0.7511,y:175.6},0).wait(1).to({scaleX:0.7518,scaleY:0.7518,x:141.3,y:175.7},0).wait(1).to({scaleX:0.7527,scaleY:0.7527,y:175.75},0).wait(1).to({scaleX:0.7538,scaleY:0.7538,y:175.8},0).wait(1).to({scaleX:0.7551,scaleY:0.7551,y:175.9},0).wait(1).to({scaleX:0.7566,scaleY:0.7566,y:176.05},0).wait(1).to({scaleX:0.7583,scaleY:0.7583,y:176.2},0).wait(1).to({scaleX:0.7603,scaleY:0.7603,y:176.35},0).wait(1).to({scaleX:0.7625,scaleY:0.7625,x:141.35,y:176.55},0).wait(1).to({scaleX:0.7649,scaleY:0.7649,y:176.8},0).wait(1).to({scaleX:0.7676,scaleY:0.7676,y:176.95},0).wait(1).to({scaleX:0.7705,scaleY:0.7705,x:141.3,y:177.2},0).wait(1).to({scaleX:0.7735,scaleY:0.7735,x:141.35,y:177.5},0).wait(1).to({scaleX:0.7767,scaleY:0.7767,y:177.75},0).wait(1).to({scaleX:0.7799,scaleY:0.7799,x:141.4,y:178.05},0).wait(1).to({scaleX:0.7832,scaleY:0.7832,y:178.25},0).wait(1).to({scaleX:0.7864,scaleY:0.7864,y:178.55},0).wait(1).to({scaleX:0.7896,scaleY:0.7896,x:141.45,y:178.8},0).wait(1).to({scaleX:0.7925,scaleY:0.7925,y:179.05},0).wait(1).to({scaleX:0.7953,scaleY:0.7953,y:179.3},0).wait(1).to({scaleX:0.7978,scaleY:0.7978,y:179.5},0).wait(1).to({scaleX:0.8001,scaleY:0.8001,y:179.7},0).wait(1).to({scaleX:0.8021,scaleY:0.8021,y:179.85},0).wait(1).to({scaleX:0.8039,scaleY:0.8039,y:180},0).wait(1).to({scaleX:0.8054,scaleY:0.8054,x:141.5,y:180.15},0).wait(1).to({scaleX:0.8067,scaleY:0.8067,y:180.25},0).wait(1).to({scaleX:0.8077,scaleY:0.8077,y:180.3},0).wait(1).to({scaleX:0.8085,scaleY:0.8085,y:180.4},0).wait(1).to({scaleX:0.8092,scaleY:0.8092,x:141.55,y:180.45},0).wait(1).to({scaleX:0.8096,scaleY:0.8096,x:141.5},0).wait(1).to({scaleX:0.8098,scaleY:0.8098,y:180.5},0).wait(1).to({regX:-0.1,regY:-0.1,scaleX:0.8099,scaleY:0.8099,x:-91.1,y:-103.1},0).wait(160).to({regX:287,regY:350,scaleX:0.8097,scaleY:0.8097,x:141.45,y:180.45},0).wait(1).to({scaleX:0.8092,scaleY:0.8092,y:180.4},0).wait(1).to({scaleX:0.8083,scaleY:0.8083,y:180.35},0).wait(1).to({scaleX:0.807,scaleY:0.807,x:141.4,y:180.2},0).wait(1).to({scaleX:0.8052,scaleY:0.8052,x:141.35,y:180.05},0).wait(1).to({scaleX:0.803,scaleY:0.803,x:141.25,y:179.75},0).wait(1).to({scaleX:0.8004,scaleY:0.8004,x:141.2,y:179.55},0).wait(1).to({scaleX:0.7972,scaleY:0.7972,x:141.15,y:179.15},0).wait(1).to({scaleX:0.7935,scaleY:0.7935,x:141.05,y:178.8},0).wait(1).to({scaleX:0.7893,scaleY:0.7893,x:140.9,y:178.35},0).wait(1).to({scaleX:0.7844,scaleY:0.7844,x:140.8,y:177.85},0).wait(1).to({scaleX:0.779,scaleY:0.779,x:140.6,y:177.3},0).wait(1).to({scaleX:0.7729,scaleY:0.7729,x:140.5,y:176.7},0).wait(1).to({scaleX:0.7662,scaleY:0.7662,x:140.3,y:176},0).wait(1).to({scaleX:0.7589,scaleY:0.7589,x:140.1,y:175.2},0).wait(1).to({scaleX:0.7508,scaleY:0.7508,x:139.9,y:174.4},0).wait(1).to({scaleX:0.7421,scaleY:0.7421,x:139.65,y:173.5},0).wait(1).to({scaleX:0.7328,scaleY:0.7328,x:139.4,y:172.5},0).wait(1).to({scaleX:0.7228,scaleY:0.7228,x:139.1,y:171.5},0).wait(1).to({scaleX:0.7123,scaleY:0.7123,x:138.8,y:170.4},0).wait(1).to({scaleX:0.7013,scaleY:0.7013,x:138.5,y:169.25},0).wait(1).to({scaleX:0.6899,scaleY:0.6899,x:138.25,y:168.1},0).wait(1).to({scaleX:0.6782,scaleY:0.6782,x:137.9,y:166.9},0).wait(1).to({scaleX:0.6664,scaleY:0.6664,x:137.6,y:165.65},0).wait(1).to({scaleX:0.6546,scaleY:0.6546,x:137.3,y:164.45},0).wait(1).to({scaleX:0.643,scaleY:0.643,x:137,y:163.25},0).wait(1).to({scaleX:0.6316,scaleY:0.6316,x:136.65,y:162.05},0).wait(1).to({scaleX:0.6205,scaleY:0.6205,x:136.35,y:160.95},0).wait(1).to({scaleX:0.61,scaleY:0.61,x:136.05,y:159.85},0).wait(1).to({scaleX:0.6,scaleY:0.6,x:135.8,y:158.8},0).wait(1).to({scaleX:0.5907,scaleY:0.5907,x:135.55,y:157.85},0).wait(1).to({scaleX:0.582,scaleY:0.582,x:135.3,y:156.95},0).wait(1).to({scaleX:0.5741,scaleY:0.5741,x:135.1,y:156.1},0).wait(1).to({scaleX:0.5668,scaleY:0.5668,x:134.9,y:155.35},0).wait(1).to({scaleX:0.5602,scaleY:0.5602,x:134.7,y:154.7},0).wait(1).to({scaleX:0.5542,scaleY:0.5542,x:134.55,y:154.1},0).wait(1).to({scaleX:0.549,scaleY:0.549,x:134.4,y:153.55},0).wait(1).to({scaleX:0.5443,scaleY:0.5443,x:134.3,y:153.05},0).wait(1).to({scaleX:0.5403,scaleY:0.5403,x:134.15,y:152.65},0).wait(1).to({scaleX:0.5369,scaleY:0.5369,x:134.1,y:152.3},0).wait(1).to({scaleX:0.5339,scaleY:0.5339,x:134,y:152},0).wait(1).to({scaleX:0.5315,scaleY:0.5315,x:133.95,y:151.75},0).wait(1).to({scaleX:0.5296,scaleY:0.5296,x:133.9,y:151.55},0).wait(1).to({scaleX:0.5282,scaleY:0.5282,x:133.85,y:151.35},0).wait(1).to({scaleX:0.5272,scaleY:0.5272,x:133.8,y:151.25},0).wait(1).to({scaleX:0.5266,scaleY:0.5266,y:151.2},0).wait(1).to({regX:-0.2,regY:-0.2,scaleX:0.5264,scaleY:0.5264,x:-17.35,y:-33.1},0).wait(80).to({regX:287,regY:350,scaleX:0.5265,scaleY:0.5265,x:133.85,y:151.3},0).wait(1).to({scaleX:0.5267,scaleY:0.5267},0).wait(1).to({scaleX:0.5271,scaleY:0.5271,x:133.9,y:151.35},0).wait(1).to({scaleX:0.5276,scaleY:0.5276,y:151.4},0).wait(1).to({scaleX:0.5284,scaleY:0.5284,y:151.5},0).wait(1).to({scaleX:0.5293,scaleY:0.5293,x:133.85,y:151.55},0).wait(1).to({scaleX:0.5305,scaleY:0.5305,x:133.9,y:151.7},0).wait(1).to({scaleX:0.5319,scaleY:0.5319,y:151.85},0).wait(1).to({scaleX:0.5335,scaleY:0.5335,y:152},0).wait(1).to({scaleX:0.5354,scaleY:0.5354,y:152.2},0).wait(1).to({scaleX:0.5375,scaleY:0.5375,y:152.45},0).wait(1).to({scaleX:0.5399,scaleY:0.5399,y:152.7},0).wait(1).to({scaleX:0.5426,scaleY:0.5426,y:152.95},0).wait(1).to({scaleX:0.5454,scaleY:0.5454,x:133.95,y:153.2},0).wait(1).to({scaleX:0.5484,scaleY:0.5484,y:153.55},0).wait(1).to({scaleX:0.5515,scaleY:0.5515,y:153.85},0).wait(1).to({scaleX:0.5545,scaleY:0.5545,y:154.15},0).wait(1).to({scaleX:0.5575,scaleY:0.5575,x:134,y:154.45},0).wait(1).to({scaleX:0.5602,scaleY:0.5602,y:154.75},0).wait(1).to({scaleX:0.5628,scaleY:0.5628,x:133.95,y:155},0).wait(1).to({scaleX:0.5651,scaleY:0.5651,x:134,y:155.25},0).wait(1).to({scaleX:0.5672,scaleY:0.5672,y:155.45},0).wait(1).to({scaleX:0.5689,scaleY:0.5689,y:155.65},0).wait(1).to({scaleX:0.5705,scaleY:0.5705,y:155.75},0).wait(1).to({scaleX:0.5717,scaleY:0.5717,x:134.05,y:155.9},0).wait(1).to({scaleX:0.5727,scaleY:0.5727,x:134,y:156},0).wait(1).to({scaleX:0.5735,scaleY:0.5735,y:156.1},0).wait(1).to({scaleX:0.5741,scaleY:0.5741,y:156.15},0).wait(1).to({scaleX:0.5745,scaleY:0.5745,x:134.05,y:156.2},0).wait(1).to({scaleX:0.5748,scaleY:0.5748,x:134},0).wait(1).to({regX:-0.3,regY:-0.4,x:-31.1,y:-45.15},0).to({_off:true},57).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},991).wait(105));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1003).wait(88).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1548.3,-720,2168.3,1420);
// library properties:
lib.properties = {
	id: '_401_3',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1582601333754", id:"_401_3_bg"},
		{src:"images/ch_base.png?1582601333754", id:"_401_3_ch_base"},
		{src:"images/ch_face2.png?1582601333754", id:"_401_3_ch_face2"},
		{src:"images/ch_face3.png?1582601333754", id:"_401_3_ch_face3"},
		{src:"images/ch_face4.png?1582601333754", id:"_401_3_ch_face4"},
		{src:"images/ch_face6.png?1582601333754", id:"_401_3_ch_face6"},
		{src:"images/ch_face7.png?1582601333754", id:"_401_3_ch_face7"},
		{src:"images/ch_face8.png?1582601333754", id:"_401_3_ch_face8"},
		{src:"images/ch_face9.png?1582601333754", id:"_401_3_ch_face9"},
		{src:"images/cut_1.jpg?1582601333754", id:"_401_3_cut_1"},
		{src:"images/finish.jpg?1582601333754", id:"_401_3_finish"},
		{src:"images/finish_blur.jpg?1582601333754", id:"_401_3_finish_blur"},
		{src:"images/first_scene.jpg?1582601333754", id:"_401_3_first_scene"},
		{src:"images/glitter.png?1582601333754", id:"_401_3_glitter"},
		{src:"images/leef_a.png?1582601333754", id:"_401_3_leef_a"},
		{src:"images/leef_b.png?1582601333754", id:"_401_3_leef_b"},
		{src:"images/leef_d.png?1582601333754", id:"_401_3_leef_d"},
		{src:"images/leef_e.png?1582601333754", id:"_401_3_leef_e"},
		{src:"images/leef_f.png?1582601333754", id:"_401_3_leef_f"},
		{src:"images/leef_g.png?1582601333754", id:"_401_3_leef_g"},
		{src:"images/leef_l.png?1582601333754", id:"_401_3_leef_l"},
		{src:"images/sun_light.png?1582601333754", id:"_401_3_sun_light"},
		{src:"images/tie_fp.png?1582601333754", id:"_401_3_tie_fp"},
		{src:"images/tie_sp.png?1582601333754", id:"_401_3_tie_sp"}
	],
	preloads: []
};
