...
(lib.bg = function() {
	this.initialize(img._431_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1288,1400);


(lib.book = function() {
	this.initialize(img._431_2_book);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1288,364);


(lib.ch_base = function() {
	this.initialize(img._431_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1288,1400);


(lib.ch_face2 = function() {
	this.initialize(img._431_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face3 = function() {
	this.initialize(img._431_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face4 = function() {
	this.initialize(img._431_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face5 = function() {
	this.initialize(img._431_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face6 = function() {
	this.initialize(img._431_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face7 = function() {
	this.initialize(img._431_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.ch_face8 = function() {
	this.initialize(img._431_2_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,292,292);


(lib.finish = function() {
	this.initialize(img._431_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._431_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._431_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._431_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
}).prototype = getMCSymbolPrototype(lib.book_1, new cjs.Rectangle(0,0,644,182), null);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	this.shape_1.setTransform(15.875,0.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("Ag4AuIAAgOIAwAAIAAg/IgrAAIAAgPIBnAAIAAAPIgrAAIAAA/IAwAAIAAAOg");
	this.shape_2.setTransform(-0.05,2.05);
	...
	this.shape_3.setTransform(-15.825,0.875);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#333333").s().p("AhCA5QAUgIAMgMQAMgMAHgPQAGgPACgUIgwAAIAAgQIAxAAIABgOIAAgOIARAAIAAAOIgBAOIA4AAIAAAYIgBAXIgCAWIgCAOQgDALgGAGQgHAFgHACQgIABgHAAIgHAAIgHAAIgHgSIALABIALAAIAHAAQAFgBADgDQAEgDACgGIABgNIABgRIABgRIAAgPIgnAAQgCAXgHAQQgGASgMAOQgNAOgWAKg");
	this.shape_4.setTransform(-32.55,0.45);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(98.65,42.2,0.5505,0.2479,0,123.6099,123.3659,0.1,-0.3);

	this.instance_1 = new lib.uru_set();
	this.instance_1.parent = this;
	this.instance_1.setTransform(95.6,42.35,1.7805,0.7403,0,123.6118,123.3664,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1},{t:this.instance,p:{regX:0.1,regY:-0.3,scaleX:0.5505,scaleY:0.2479,skewX:123.6099,skewY:123.3659,x:98.65,y:42.2}}]},10).to({state:[]},2).to({state:[{t:this.instance,p:{regX:0,regY:0,scaleX:0.9005,scaleY:0.5503,skewX:26.0791,skewY:25.8338,x:87,y:41.9}}]},7).wait(1));

	// moisture_righteye
	this.instance_2 = new lib.uru_set();
	this.instance_2.parent = this;
	this.instance_2.setTransform(32.4,62.95,0.501,0.2347,0,100.3632,104.9192,0.8,3.9);

	this.instance_3 = new lib.uru_set();
	this.instance_3.parent = this;
	this.instance_3.setTransform(27.85,63.65,1.6143,0.6795,0,100.3643,104.9203,0.7,3.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_3},{t:this.instance_2,p:{regX:0.8,regY:3.9,scaleX:0.501,scaleY:0.2347,skewX:100.3632,skewY:104.9192,x:32.4,y:62.95}}]},10).to({state:[]},2).to({state:[{t:this.instance_2,p:{regX:0.7,regY:4.2,scaleX:1.0632,scaleY:0.5296,skewX:32.5646,skewY:37.1205,x:34.65,y:40.95}}]},7).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},2).to({state:[{t:this.instance_7}]},1).to({state:[]},1).wait(8));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-129,241);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:70.6082,y:52.193}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
...
p.nominalBounds = new cjs.Rectangle(-249,-155,644,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-191,-98);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-311,-494,644,700);
...
(lib.mc_kirakira = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(100.3,-24,1.3886,1.3886);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(84.95,32.25);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(57.4,8.85,1.4656,1.4656);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(53.3,-22.75,1.1145,1.1145,0,0,0,0.1,0);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(67.95,-41.45,1.7128,1.7128,0,0,0,0.3,-0.4);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(104.25,32.45,1.8,1.8,0,0,0,0,0.1);
	...
	this.instance_6.parent = this;
	this.instance_6.setTransform(83.8,-22,0.5847,0.5847,0,0,0,0.1,-0.1);
	...
	this.instance_7.parent = this;
	this.instance_7.setTransform(96.55,41.25);
	...
	this.instance_8.parent = this;
	this.instance_8.setTransform(111.65,0.05,1.0265,1.0265);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(73.2,7.05,0.5111,0.5111,0,0,0,0.1,0.1);
	...
	this.instance_10.parent = this;
	this.instance_10.setTransform(29,-62.05,0.5333,0.5333,0,0,0,0.1,-0.1);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(72.1,-13.2,0.7347,0.7347);
	...
	this.instance_12.parent = this;
	this.instance_12.setTransform(177.75,-41.35,0.5333,0.5333,0,0,0,0.1,-0.1);
	...
	this.instance_13.parent = this;
	this.instance_13.setTransform(-8.15,-11.3,0.5556,0.5556,0,0,0,-0.1,-0.1);
	...
	this.instance_14.parent = this;
	this.instance_14.setTransform(24.6,-9.15,1.6218,1.6218,0,0,0,0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-13.4,-68,196.3,120.6);
...
(lib.character1_container = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(7).call(this.frame_15).wait(1).call(this.frame_16).wait(8).call(this.frame_24).wait(1).call(this.frame_25).wait(11).call(this.frame_36).wait(1).call(this.frame_37).wait(9).call(this.frame_46).wait(1).call(this.frame_47).wait(9).call(this.frame_56).wait(1).call(this.frame_57).wait(8).call(this.frame_65).wait(1).call(this.frame_66).wait(14).call(this.frame_80).wait(1).call(this.frame_81).wait(10).call(this.frame_91).wait(1).call(this.frame_92).wait(19).call(this.frame_111).wait(1).call(this.frame_112).wait(8).call(this.frame_120).wait(1).call(this.frame_121).wait(10).call(this.frame_131).wait(1).call(this.frame_132).wait(13).call(this.frame_145).wait(1).call(this.frame_146).wait(13).call(this.frame_159).wait(1).call(this.frame_160).wait(20).call(this.frame_180).wait(1).call(this.frame_181).wait(19).call(this.frame_200).wait(1).call(this.frame_201).wait(27).call(this.frame_228).wait(1).call(this.frame_229).wait(11).call(this.frame_240).wait(1).call(this.frame_241).wait(10).call(this.frame_251).wait(1).call(this.frame_252).wait(15).call(this.frame_267).wait(1).call(this.frame_268).wait(26).call(this.frame_294).wait(1).call(this.frame_295).wait(17).call(this.frame_312).wait(1).call(this.frame_313).wait(11).call(this.frame_324).wait(1).call(this.frame_325).wait(17).call(this.frame_342).wait(1).call(this.frame_343).wait(6).call(this.frame_349).wait(1).call(this.frame_350).wait(18).call(this.frame_368).wait(1).call(this.frame_369).wait(14).call(this.frame_383).wait(1).call(this.frame_384).wait(19).call(this.frame_403).wait(1).call(this.frame_404).wait(11).call(this.frame_415).wait(1).call(this.frame_416).wait(16).call(this.frame_432).wait(1).call(this.frame_433).wait(8).call(this.frame_441).wait(1).call(this.frame_442).wait(19).call(this.frame_461).wait(1).call(this.frame_462).wait(13).call(this.frame_475).wait(1).call(this.frame_476).wait(20).call(this.frame_496).wait(1).call(this.frame_497).wait(19).call(this.frame_516).wait(1).call(this.frame_517).wait(20).call(this.frame_537).wait(1));

	// effect_look_to_right2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(65.3,-364.3,1.1645,1.1645,0,0,180);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(313).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.9,y:-373.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:102.55,y:-377.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:65.3,y:-364.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.9,y:-373.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:102.55,y:-377.6,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,skewX:0,skewY:180,x:65.3,y:-364.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.9,y:-373.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:102.55,y:-377.6,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,skewX:0,skewY:180,x:65.3,y:-364.3,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,skewX:33.7496,skewY:213.7496,x:90.9,y:-373.3,alpha:0.4141},0).wait(1).to({regX:0,regY:0,skewX:44.9995,skewY:224.9995,x:102.55,y:-377.6,alpha:0.2188},0).to({_off:true},1).wait(206));

	// effect_look_to_right
	this.instance_1 = new lib.spread_flower_pink("synched",0,false);
	this.instance_1.parent = this;
	this.instance_1.setTransform(7.15,-271.55,1.4807,1.4807,0,0,180);

	this.instance_2 = new lib.good_effect("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(7.2,-271.6,1.481,1.481);

	this.instance_3 = new lib.notice();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-64.5,-361.65,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_3._off = true;

	this.instance_4 = new lib.laugh("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-85.4,-356.35,1.4204,1.4204,35.8424,0,0,-30.3,20.6);
	this.instance_4._off = true;

	this.instance_5 = new lib.chord("synched",0,false);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-57.6,-274,1.0029,1.0029,-61.4995,0,0,-23.4,76.9);

	this.instance_6 = new lib.question();
	this.instance_6.parent = this;
	this.instance_6.setTransform(69.05,-356.8,1.053,1.053,29.448);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.instance_7 = new lib.mc_exclamation("synched",0,false);
	this.instance_7.parent = this;
	this.instance_7.setTransform(72.8,-372.2,1.0929,1.0929,0,30,-150.0007,-0.1,0.1);

	this.instance_8 = new lib.drop1a("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(68.5,-354.7,1,1,0,0,0,-0.5,0.2);
	this.instance_8._off = true;

	this.instance_9 = new lib.drop2_v2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(67.1,-354.55,0.9876,0.9876,0,-14.9998,165.0002);
	this.instance_9._off = true;

	this.instance_10 = new lib.shock("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(73.55,-357.55,1.3878,1.3878,0,121.2396,-58.7604);

	this.instance_11 = new lib.sigh("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(47.1,-204.25,1,1,0,0,180);
	this.instance_11.alpha = 0.6016;
	this.instance_11._off = true;

	this.instance_12 = new lib.heart("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(73.75,-313.7,0.4532,0.4532,0,0,180);
	this.instance_12._off = true;

	this.instance_13 = new lib.angry("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(80.3,-334.95,0.5276,0.5276);
	this.instance_13._off = true;

	this.instance_14 = new lib.mc_punpun();
	this.instance_14.parent = this;
	this.instance_14.setTransform(-50.75,-384.1,1.1377,1.1377);

	this.instance_15 = new lib.concent_wrapper("synched",0,false);
	this.instance_15.parent = this;
	this.instance_15.setTransform(6.95,-272.15,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},37).to({state:[{t:this.instance_2}]},10).to({state:[]},10).to({state:[{t:this.instance_3}]},76).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_3}]},2).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},20).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},7).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},6).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},2).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},5).to({state:[{t:this.instance_8}]},16).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},9).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_8}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},24).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},5).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},11).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},3).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},11).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},2).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},6).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},5).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},2).to({state:[]},12).to({state:[{t:this.instance_15}]},17).to({state:[{t:this.instance_5}]},9).to({state:[]},20).to({state:[{t:this.instance_3}]},1).to({state:[]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},2).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_3}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},21).to({state:[{t:this.instance_4}]},15).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(133).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-64.1,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-64.5,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-64.1,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-64.5,alpha:0},0).to({_off:true},1).wait(304).to({_off:false,regX:-29.3,scaleX:1.1856,scaleY:1.1856,rotation:131.5883,skewX:0,skewY:0,x:204.25,y:-280.55,alpha:1},0).to({_off:true},2).wait(1).to({_off:false,regX:-29.2,scaleX:1.1863,scaleY:1.1863,rotation:131.5872,x:204.2,y:-280.4},0).wait(3).to({regX:-28.8,regY:20.5,x:203.8,y:-280.15,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.2,regY:20.4,x:204.2,y:-280.4,alpha:0},0).to({_off:true},1).wait(63));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-87.9,y:-355.5,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-85.4,y:-356.35,alpha:0,startPosition:19},0).to({_off:true},1).wait(296).to({_off:false,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-87.9,y:-355.5,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-85.4,y:-356.35,alpha:0,startPosition:19},0).to({_off:true},1).wait(21).to({_off:false,alpha:1,startPosition:0},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-87.9,y:-355.5,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.3,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-85.4,y:-356.35,alpha:0,startPosition:19},0).to({_off:true},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(202).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:76.7,y:-369.75,alpha:0.5556},0).wait(1).to({x:81.5,y:-377.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:83.45,y:-380.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:82.8,y:-379.65},0).wait(1).to({x:81.75,y:-377.8},0).wait(1).to({x:80,y:-374.7},0).wait(1).to({regX:0,regY:0,x:77.85,y:-370.5},0).to({x:78.6,y:-371.85},2).wait(8).to({regX:-0.2,regY:0.2,x:77.95,y:-371.15,alpha:0.9298},0).wait(1).to({x:76.85,y:-369.2,alpha:0.692},0).wait(1).to({x:75.25,y:-366.35,alpha:0.339},0).wait(1).to({x:74.05,y:-364.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-363.7,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:69.05,y:-356.8},0).wait(1).to({regX:-0.2,regY:0.2,x:76.7,y:-369.75,alpha:0.5556},0).wait(1).to({x:81.5,y:-377.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:83.45,y:-380.4,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:82.8,y:-379.65},0).wait(1).to({x:81.75,y:-377.8},0).wait(1).to({x:80,y:-374.7},0).wait(1).to({regX:0,regY:0,x:77.85,y:-370.5},0).to({x:78.6,y:-371.85},2).wait(3).to({regX:-0.2,regY:0.2,x:77.95,y:-371.15,alpha:0.9298},0).wait(1).to({x:76.85,y:-369.2,alpha:0.692},0).wait(1).to({x:75.25,y:-366.35,alpha:0.339},0).wait(1).to({x:74.05,y:-364.25,alpha:0.0788},0).wait(1).to({regX:0,regY:0,y:-363.7,alpha:0},0).to({_off:true},1).wait(291));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(268).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:69.5,y:-351},0).wait(1).to({y:-347.15},0).wait(1).to({y:-343.9},0).wait(1).to({y:-341.25},0).wait(1).to({y:-339.15},0).wait(1).to({y:-337.65},0).wait(1).to({y:-336.75},0).wait(1).to({regX:-0.5,regY:0.2,x:68.5,y:-335.7},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:69.5,y:-336.5,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:68.5,y:-335.7,alpha:0},0).to({_off:true},1).wait(249));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(313).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:98.525,y:-349.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:109,y:-348.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:67.1,y:-354.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:98.525,y:-354.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:109,y:-354.25,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:67.1,y:-354.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:98.525,y:-349.9375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:109,y:-348.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,skewX:-14.9998,skewY:165.0002,x:67.1,y:-354.55,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,skewX:18.7494,skewY:198.7494,x:98.525,y:-354.325,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,skewX:29.9991,skewY:209.9991,x:109,y:-354.25,alpha:0.2188},0).to({_off:true},1).wait(206));
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(351).to({_off:false},0).wait(1).to({x:48.1,y:-203.25,alpha:1},0).wait(1).to({regX:0.9,x:48.2,y:-202.3,alpha:0.8965},0).wait(1).to({x:49.55,y:-201.1,alpha:0.7636},0).wait(1).to({x:51.15,y:-199.65,alpha:0.6048},0).wait(1).to({x:52.95,y:-198.05,alpha:0.4229},0).wait(1).to({x:54.95,y:-196.2,alpha:0.2205},0).wait(1).to({regX:0,x:58.1,y:-194.25,alpha:0},0).to({_off:true},1).wait(179));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(370).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:75.5,y:-327.85},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:78.75,y:-333.7},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:76.2,y:-331.55},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:75.65,y:-328.3},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:76.75,y:-323.7},0).to({scaleX:1,scaleY:1,x:77.75,y:-327.7},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:75.15,y:-326.7,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:76.75,y:-327.45,alpha:0.1016},0).to({_off:true},1).wait(155));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(389).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-338.7},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-339.95},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(136));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:11,regY:-144,x:11,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-144,x:11,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({y:2},0).wait(1).to({regX:11,regY:-144,x:11,y:-149.5},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:11,regY:-144,x:11,y:-149.75},0).wait(1).to({y:-142.8},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:11,regY:-144,x:11,y:-140.75},0).wait(1).to({y:-143.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-144,x:11,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-144,x:11,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-144,x:11,y:-143.1},0).wait(1).to({y:-143.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:11,regY:-144,x:11,y:-153},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:11,regY:-144,x:11,y:-156.95},0).wait(1).to({y:-153.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-144,x:11,y:-142},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-144,x:11,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},0).wait(1).to({regX:11,regY:-144,x:11,y:-153},0).wait(1).to({regX:0,regY:0,x:0,y:-14},0).wait(1).to({regX:11,regY:-144,x:11,y:-156.95},0).wait(1).to({y:-153.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-144,x:11,y:-142},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-144,x:11,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-144,x:11,y:-143.4},0).wait(1).to({y:-141},0).wait(1).to({y:-138.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:11,regY:-144,x:11,y:-138.65},0).wait(1).to({y:-141},0).wait(1).to({y:-143.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-144,x:11,y:-143.85},0).wait(1).to({y:-143.3},0).wait(1).to({y:-142.2},0).wait(1).to({y:-140.85},0).wait(1).to({y:-139.75},0).wait(1).to({y:-139.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:11,regY:-144,x:11,y:-139.2},0).wait(1).to({y:-139.75},0).wait(1).to({y:-140.85},0).wait(1).to({y:-142.2},0).wait(1).to({y:-143.3},0).wait(1).to({y:-143.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:6},2).wait(1).to({regX:11,regY:-144,x:11,y:-139.25},0).wait(1).to({y:-142.8},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).to({y:6},2).wait(1).to({regX:11,regY:-144,x:11,y:-141.8},0).wait(1).to({y:-143.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-144,rotation:0.0244,x:11.05,y:-143.95},0).wait(1).to({rotation:0.1092,x:11.35,y:-143.65},0).wait(1).to({rotation:0.275,x:12.05,y:-143.05},0).wait(1).to({rotation:0.538,x:13.05,y:-142.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:14.35,y:-140.95},0).wait(1).to({rotation:1.1673,x:15.5,y:-139.9},0).wait(1).to({rotation:1.367,x:16.25,y:-139.15},0).wait(1).to({rotation:1.4695,x:16.65,y:-138.75},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:11,regY:-144,rotation:1.479,x:16.6,y:-138.8},0).wait(1).to({rotation:1.4111,x:16.35,y:-139.05},0).wait(1).to({rotation:1.2801,x:15.85,y:-139.5},0).wait(1).to({rotation:1.0711,x:15.05,y:-140.25},0).wait(1).to({rotation:0.7884,x:14,y:-141.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4865,x:12.8,y:-142.3},0).wait(1).to({rotation:0.2415,x:11.85,y:-143.15},0).wait(1).to({rotation:0.0832,x:11.25,y:-143.75},0).wait(1).to({rotation:0.0011,x:11,y:-144},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-144,rotation:0.0244,x:11.05,y:-143.95},0).wait(1).to({rotation:0.1092,x:11.35,y:-143.65},0).wait(1).to({rotation:0.275,x:12.05,y:-143.05},0).wait(1).to({rotation:0.538,x:13.05,y:-142.15},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8681,x:14.35,y:-140.95},0).wait(1).to({rotation:1.1673,x:15.5,y:-139.9},0).wait(1).to({rotation:1.367,x:16.25,y:-139.15},0).wait(1).to({rotation:1.4695,x:16.65,y:-138.75},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(1).to({regX:11,regY:-144,rotation:1.4793,x:16.6,y:-138.8},0).wait(1).to({rotation:1.4124,x:16.35,y:-139.05},0).wait(1).to({rotation:1.2834,x:15.85,y:-139.5},0).wait(1).to({rotation:1.0775,x:15.05,y:-140.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.7991,x:14,y:-141.25},0).wait(1).to({rotation:0.5016,x:12.85,y:-142.3},0).wait(1).to({rotation:0.2603,x:11.9,y:-143.15},0).wait(1).to({rotation:0.1043,x:11.3,y:-143.75},0).wait(1).to({rotation:0.0235,x:11.05,y:-144},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:11,regY:-144,x:11,y:-149.55},0).wait(1).to({y:-151.45},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:11,regY:-144,x:11,y:-151.35},0).wait(1).to({y:-149.25},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(7).to({regX:11,regY:-144,x:11,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-144,x:11,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(15).to({regX:11,regY:-144,rotation:-0.0253,x:10.85,y:-144},0).wait(1).to({rotation:-0.1129,x:10.25,y:-143.85},0).wait(1).to({rotation:-0.2845,x:9.1,y:-143.65},0).wait(1).to({rotation:-0.5565,x:7.2,y:-143.25},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:4.85,y:-142.75},0).wait(1).to({rotation:-1.2075,x:2.7,y:-142.35},0).wait(1).to({rotation:-1.4141,x:1.25,y:-142.05},0).wait(1).to({rotation:-1.5201,x:0.55,y:-141.9},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-6.8,y:2.4},0).wait(1).to({regX:11,regY:-144,rotation:-1.5305,x:0.45,y:-141.9},0).wait(1).to({rotation:-1.4624,x:0.95,y:-142},0).wait(1).to({rotation:-1.3309,x:1.85,y:-142.15},0).wait(1).to({rotation:-1.121,x:3.35,y:-142.45},0).wait(1).to({rotation:-0.8372,x:5.3,y:-142.85},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:7.4,y:-143.3},0).wait(1).to({rotation:-0.2881,x:9.15,y:-143.65},0).wait(1).to({rotation:-0.1291,x:10.25,y:-143.85},0).wait(1).to({rotation:-0.0467,x:10.8,y:-144},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-144,rotation:0.1421,x:11.5,y:-143.5},0).wait(1).to({rotation:0.6998,x:13.65,y:-141.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.327,x:16.1,y:-139.3},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(18).to({regX:11,regY:-144,rotation:1.4399,x:16.45,y:-138.9},0).wait(1).to({rotation:1.2196,x:15.6,y:-139.7},0).wait(1).to({rotation:0.7884,x:14,y:-141.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:12.15,y:-142.9},0).wait(1).to({rotation:0.0482,x:11.1,y:-143.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-144,rotation:0.0865,x:11.3,y:-143.75},0).wait(1).to({rotation:0.4213,x:12.6,y:-142.5},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.9973,x:14.8,y:-140.45},0).wait(1).to({rotation:1.3945,x:16.35,y:-139.05},0).wait(1).to({regX:0,regY:0,rotation:1.4989,x:1.95,y:4.95},0).wait(8).to({regX:11,regY:-144,rotation:1.4399,x:16.45,y:-138.9},0).wait(1).to({rotation:1.2196,x:15.6,y:-139.7},0).wait(1).to({rotation:0.7884,x:14,y:-141.25},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.3138,x:12.15,y:-142.9},0).wait(1).to({rotation:0.0482,x:11.1,y:-143.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:11,regY:-144,x:11,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-144,x:11,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:11,regY:-144,x:8.25,y:-136.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:11,regY:-144,x:11,y:-131.75},0).wait(1).to({y:-134.7},0).wait(1).to({y:-139.65},0).wait(1).to({y:-143.1},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:11,regY:-144,x:11,y:-143},0).wait(1).to({y:-137.05},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:11,regY:-144,x:11,y:-136.2},0).wait(1).to({y:-140.5},0).wait(1).to({y:-144.8},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:11,regY:-144,x:11,y:-144.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-144,x:11,y:-150.7},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:11,regY:-144,x:11,y:-150.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:11,regY:-144,x:11,y:-152.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-144,x:11,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:11,regY:-144,x:8.25,y:-136.25},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:11,regY:-144,x:11,y:-133.25},0).wait(1).to({y:-141},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({regX:11,regY:-144,x:11,y:-145},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:11,regY:-144,x:11,y:-144.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({regX:11,regY:-144,x:11,y:-143.5},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-144,x:11,y:-143.4},0).wait(1).to({y:-141},0).wait(1).to({y:-138.65},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:11,regY:-144,x:11,y:-138.6},0).wait(1).to({y:-138.9},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:11,regY:-144,x:11,y:-139.4},0).wait(1).to({y:-140.9},0).wait(1).to({y:-143.15},0).wait(1).to({y:-144.6},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:11,regY:-144,x:11,y:-144.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:5},0).wait(1).to({regX:11,regY:-144,x:11,y:-151.6},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:11,regY:-144,x:11,y:-153.2},0).wait(1).to({y:-150.45},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({regX:11,regY:-144,x:11,y:-151.5},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:11,regY:-144,x:11,y:-152},0).wait(1).to({y:-146},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:11,regY:-144,x:11,y:-139.35},0).wait(1).to({y:-140.55},0).wait(1).to({y:-142.5},0).wait(1).to({y:-143.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-144,x:11,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:11,regY:-144,x:11,y:-148.95},0).wait(1).to({y:-143.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:11,regY:-144,x:11,y:-143.1},0).wait(1).to({y:-143.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:11,regY:-144,x:14,y:-140.6},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:11,regY:-144,x:10.15,y:-134.55},0).wait(1).to({x:10.8,y:-134.15},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:11,regY:-144,x:11,y:-134.7},0).wait(1).to({y:-137.15},0).wait(1).to({y:-140.85},0).wait(1).to({y:-143.35},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:11,regY:-144,rotation:-0.0253,x:10.9,y:-143.95},0).wait(1).to({rotation:-0.1129,x:10.4,y:-143.65},0).wait(1).to({rotation:-0.2845,x:9.5,y:-143.15},0).wait(1).to({rotation:-0.5565,x:7.95,y:-142.35},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:6.1,y:-141.25},0).wait(1).to({rotation:-1.2075,x:4.4,y:-140.35},0).wait(1).to({rotation:-1.4141,x:3.3,y:-139.65},0).wait(1).to({rotation:-1.5201,x:2.7,y:-139.35},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-4.6,y:5},0).wait(1).to({regX:11,regY:-144,rotation:-1.5305,x:2.65,y:-139.35},0).wait(1).to({rotation:-1.4624,x:3.05,y:-139.55},0).wait(1).to({rotation:-1.3309,x:3.75,y:-139.95},0).wait(1).to({rotation:-1.121,x:4.9,y:-140.6},0).wait(1).to({rotation:-0.8372,x:6.45,y:-141.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:8.15,y:-142.45},0).wait(1).to({rotation:-0.2881,x:9.55,y:-143.2},0).wait(1).to({rotation:-0.1291,x:10.4,y:-143.7},0).wait(1).to({rotation:-0.0467,x:10.85,y:-143.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(36).to({regX:11,regY:-144,rotation:-0.0253,x:10.9,y:-143.95},0).wait(1).to({rotation:-0.1129,x:10.4,y:-143.65},0).wait(1).to({rotation:-0.2845,x:9.5,y:-143.15},0).wait(1).to({rotation:-0.5565,x:7.95,y:-142.35},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.898,x:6.1,y:-141.25},0).wait(1).to({rotation:-1.2075,x:4.4,y:-140.35},0).wait(1).to({rotation:-1.4141,x:3.3,y:-139.65},0).wait(1).to({rotation:-1.5201,x:2.7,y:-139.35},0).wait(1).to({regX:0,regY:0,rotation:-1.5505,x:-4.6,y:5},0).wait(1).to({regX:11,regY:-144,rotation:-1.5305,x:2.65,y:-139.35},0).wait(1).to({rotation:-1.4624,x:3.05,y:-139.55},0).wait(1).to({rotation:-1.3309,x:3.75,y:-139.95},0).wait(1).to({rotation:-1.121,x:4.9,y:-140.6},0).wait(1).to({rotation:-0.8372,x:6.45,y:-141.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.534,x:8.15,y:-142.45},0).wait(1).to({rotation:-0.2881,x:9.55,y:-143.2},0).wait(1).to({rotation:-0.1291,x:10.4,y:-143.7},0).wait(1).to({rotation:-0.0467,x:10.85,y:-143.95},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:11,regY:-144,x:11,y:-143.85},0).wait(1).to({y:-143.3},0).wait(1).to({y:-142.2},0).wait(1).to({y:-140.85},0).wait(1).to({y:-139.75},0).wait(1).to({y:-139.2},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:11,regY:-144,x:11,y:-139.2},0).wait(1).to({y:-139.75},0).wait(1).to({y:-140.85},0).wait(1).to({y:-142.2},0).wait(1).to({y:-143.3},0).wait(1).to({y:-143.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(7));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-398.9,-672.4,813.5,895.8);
...
// stage content:
(lib._431_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:150,scene2:151,end2:280,scene3:281,end3:400,scene4:401,end4:531,scene5:532,end5:647,scene6:648,end6:785,scene7:786,end7:945});
	...
	this.frame_166 = function() {
		exportRoot._g.m1 = "ﾒｯｾｰｼﾞは､ｸﾘｽﾏｽのお祝いと､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch1", 2);
	}
	...
	this.frame_663 = function() {
		exportRoot._g.m1 = "お揃いって､素敵ですよねっ｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 12);
	}
	this.frame_691 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "にいなくても､";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 8);
	}
	this.frame_712 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "る気がして｡";
		exportRoot._u.setText();
		exportRoot._u.setFace("ch2", 6);
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(13).call(this.frame_28).wait(14).call(this.frame_42).wait(13).call(this.frame_55).wait(27).call(this.frame_82).wait(27).call(this.frame_109).wait(20).call(this.frame_129).wait(21).call(this.frame_150).wait(1).call(this.frame_151).wait(15).call(this.frame_166).wait(24).call(this.frame_190).wait(23).call(this.frame_213).wait(32).call(this.frame_245).wait(12).call(this.frame_257).wait(23).call(this.frame_280).wait(1).call(this.frame_281).wait(19).call(this.frame_300).wait(34).call(this.frame_334).wait(32).call(this.frame_366).wait(15).call(this.frame_381).wait(19).call(this.frame_400).wait(1).call(this.frame_401).wait(28).call(this.frame_429).wait(36).call(this.frame_465).wait(17).call(this.frame_482).wait(32).call(this.frame_514).wait(17).call(this.frame_531).wait(1).call(this.frame_532).wait(22).call(this.frame_554).wait(29).call(this.frame_583).wait(38).call(this.frame_621).wait(16).call(this.frame_637).wait(10).call(this.frame_647).wait(1).call(this.frame_648).wait(15).call(this.frame_663).wait(28).call(this.frame_691).wait(21).call(this.frame_712).wait(36).call(this.frame_748).wait(20).call(this.frame_768).wait(17).call(this.frame_785).wait(1).call(this.frame_786).wait(21).call(this.frame_807).wait(28).call(this.frame_835).wait(16).call(this.frame_851).wait(32).call(this.frame_883).wait(24).call(this.frame_907).wait(22).call(this.frame_929).wait(16).call(this.frame_945).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(945).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(950));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(931));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(935));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},15).wait(935));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(867).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(907).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},907).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(907).to({_off:false},0).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(907).to({_off:false},0).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(895).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(15).to({_off:false},0).to({alpha:0},3).to({_off:true},1).wait(553).to({_off:false},0).to({alpha:1},5).to({alpha:0},5).to({_off:true},1).wait(33).to({_off:false},0).to({alpha:1},5).to({alpha:0},5).to({_off:true},1).wait(159).to({_off:false,alpha:1},0).to({alpha:0},7).to({_off:true},1).wait(156));

	// kira
	this.instance_11 = new lib.mc_kirakira("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(61.4,136.55,1,1,0,0,0,9.7,11.3);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(577).to({_off:false},0).to({x:54.8},43).to({_off:true},1).wait(329));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13},{t:this.instance_12}]}).to({state:[]},15).to({state:[{t:this.instance_14}]},562).to({state:[]},45).wait(328));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(577).to({_off:false},0).to({_off:true},45).wait(328));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(648).to({_off:false},0).to({alpha:1},43).to({_off:true},95).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(648).to({_off:false},0).to({alpha:0.4492},43).to({_off:true},95).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(15).to({_off:false},0).wait(935));

	// book
	this.book1 = new lib.book_1();
	this.book1.name = "book1";
	this.book1.parent = this;
	this.book1.setTransform(72.55,352.8,0.6328,0.6326,0,0,0,244.8,91.3);

	this.timeline.addTween(cjs.Tween.get(this.book1).wait(28).to({regY:91.4,scaleX:0.5409,scaleY:0.5408,x:60.1,y:306.8},27,cjs.Ease.quadInOut).wait(96).to({x:78.6},31,cjs.Ease.quadInOut).wait(99).to({alpha:0},10).to({_off:true},1).wait(658));

	// ch
	this.ch1 = new lib.character1_container();
	this.ch1.name = "ch1";
	this.ch1.parent = this;
	this.ch1.setTransform(114.3,279.9,0.6328,0.6328,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(28).to({regX:0.3,regY:0.2,scaleX:0.5409,scaleY:0.5409,x:95.85,y:244.45},27,cjs.Ease.quadInOut).wait(96).to({x:114.35},31,cjs.Ease.quadInOut).wait(99).to({alpha:0},10).to({_off:true},1).wait(658));

	// bg
	this.bg1 = new lib.bg_zoom_half();
	this.bg1.name = "bg1";
	this.bg1.parent = this;
	this.bg1.setTransform(-82.4,-32.7,0.6328,0.6328,0,0,0,-0.1,-0.3);

	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(28).to({regX:-0.2,regY:-0.2,scaleX:0.5409,scaleY:0.5409,x:-72.4,y:-22.75},27,cjs.Ease.quadInOut).wait(96).to({x:-53.9},31,cjs.Ease.quadInOut).wait(99).to({alpha:0},10).to({_off:true},1).wait(658));

	// book2
	this.book2 = new lib.book_1();
	this.book2.name = "book2";
	this.book2.parent = this;
	this.book2.setTransform(742.55,352.8,0.6328,0.6326,0,0,0,244.8,91.3);

	this.timeline.addTween(cjs.Tween.get(this.book2).wait(281).to({regY:91.4,scaleX:0.6822,scaleY:0.6821,x:66.25,y:333.95},0).to({y:373.95},29,cjs.Ease.quadInOut).wait(267).to({scaleX:1.3622,scaleY:1.3619,x:-95,y:116.75},0).to({x:-101.35},43).wait(1).to({scaleX:0.6822,scaleY:0.6821,x:66.25,y:373.95},0).wait(27).to({scaleX:0.8037,scaleY:0.8035,x:57.45,y:425.6},43,cjs.Ease.quadInOut).wait(95).to({scaleX:0.5945,scaleY:0.5944,x:73.9,y:328},0).to({_off:true},121).wait(43));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(784.3,279.9,0.6328,0.6328,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.ch2).wait(281).to({regX:0.3,regY:0.2,scaleX:0.6822,scaleY:0.6822,x:111.55,y:255.35},0).to({y:295.35},29,cjs.Ease.quadInOut).wait(267).to({scaleX:1.3622,scaleY:1.3622,x:-4.55,y:-40.2},0).to({x:-10.9},43).wait(1).to({scaleX:0.6822,scaleY:0.6822,x:111.55,y:295.35},0).wait(27).to({regY:0.3,scaleX:0.8037,scaleY:0.8037,x:110.75,y:333.05},43,cjs.Ease.quadInOut).wait(95).to({regX:0.4,scaleX:0.5945,scaleY:0.5945,x:113.2,y:259.55},0).to({_off:true},121).wait(43));

	// bg2
	this.bg2 = new lib.bg_zoom_half();
	this.bg2.name = "bg2";
	this.bg2.parent = this;
	this.bg2.setTransform(587.6,-32.7,0.6328,0.6328,0,0,0,-0.1,-0.3);

	this.timeline.addTween(cjs.Tween.get(this.bg2).wait(281).to({regX:-0.2,regY:-0.2,scaleX:0.6822,scaleY:0.6822,x:-100.9,y:-81.65},0).to({y:-41.65},29,cjs.Ease.quadInOut).wait(267).to({regY:-0.3,scaleX:1.3622,scaleY:1.3622,x:-428.7,y:-713.15},0).to({x:-435.05},43).wait(1).to({regY:-0.2,scaleX:0.6822,scaleY:0.6822,x:-100.9,y:-41.65},0).wait(27).to({regX:-0.3,regY:-0.3,scaleX:0.8037,scaleY:0.8037,x:-139.55,y:-64.05},43,cjs.Ease.quadInOut).wait(95).to({scaleX:0.5945,scaleY:0.5945,x:-71.85,y:-34.25},0).to({_off:true},121).wait(43));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},895).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},907).wait(38).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-314.9,-720,1310.1,1340);
// library properties:
lib.properties = {
	id: '_431_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1607396672485", id:"_431_2_bg"},
		{src:"images/book.png?1607396672485", id:"_431_2_book"},
		{src:"images/ch_base.png?1607396672485", id:"_431_2_ch_base"},
		{src:"images/ch_face2.png?1607396672485", id:"_431_2_ch_face2"},
		{src:"images/ch_face3.png?1607396672485", id:"_431_2_ch_face3"},
		{src:"images/ch_face4.png?1607396672485", id:"_431_2_ch_face4"},
		{src:"images/ch_face5.png?1607396672485", id:"_431_2_ch_face5"},
		{src:"images/ch_face6.png?1607396672485", id:"_431_2_ch_face6"},
		{src:"images/ch_face7.png?1607396672485", id:"_431_2_ch_face7"},
		{src:"images/ch_face8.png?1607396672485", id:"_431_2_ch_face8"},
		{src:"images/finish.jpg?1607396672485", id:"_431_2_finish"},
		{src:"images/finish_blur.jpg?1607396672485", id:"_431_2_finish_blur"},
		{src:"images/tie_fp.png?1607396672485", id:"_431_2_tie_fp"},
		{src:"images/tie_sp.png?1607396672485", id:"_431_2_tie_sp"}
	],
	preloads: []
};
